...
namespace Contena\Core\Profiling;
...
{
    /**
     * Profilers will be activated over the contena.yaml file
     *
     ...
     * @return mixed
     */
    public static function trace(string $name, \Closure $closure, string $category = 'contena', array $tags = [])
    {

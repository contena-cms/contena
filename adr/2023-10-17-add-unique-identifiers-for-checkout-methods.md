...
This issue is particularly significant for app servers, as it necessitates calls to the Contena Admin API for the identification of payment and shipping methods based on their respective IDs.
...
As part of the database migration process, the `technicalName` field will be automatically generated for the default payment and shipping methods provided by Contena, as illustrated below:

...
Currently, to define a custom sorting option, you need to define it as a service and tag it as `contena.sales_channel.product_listing.sorting`.
...
namespace Contena\Core\Content\Product\SalesChannel\Sorting\Example;

use Contena\Core\Content\Product\Events\ProductListingCriteriaEvent;
use Contena\Core\Content\Product\SalesChannel\Sorting\ProductSortingCollection;
use Contena\Core\Content\Product\SalesChannel\Sorting\ProductSortingEntity;

...
## Context
We often need a way between the different Contena versions to provide a one-time update for data. This is currently done on the way to extend an indexer to this logic and then trigger this via a migration.
...
class MigrationExample extends \Contena\Core\Framework\Migration\MigrationStep
{

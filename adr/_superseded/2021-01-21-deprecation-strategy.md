...
When a new service is implemented, the tag `contena.feature` with the minor-flag has to be added in the dependencyInjection.xml.
...
service.xml
```xml
        <service id="Contena\Core\Content\MyTest\Service\MyNewTestClass" public="true">
            <argument type="service" id="Contena\Core\System\SystemConfig\SystemConfigService"/>
            <tag name="contena.feature" flag="FEATURE_NEXT_11111"/>
        </service>
```
...
```xml
        ...
        <service id="Contena\Core\Content\MyTest\Service\MyTestClass" public="true">
            <argument type="service" id="Contena\Core\System\SystemConfig\SystemConfigService"/>
            <deprecated>tag:v6.4.0: The "%alias_id%" service is deprecated and will be removed in 6.4.0. Use "%Contena\Core\Content\MyTest\Service\MyTestClass%" instead<deprecated/>
        </service>
```
...
```xml
        ...
        <service id="Contena\Core\Content\MyTest\Service\MyTestClass" public="true">
            ...
            <argument type="service" id="Contena\Core\System\SystemConfig\Something" on-invalid="null" />
            <!-- @internal tag:v6.4.0 (flag:FEATURE_NEXT_22222) remove on-invalid=null on feature release -->
            <argument type="service" id="Contena\Core\System\SystemConfig\Somewhat" on-invalid="null" />
        </service>
```
...
[^8]: **code-basis**: The whole code of contena platform, development and production.

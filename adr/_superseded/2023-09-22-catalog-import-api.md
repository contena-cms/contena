...
And reduce the amount of implementation details developers have to know about when integrating Contena within existing
...
This endpoint is used to commit the records and begin the actual import into Contena.

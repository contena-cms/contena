...
* In the entity indexers
    ...
    * The entity indexers are not an extension point of contena. The queries that are executed there are only used for internal processing of data and should never be rewritten.

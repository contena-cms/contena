...
If you want to override the default mysql or redis adapter, you need to register your own incrementer gateway in DI container with the id `contena.increment.<custom_pool>.gateway.<adapter>`

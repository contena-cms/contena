...
use Contena\Core\Checkout\Cart\Error\IncompleteLineItemError;
use Contena\Core\Checkout\Cart\LineItem\CartDataCollection;
use Contena\Core\Checkout\Cart\LineItem\LineItem;
use Contena\Core\Content\Product\Cart\ProductCartProcessor;
use Contena\Core\System\SalesChannel\SalesChannelContext;
...
The plugins have to implement their only processing logic or alternatively extend contena's cart processors, when using

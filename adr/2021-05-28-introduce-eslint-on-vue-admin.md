...
``` html
…
    <ct-language-switcher></ct-language-switcher>
…
```
...
``` html
    …
    <div v-for="strategy in strategies" class="ct-app-app-url-changed-modal__content-choices">
    …
    <ct-icon small color="#189eff" name="default-basic-shape-circle-filled"></ct-icon>
    …
```
...
``` html
    ...
    <div
        ...
        class="ct-app-app-url-changed-modal__content-choices"
    >
    …
    <ct-icon
        small

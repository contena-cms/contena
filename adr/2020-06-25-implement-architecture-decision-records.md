...
## Consequences
From now on, every architecture decision, affecting the contena platform or one of its components, has to be recorded in an ADR, following the described workflow.
...
Every developer working with contena platform!

**When do you have to create an ADR?**  
Have you made a significant decision that impacts how developers should write code in the contena platform? Write an ADR! Here are some cases, which can help you to understand when to write an ADR:

...
## Decision
The current clone behavior is controlled by the `Contena\Core\Framework\DataAbstractionLayer\Field\Flag\CascadeDelete` flag.
...
## Consequences
After 6.3 released, the developer can control this behavior by setting `\Contena\Core\Framework\DataAbstractionLayer\Field\Flag\CascadeDelete::$cloneRelevant` to false

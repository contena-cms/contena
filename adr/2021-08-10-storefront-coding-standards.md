...
* The controller class requires the annotation: `#[Route(defaults: [\Contena\Core\PlatformRequest::ATTRIBUTE_ROUTE_SCOPE => [\Contena\Storefront\Framework\Routing\StorefrontRouteScope::ID]])]`
...
* A storefront controller has to extend the `\Contena\Storefront\Controller\StorefrontController`

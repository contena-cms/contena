---
title: Keep the Administration top bar under Contena control
date: 2026-04-15
area: administration
...
The Administration needs a minimal and stable UI shell that Contena can rely on globally. Alongside the navigation sidebar, the top bar is one of the very few shell elements that stay relevant across modules and viewport sizes.
...
* Contena loses control over parts of the interface that must remain consistently available.
...
Extensions may no longer hide the Administration top/search bar. The top/search bar is part of the minimal stable Administration shell and stays under Contena control.

...
## Context
The current ct-text-editor in the administration has numerous low-level bugs in basic WYSIWYG features. It is built in a
...
## Consequences
We need to replace our current ct-text-editor with the new editor. We have chosen TipTap as the base for our new text

...
namespace Contena\Core\Checkout\Gateway;

use Contena\Core\Checkout\Gateway\Command\Struct\CheckoutGatewayPayloadStruct;
...
### App-System
For the initial release, Contena will support a single implementation of the `CheckoutGatewayInterface`, provided by the app-system.

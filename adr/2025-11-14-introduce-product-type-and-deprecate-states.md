...
- This registry help both core rules and plugins can register additional product types via the parameter `%contena.product.allowed_types%` as an array.
...
- You can now easily register new product types by override `contena.product.allowed_types` in your `config/packages/contena.yaml`. For e.g:

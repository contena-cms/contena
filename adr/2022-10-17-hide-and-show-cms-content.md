...
<ct-checkbox-field
    ...
    class=ct-cms-visibility-config__checkbox-input
    :label="$tc('ct-cms.sidebar.contentMenu.visibilityMobile')"
/>

<ct-checkbox-field
    v-model="visibility.tablet"
    class="ct-cms-visibility-config__checkbox-input"
    :label="$tc('ct-cms.sidebar.contentMenu.visibilityTablet')"
/>

<ct-checkbox-field
    v-model="visibility.desktop"
    class="ct-cms-visibility-config__checkbox-input"
    :label="$tc('ct-cms.sidebar.contentMenu.visibilityDesktop')"
/>
```

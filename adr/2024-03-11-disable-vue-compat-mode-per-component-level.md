...
This custom configuration is exposed in `Contena.compatConfig` and has all compatibility features disabled if the
feature flag is activated.

### Example

```javascript
Contena.Component.register('your-component', {
...
syntax `compatConfig: Contena.compatConfig,` inside the component definition. Any other syntax, e.g. `compatConfig: false,`

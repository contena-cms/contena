...
- Apps cannot currently provide custom document generators or hook into existing ones to modify their output
  (see [contena#9676](https://github.com/contena/contena/issues/9676) and
  [contena#10478](https://github.com/contena/contena/issues/10478)).
- The Zugferd library we use, [horstoeko/zugferd](https://github.com/horstoeko/zugferd), has been declared legacy.
  ...
  - Additionally, exposing its builder pattern to third-party extensions is not the cleanest interface,
    especially for apps. Right now it is wrapped behind a Contena `ZugferdBuilder`,
...
break easily with each Contena major release, and block future internal improvements.
...
[2026-03-18-new-document-generation-architecture.md](https://github.com/contena/contena/blob/trunk/adr/2026-03-18-new-document-generation-architecture.md)

The new extension points are described here:
[2026-03-19-new-document-generation-extension-points.md](https://github.com/contena/contena/blob/trunk/adr/2026-03-19-new-document-generation-extension-points.md)

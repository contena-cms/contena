...
### Example
The test for the `ct-cms-el-config-image` component will be moved to `src/Administration/Resources/app/administration/src/module/ct-cms/component/ct-cms-el-config-image/ct-cms-el-config-image.spec.js`.

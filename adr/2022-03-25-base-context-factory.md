...
Therefore, a cache for the corresponding service (`Contena\Core\System\SalesChannel\Context\SalesChannelContextFactory`) has already been implemented in the past: `Contena\Core\System\SalesChannel\Context\CachedSalesChannelContextFactory`.
...
namespace Contena\Core\System\SalesChannel\Context;
...
For this we have implemented the `Contena\Core\System\SalesChannel\Context\BaseSalesChannelContextFactory`, which is responsible for creating the `Contena\Core\System\SalesChannel\BaseSalesChannelContext`.
...
namespace Contena\Core\System\SalesChannel;
...
In addition to the `Contena\Core\System\SalesChannel\Context\BaseSalesChannelContextFactory` the `Contena\Core\System\SalesChannel\Context\CachedBaseSalesChannelContextFactory` was implemented, which is responsible for caching the base context.

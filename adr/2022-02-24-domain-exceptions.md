...
Until now, we have implemented many different exception classes in Contena to map different exception cases.
...
namespace Contena\Core\Content\Cms;
...
namespace Contena\Core\Content\Product {

    class ProductException extends ContenaHttpException
    {
        public static function notFound(?\Throwable $e = null): void
        {
...
namespace Contena\Core\Content\Product\Exception {

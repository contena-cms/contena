...
Contena will apply validation rules to ensure consistency and prevent conflicting command execution.
...
All implementations of `AbstractContextGatewayCommandHandler` must be tagged with the `contena.context.gateway.command` service tag.

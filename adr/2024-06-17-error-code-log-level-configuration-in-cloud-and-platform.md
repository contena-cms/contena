...
* all the unexpected stuff that should not happen and a dev should look at this, even though the fix is not in Contena itself but probably in some calling code/configuration
* like API misuses

...
```javascript
Component.extend('ct-condition-script', 'ct-condition-base', {
    template,
    inheritAttrs: false,
    ...
    computed: {
        ...
        currentError() {
            ...
            Object.keys(this.constraints).forEach((key) => {
                ...
                const errorProperty = Contena.State.getters['error/getApiError'](this.condition, `value.${key}`);
...
```html
<!-- /src/app/component/rule/condition-type/ct-condition-script/ct-condition-script.html.twig -->
{% block sw_condition_value_content %}
<div class="ct-condition-script ct-condition__condition-value">
    ...
    >
        ...
        <!-- e.g. ct-entity-multi-select, ct-tagged-field, ct-number-field ... -->
    </ct-arrow-field>
    {% endblock %}
</div>
{% endblock %}

...
Unit tests are an essential part of our software. The Contena product grows and grows, the release cycles become shorter and shorter, more and more developers work with the software.
...
## Examples
Here are some good examples of contena unit tests:
- [CriteriaTest](https://github.com/contena/contena/blob/trunk/tests/unit/Core/Framework/DataAbstractionLayer/Search/CriteriaTest.php)
  - Good example for simple DTO tests
- [CashRounding](https://github.com/contena/contena/blob/trunk/tests/unit/Core/Checkout/Cart/Price/CashRoundingTest.php)
  - Nice test matrix for single service coverage
- [AddCustomerTagActionTest](https://github.com/contena/contena/blob/trunk/tests/unit/Core/Content/Flow/Dispatching/Action/AddCustomerTagActionTest.php)
...
- [ProductCartTest](https://github.com/contena/contena/blob/trunk/src/Core/Content/Test/Product/Cart/ProductCartTest.php)
  - Slim product cart test with good helper function integrations
- [CachedProductListingRouteTest](https://github.com/contena/contena/blob/trunk/src/Core/Content/Test/Product/SalesChannel/Listing/CachedProductListingRouteTest.php)
...
The absence of such abstraction in the existing `contena/platform` codebase is one of the reasons why it is so hard to write "good" unit tests for contena, but that does not mean that we should keep designing our code as we used and keep writing "bad" (meaning unit tests tightly coupled to the implementation) unit tests.

...
name: ct-review
description: >
    Review a Contena 6 GitHub pull request or local diff. Use when the user asks
...
Senior Contena 6 reviewer. Be calibrated: real findings only, no padding.

This skill drives the **interactive** review path. The **unattended CI path**
runs in GitHub Agentic Workflows (`gh aw`) from `.github/workflows/ct-review.md`,
...
**`.github/aw/shared/ct-review-policy.md`** and the same `personas/` +
...
```text
You are a Contena PR review persona-worker. Load:
- .agents/skills/ct-review/personas/[slug].md
- .agents/skills/ct-review/references/RUNTIME.md
- .agents/skills/ct-review/references/CLASSIFICATION.md for severity, confidence, decision, and risk
- .agents/skills/ct-review/references/DIFF-DISCIPLINE.md only when needed
- .agents/skills/ct-review/references/SCHEMA.md for JSON shape

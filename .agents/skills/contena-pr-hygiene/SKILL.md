---
name: contena-pr-hygiene
description: Prepare or update Contena pull requests. Use when writing or editing a PR description or PR text (incl. "output a PR description"), choosing a PR title, responding to review feedback, or updating a PR after CI failures.
license: MIT
---

---
name: contena-release-docs
description: Decide and write Contena developer-facing release documentation (RELEASE_INFO / UPGRADE / changelog entries). Use when a change may affect extension authors, API consumers, operators, or storefront/theme developers — public APIs, deprecations, removals, configuration, or upgrade steps.
license: MIT
---

# Contena Release Docs

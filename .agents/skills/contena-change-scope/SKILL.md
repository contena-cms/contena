---
name: contena-change-scope
description: Scope Contena bug fixes, cleanups, and behavioral changes. Use when fixing an issue, applying review feedback, deciding whether to broaden a cleanup, or checking that the change addresses the root cause instead of one symptom.
license: MIT
---

# Contena Change Scope

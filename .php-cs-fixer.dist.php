...
return new Config()
    ...
    ->setRules([
        ...
        'modern_serialization_methods' => false, // TODO: enable again with https://github.com/contena/contena/issues/15465
    ...
    ->setUsingCache(true)
    ->setCacheFile(Path::join($_SERVER['CONTENA_TOOL_CACHE_ECS'] ?? 'var/cache/cs_fixer', 'cs_fixer.cache'))
    ->setFinder(
        new Finder()

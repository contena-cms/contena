...
namespace Contena\Tests\Unit\Elasticsearch\Event;
...
class ElasticsearchCustomFieldsMappingEventTest extends TestCase
{
    public function testEvent(): void
    {
        ...
        $event = new ElasticsearchCustomFieldsMappingEvent(BlogDefinition::ENTITY_NAME, ['field1' => 'text'], $context);
        static::assertSame('blog', $event->getEntity());

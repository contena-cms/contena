...
class TokenQueryBuilderTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        $this->tokenQueryBuilder = new TokenQueryBuilder(
            ...
            $this->createFieldQueryBuilder(),
        );
    }

    public function testBuildWithInvalidField(): void
    {
        $query = $this->tokenQueryBuilder->build('blog', 'foo', [
    ...
    {
        $query = $this->tokenQueryBuilder->build('blog', 'foo', [], Context::createDefaultContext());
        static::assertNull($query);
    }
    ...
    public function testBuildWithExplainMode(): void
    {
        ...
        $query = $this->tokenQueryBuilder->build('blog', $term, $config, $context);
    ...
    public static function buildSingleLanguageProvider(): \Generator
    {
        ...
        yield 'Test multiple fields OR search' => [
            'config' => [
                ...
                self::config(field: 'autoIncrement', ranking: 1500, and: false),
    ...
    public function testBuildWithLanguageAnalyzerDisabled(): void
    {
        $tokenQueryBuilder = new TokenQueryBuilder(
            ...
            $this->createFieldQueryBuilder(false),
        );
        ...
        $query = $tokenQueryBuilder->build('blog', 'foo', $config, $context);
        static::assertNotNull($query);
        ...
        $phraseQuery = $tokenQueryBuilder->build('blog', 'foo bar', $phraseConfig, $context);
    ...
    public function testTieBreakerRewardsMultiClauseMatchWithinField(): void
    {
        ...
        $query = $this->tokenQueryBuilder->build('blog', 'stihl', $config, $context);
        static::assertNotNull($query);
    ...
    public function testTieBreakerRewardsMultiLanguageMatch(): void
    {
        ...
        $query = $this->tokenQueryBuilder->build('blog', 'foo', $config, $context);
        static::assertNotNull($query);
    ...
    public function testTieBreakerWithNgramClause(): void
    {
        ...
        $query = $this->tokenQueryBuilder->build('blog', 'foooooooooo', $config, $context);
        static::assertNotNull($query);
    ...
    {
        $builder = $this->createFieldQueryBuilder();
    ...
    private function createFieldQueryBuilder(bool $useLanguageAnalyzer = true): AbstractFieldQueryBuilder
    {
     ...
     * must match {@see \Contena\Elasticsearch\FieldQueryBuilder} so the encoded strings compare equal.
     */

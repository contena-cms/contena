...
class ElasticsearchExceptionTest extends TestCase
{
    ...
    {
        $exception = ElasticsearchException::definitionNotFound('blog');

        static::assertSame('ELASTICSEARCH__DEFINITION_NOT_FOUND', $exception->getErrorCode());
        static::assertSame('Definition blog not found', $exception->getMessage());
        static::assertSame(Response::HTTP_BAD_REQUEST, $exception->getStatusCode());
    }

    public function testUnsupportedDefinition(): void
    {
        $exception = ElasticsearchException::unsupportedElasticsearchDefinition('blog');

        static::assertSame('ELASTICSEARCH__UNSUPPORTED_DEFINITION', $exception->getErrorCode());
        static::assertSame('Definition blog is not supported for elasticsearch', $exception->getMessage());
        static::assertSame(Response::HTTP_BAD_REQUEST, $exception->getStatusCode());
    }

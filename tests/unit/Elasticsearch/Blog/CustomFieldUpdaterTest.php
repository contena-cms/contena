...
class CustomFieldUpdaterTest extends TestCase
{
    ...
    public function testNotBlogWritten(): void
    {
    ...
    public function testCustomFieldCreationDoesCreateThemInES(): void
    {
        ...
        $gateway->expects($this->once())
            ...
            ->willReturn([$customFieldSetId => ['blog']]);
    ...
    public function testCustomFieldsAreNotIndexedWhenNonBlogAssociationIsAddedToFieldSet(): void
    {
        $elasticsearchHelper = static::createStub(ElasticsearchHelper::class);
        $elasticsearchHelper
            ->method('allowIndexing')
        ...
        $writeResults = [
            new EntityWriteResult(
                ...
                ['entityName' => 'member', 'customFieldSetId' => $customFieldSetId],
    ...
    public function testCustomFieldsAreIndexedWhenBlogAssociationIsAddedToFieldSet(): void
    {
        $elasticsearchHelper = static::createStub(ElasticsearchHelper::class);
        $elasticsearchHelper
            ->method('allowIndexing')
        ...
        $writeResults = [
            new EntityWriteResult(
                $customFieldSetRelationId,
                ['entityName' => 'blog', 'customFieldSetId' => $customFieldSetId],
                CustomFieldSetRelationDefinition::ENTITY_NAME,
                EntityWriteResult::OPERATION_INSERT
            ),
        ];
    ...
    public function testOnlyBlogCustomFieldsAreCreatedInES(): void
    {
        $elasticsearchHelper = static::createStub(ElasticsearchHelper::class);
        $elasticsearchHelper
            ->method('allowIndexing')
        ...
        $gateway->expects($this->once())
            ...
            ->willReturn([
                $customFieldSetId1 => ['member'],
                $customFieldSetId2 => ['blog', 'member'],
            ]);
        ...
        $mappingHelper
            ...
            ->method('createFieldsInIndices')
            ->with(static::callback(static function (array $fields) {
                // Only field2 should be indexed (blog-related, includeInSearch)
    ...
    public function testCustomFieldsUpdatedNotRelatedToBlog(): void
    {
        $elasticsearchHelper = static::createStub(ElasticsearchHelper::class);
        $elasticsearchHelper
            ->method('allowIndexing')
        ...
        $gateway->expects($this->once())
            ->method('fetchFieldSetEntityMappings')
            ->with([$customFieldSetId])
            ->willReturn([$customFieldSetId => ['member']]); // Not blog!
    ...
    public function testBothCustomFieldAndRelationEventsProcessed(): void
    {
        ...
        $relationWriteResults = [
            new EntityWriteResult(
                $relationId,
                ['entityName' => 'blog', 'customFieldSetId' => $relationSetId],
                CustomFieldSetRelationDefinition::ENTITY_NAME,
                EntityWriteResult::OPERATION_INSERT
            ),
        ];

...
class AdminSearchIndexingMessageTest extends TestCase
{
    ...
    {
        yield 'same data' => [
            ['blog', 'blog-listing', ['ct-admin-blog-listing' => 'ct-admin-blog-listing_12345'], ['c1a28776116d4431a2208eb2960ec340']],
            ['blog', 'blog-listing', ['ct-admin-blog-listing' => 'ct-admin-blog-listing_12345'], ['c1a28776116d4431a2208eb2960ec340']],
            true,
        ];
        yield 'different order same data' => [
            ['blog', 'blog-listing', ['ct-admin-blog-listing' => 'ct-admin-blog-listing_12345', 'ct-admin-category-listing' => 'ct-admin-category-listing_67890'], ['c1a28776116d4431a2208eb2960ec340', 'c2b39887227e5542b3319fc4071fd451']],
            ['blog', 'blog-listing', ['ct-admin-category-listing' => 'ct-admin-category-listing_67890', 'ct-admin-blog-listing' => 'ct-admin-blog-listing_12345'], ['c2b39887227e5542b3319fc4071fd451', 'c1a28776116d4431a2208eb2960ec340']],
            true,
        ];
        yield 'different data' => [
            ['blog', 'blog-listing', ['ct-admin-blog-listing' => 'ct-admin-blog-listing_12345'], ['c1a28776116d4431a2208eb2960ec340']],
            ['blog', 'blog-listing', ['ct-admin-blog-listing' => 'ct-admin-blog-listing_12345'], ['c2b39887227e5542b3319fc4071fd451']],
            false,
        ];
    }

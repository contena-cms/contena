...
class ElasticsearchIndexingMessageTest extends TestCase
{
    ...
    public static function provideDeduplicationData(): iterable
    {
        ...
        yield 'same data' => [
            [new IndexingDto(['id1', 'id2'], 'test-index', 'blog'), null, $context],
            [new IndexingDto(['id1', 'id2'], 'test-index', 'blog'), null, $context],
            true,
        ];

        yield 'different order same ids' => [
            [new IndexingDto(['id2', 'id1'], 'test-index', 'blog'), null, $context],
            [new IndexingDto(['id1', 'id2'], 'test-index', 'blog'), null, $context],
            true,
        ];
        ...
        yield 'different ids' => [
            [new IndexingDto(['id1', 'id2'], 'test-index', 'blog'), null, $context],
            [new IndexingDto(['id1', 'id3'], 'test-index', 'blog'), null, $context],
            false,
        ];

        yield 'different index' => [
            [new IndexingDto(['id1', 'id2'], 'test-index-1', 'blog'), null, $context],
            [new IndexingDto(['id1', 'id2'], 'test-index-2', 'blog'), null, $context],
            false,
        ];
        ...
        yield 'different offset' => [
            [new IndexingDto(['id1', 'id2'], 'test-index', 'blog'), new IndexerOffset(['blog'], 1751556420, ['offset' => 1]), $context],
            [new IndexingDto(['id1', 'id2'], 'test-index', 'blog'), new IndexerOffset(['blog'], 1751556421, ['offset' => 2]), $context],
            false,
        ];
        ...
        yield 'different context' => [
            [new IndexingDto(['id1', 'id2'], 'test-index', 'blog'), new IndexerOffset(['blog'], 1751556420, ['offset' => 1]), $context],
            [new IndexingDto(['id1', 'id2'], 'test-index', 'blog'), new IndexerOffset(['blog'], 1751556420, ['offset' => 1]), $context2],
            false,
        ];
    }
}

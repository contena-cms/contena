...
namespace Contena\Tests\Unit\Frontend\Event;
 ...
 * @internal
 */
#[CoversClass(FrontendRedirectEvent::class)]
class FrontendRedirectEventTest extends TestCase
{
    public function testMinimalConstructor(): void
    {
        $event = new FrontendRedirectEvent('test_route');
    ...
    {
        $event = new FrontendRedirectEvent('test_route', ['test_parameter' => 'test_value'], 500);

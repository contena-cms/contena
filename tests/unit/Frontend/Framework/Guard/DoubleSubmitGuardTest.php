...
{
    private const string SCOPE = 'frontend-registration';

    private const string TOKEN = 'context-token';

    private const string WINNER_TOKEN = 'winner-context-token';
    ...
    {
        return Generator::generateChannelContext(token: self::TOKEN);
    }

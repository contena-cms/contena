...
class NotFoundSubscriberTest extends TestCase
{
    public function testDebugIsOnDoesNothing(): void
    {
        $subscriber = new NotFoundSubscriber(
            ...
            static::createStub(ChannelContextRequestRestorer::class),
            true,
    ...
    private function createContextRestorer(): ChannelContextRequestRestorer
    {
        ...
        $contextRestorer = static::createStub(ChannelContextRequestRestorer::class);
        $contextRestorer
            ->method('restore')
            ->willReturnCallback(static function (Request $request) use ($context): ChannelContext {

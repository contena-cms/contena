...
class ThemeCreateCommandTest extends TestCase
{
    ...
    public function testSuccessfulCreateCommand(): void
    {
        ...
        static::assertDirectoryDoesNotExist($expectedDirectory . 'Resources/app/frontend/src/scss/abstracts');
        ...
        static::assertSame('~6.8.0', $composer['require']['contena/core']);
    }
    ...
    public function testSuccessfulCreateFullCommand(): void
    {
        ...
        static::assertFileExists($expectedDirectory . 'Resources/snippet/frontend.en-GB.json');
        static::assertFileExists($expectedDirectory . 'Resources/snippet/frontend.zh-CN.json');
        static::assertFileDoesNotExist($expectedDirectory . 'Resources/snippet/frontend.de-DE.json');

        $scssBase = $expectedDirectory . 'Resources/app/frontend/src/scss/';
    ...
    public function testSuccessfulCreateWithConfigOnly(): void
    {
        ...
        static::assertDirectoryDoesNotExist($expectedDirectory . 'Resources/snippet');
        static::assertDirectoryDoesNotExist($expectedDirectory . 'Resources/app/frontend/src/scss/abstracts');
        static::assertFileExists($expectedDirectory . 'Resources/app/frontend/src/scss/base.scss');
    }

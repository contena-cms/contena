...
class ThemeRuntimeConfigServiceTest extends TestCase
{
    ...
    public function testGetResolvedRuntimeConfigResolvesJs(): void
    {
        ...
        $pluginRegistry = $this->createMock(FrontendPluginRegistry::class);
        $pluginRegistry
            ->expects($this->once())
            ->method('getConfigurations')
            ->willReturn(
                new FrontendPluginConfigurationCollection([
                    new FrontendPluginConfiguration($technicalName),
                ])
            );
    ...
    public function testGenerateRuntimeConfigForCopyStoresNullTechnicalName(): void
    {
        ...
        $themeConfig = new FrontendPluginConfiguration($parentTechnicalName);
        $themeConfig->setIconSets(['set1' => 'path/to/icons']);

        $pluginRegistry = static::createStub(FrontendPluginRegistry::class);
        $pluginRegistry
            ->method('getConfigurations')
            ->willReturn(new FrontendPluginConfigurationCollection([$themeConfig]));
    ...
    public function testRefreshRuntimeConfig(): void
    {
        ...
        $themeConfig = new FrontendPluginConfiguration($technicalName);
    ...
    public function testRefreshRuntimeConfigStoresComponentImportMapWhenProvided(): void
    {
        ...
        $importMap = [
            'imports' => [
                ...
                'Contena:Button' => 'js/components/Contena/Button.js',
            ],
        ];
    ...
    private function createService(
        ...
        ?FrontendPluginRegistry $pluginRegistry = null,

...
class ComposerVersionConstraintsTest extends TestCase
{
    ...
    public static function constraintProvider(): \Generator
    {
        ...
        yield 'contena/conflicts star constraint passes' => ['contena/conflicts', '*', null];
    ...
    {
        $context = $this->createContextWithComposerFile('src/Frontend/composer.json', ['monolog/monolog' => '3.5.0']);

        (new ComposerVersionConstraints())($context);

        static::assertCount(1, $context->getFailures());
        static::assertStringContainsString('src/Frontend/composer.json', $context->getFailures()[0]);
    }

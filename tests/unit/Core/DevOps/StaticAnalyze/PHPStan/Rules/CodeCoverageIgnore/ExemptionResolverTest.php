...
use Contena\Core\DevOps\StaticAnalyze\PHPStan\Rules\CodeCoverageIgnore\ExemptionResolver;
...
{
    private const string EXISTING_TEST = 'Contena\Tests\Integration\Core\Framework\Webhook\Service\RelatedWebhooksTest';
    ...
    public static function caseProvider(): \Generator
    {
        ...
        yield 'FQCN to existing integration test exempts' => [
            '/** @see \\Contena\\Tests\\Integration\\Core\\Framework\\Webhook\\Service\\RelatedWebhooksTest */',
            [],
            true,
        ];

        yield 'FQCN to non-existent integration test does not exempt' => [
            '/** @see \\Contena\\Tests\\Integration\\Definitely\\Not\\A\\RealTest */',
            [],
            false,
        ];

        yield 'FQCN to unit test (not integration) does not exempt' => [
            '/** @see \\Contena\\Tests\\Unit\\Core\\Framework\\SomeUnitTest */',
            [],
            false,
        ];

        yield '::method suffix on the reference is stripped' => [
            '/** @see \\Contena\\Tests\\Integration\\Core\\Framework\\Webhook\\Service\\RelatedWebhooksTest::testFoo */',
            [],
            true,
        ];
        ...
        yield 'short-form @see resolved through the use map exempts' => [
            ...
            ['RelatedWebhooksTest' => 'Contena\\Tests\\Integration\\Core\\Framework\\Webhook\\Service\\RelatedWebhooksTest'],
            true,
        ];

...
class CustomEntityEnrichmentServiceTest extends TestCase
{
    ...
    public function testEnrichCmsAwareAffectedEntities(): void
    {
        ...
        foreach ($enrichedCustomEntities as $enrichedCustomEntity) {
            ...
            static::assertContains('ct_title', $fieldNames);
            static::assertContains('ct_content', $fieldNames);
            static::assertContains('ct_cms_page', $fieldNames);
            static::assertContains('ct_slot_config', $fieldNames);
            static::assertContains('ct_categories', $fieldNames);
            static::assertContains('ct_og_image', $fieldNames);
            static::assertContains('ct_seo_meta_title', $fieldNames);
            static::assertContains('ct_seo_meta_description', $fieldNames);
    ...
    public function testEnrichCmsAwareUnaffectedEntities(): void
    {
        ...
        foreach ($enrichedCustomEntities as $enrichedCustomEntity) {
            ...
            static::assertNotContains('ct_title', $fieldNames);
            static::assertNotContains('ct_description', $fieldNames);
            static::assertNotContains('ct_cms_page', $fieldNames);
            static::assertNotContains('ct_categories', $fieldNames);
            static::assertNotContains('ct_media', $fieldNames);
            static::assertNotContains('ct_seo_meta_title', $fieldNames);
            static::assertNotContains('ct_seo_meta_description', $fieldNames);
            static::assertNotContains('ct_seo_keywords', $fieldNames);
    ...
    public function testEnrichAdminUiAffectedEntities(): void
    {
        ...
        foreach ($outerEnrichedCustomEntities->getEntities() as $enrichedCustomEntity) {
            ...
            static::assertSame('ct-content', $adminUi->getVars()['navigationParent']);

...
class CustomEntityXmlSchemaValidatorTest extends TestCase
{
    ...
    public function testValidateAllowsValidFieldNames(string $fieldName): void
    {
        $dom = new \DOMDocument();
        $dom->loadXML(\sprintf(
            '<entity name="ce_test"><fields><string name="%s" channel-api-aware="true"/></fields></entity>',
            $fieldName
        ));
    ...
    public static function xmlProvider(): \Generator
    {
        ...
        yield 'whitespace-in-field-name' => [
            ...
            <entity name="ce_test">
                <fields>
                    <int name="foo bar" channel-api-aware="true"/>
                </fields>
            </entity>
            XML,
        ...
        yield 'backtick-in-entity-name' => [
            ...
            <entity name="ce_test`x">
                <fields>
                    <string name="title" channel-api-aware="true"/>
                </fields>
            </entity>
            XML,
        ...
        yield 'field-name-with-invalid-character' => [
            ...
            <entity name="ce_test">
                <fields>
                    <string name="my-field" channel-api-aware="true"/>
                </fields>
            </entity>
            XML,

...
class SchemaUpdaterTest extends TestCase
{
    ...
    public function testInvalidNamesAreRejectedThroughTheNameValidator(): void
    {
        ...
        $updater->applyCustomEntities(new Schema(), [[
            'name' => 'ce_poc',
            'fields' => \json_encode([['name' => 'foo bar', 'type' => 'int', 'channelApiAware' => true]], \JSON_THROW_ON_ERROR),
        ]]);
    }
    ...
    public function testBlogExample(): void
    {
        $entities = [
            [
                ...
                'fields' => '[{"name":"position","channelApiAware":true,"type":"int","required":false},{"name":"rating","channelApiAware":true,"type":"float","required":false},{"name":"title","channelApiAware":true,"type":"string","translatable":true,"required":true},{"name":"content","channelApiAware":true,"allowHtml":true,"type":"text","translatable":true,"required":false},{"name":"products","channelApiAware":true,"reference":"product","inherited":false,"onDelete":"cascade","type":"many-to-many"},{"name":"top_seller","channelApiAware":true,"reference":"product","inherited":false,"onDelete":"set-null","type":"many-to-one","required":false},{"name":"comments","channelApiAware":true,"reference":"custom_entity_blog_comment","inherited":false,"onDelete":"set-null","type":"one-to-many","reverseRequired":false},{"name":"author","channelApiAware":false,"reference":"user","inherited":false,"onDelete":"set-null","type":"one-to-one","required":false}]',
            ],
            [
                'name' => 'custom_entity_blog_comment',
                'fields' => '[{"name":"title","channelApiAware":true,"type":"string","translatable":true,"required":true},{"name":"products","channelApiAware":true,"reference":"product","inherited":false,"onDelete":"set-null","type":"one-to-many","reverseRequired":false}]',
            ],
        ];

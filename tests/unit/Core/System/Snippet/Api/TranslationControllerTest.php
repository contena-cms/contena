...
use Contena\Core\System\Snippet\Request\InstallTranslationRequest;
...
class TranslationControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        $this->config = new TranslationConfig(
            ...
            ['zh-CN', 'en-GB'],
            new Uri('https://translate.contena.cn'),
            'ct-settings-language.addModal.docsUrl',
            ['ach-UG'],
            90,
        );
    }
    ...
    public function testMetaReturnsTheConfiguredMetaInformation(): void
    {
        ...
        static::assertSame('https://translate.contena.cn', $content['communityTranslationsUrl']);
        static::assertSame('ct-settings-language.addModal.docsUrl', $content['documentationUrlSnippetKey']);

...
class ConsentExceptionTest extends TestCase
{
    ...
    {
        $e = ConsentException::invalidRevision('admin_tracking', '1.0.0', '2.0.0');

        static::assertSame(Response::HTTP_BAD_REQUEST, $e->getStatusCode());
        static::assertSame(ConsentException::INVALID_REVISION, $e->getErrorCode());
        static::assertSame('Cannot accept consent "admin_tracking" for revision "1.0.0". The latest revision is "2.0.0".', $e->getMessage());
        static::assertSame([
            'consent' => 'admin_tracking',

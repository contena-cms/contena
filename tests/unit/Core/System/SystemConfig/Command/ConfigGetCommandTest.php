...
class ConfigGetCommandTest extends TestCase
{
    ...
    private function getConfigGetCommand(): ConfigGet
    {
        ...
        $systemConfigService->set('foo.bar.testString', 'test', TestDefaults::CHANNEL);
        $systemConfigService->set('foo.bar.testInt', 123, TestDefaults::CHANNEL);
        $systemConfigService->set('foo.bar.testBoolTrue', true, TestDefaults::CHANNEL);
        $systemConfigService->set('foo.bar.testBoolFalse', false, TestDefaults::CHANNEL);

...
class SystemConfigValidatorTest extends TestCase
{
    ...
    public function testValidateSuccess(array $inputValues, array $formConfigs): void
    {
        ...
        try {
            $systemConfigValidation->validate(['null' => $inputValues], $contextMock);
    ...
    public function testValidateUsesConfigurationDomainForNestedKeys(): void
    {
        ...
        $systemConfigValidation->validate(['null' => [
    ...
    public function testBuildConstraintsWithConfigs(array $elementConfig, array $expected): void
    {
        ...
        $result = $refMethod->invoke($systemConfigValidation, $elementConfig, false);

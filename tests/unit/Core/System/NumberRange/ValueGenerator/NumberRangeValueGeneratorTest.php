...
class NumberRangeValueGeneratorTest extends TestCase
{
    ...
    {
        $value = $this->getGenerator('Pre_{n}_suf')->getValue('media', Context::createDefaultContext());
        static::assertSame('Pre_5_suf', $value);
    }

    public function testGenerateDatePattern(): void
    {
        $value = $this->getGenerator('Pre_{date}_suf')->getValue('media', Context::createDefaultContext());
    ...
    {
        $value = $this->getGenerator('Pre_{date_ymd}_suf')->getValue('media', Context::createDefaultContext());
        static::assertSame('Pre_' . date('ymd') . '_suf', $value);
    }

    public function testGenerateAllPatterns(): void
    {
        $value = $this->getGenerator('Pre_{date}_{date_ymd}_{n}_suf')->getValue('media', Context::createDefaultContext());
        static::assertSame(
    ...
    {
        $value = $this->getGenerator('Pre_!"§$%&/()=_{date}_{date_ymd}_{n}_suf')->getValue('media', Context::createDefaultContext());
        static::assertSame(

 ...
 * @internal
 */
#[CoversClass(ChannelFileDiscovery::class)]
class ChannelFileDiscoveryTest extends TestCase
{
    public function testItDiscoversChannelFilesForFileFamily(): void
    {
        $discovery = new ChannelFileDiscovery(
            new ChannelFileStaticTemplateIterator([
    ...
    public function testItCachesDiscoveredFilesAcrossInstances(): void
    {
        ...
        $firstDiscovery = new ChannelFileDiscovery($firstTemplateIterator, $cache);
        $secondDiscovery = new ChannelFileDiscovery($secondTemplateIterator, $cache);
 ...
 * @internal
 */
final readonly class ChannelFileStaticTemplateIterator implements TemplatePathIteratorInterface
{
    /**

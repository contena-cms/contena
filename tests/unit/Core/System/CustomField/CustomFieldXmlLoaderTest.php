...
class CustomFieldXmlLoaderTest extends TestCase
{
    public function testLoad(): void
    {
        ...
        static::assertSame(['media', 'user'], $firstSet->getRelatedEntities());
        ...
        static::assertSame(['media_folder'], $secondSet->getRelatedEntities());
    ...
    public function testToEntityArrayWithoutAppId(): void
    {
        ...
        $existingRelations = [];
        $existingFields = [];
        $result = $set->toEntityArray($existingRelations, $existingFields);
    ...
    public function testToEntityArrayWithExistingSetId(): void
    {
        $customFields = CustomFieldXmlLoader::load(__DIR__ . '/_fixtures/custom-fields.xml');
        ...
        $existingRelations = [];
        $existingFields = [];
        $result = $set->toEntityArray($existingRelations, $existingFields, 'existing-set-id');

        static::assertArrayHasKey('id', $result);
        static::assertSame('existing-set-id', $result['id']);

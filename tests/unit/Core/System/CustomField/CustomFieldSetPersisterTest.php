...
class CustomFieldSetPersisterTest extends TestCase
{
    ...
    public function testSyncNewSetsForPluginUpsertsWithoutAppId(): void
    {
        ...
        $this->persister->sync($this->loadFixture(), 'TestPlugin', Context::createDefaultContext());
        ...
        static::assertSame(['media', 'user'], array_column($first['relations'], 'entityName'));
    ...
    public function testSyncEmptyDefinitionDeletesAllExistingSets(): void
    {
        ...
        $this->persister->sync(CustomFields::fromArray([]), 'TestPlugin', Context::createDefaultContext());
    ...
    public function testSyncEmptyPluginDefinitionDeletesExistingSetsByExtensionName(): void
    {
        ...
        $persister->sync(CustomFields::fromArray([]), 'TestPlugin', Context::createDefaultContext());
    ...
    public function testSyncExistingSetCarriesIdAndDeletesObsoleteChildren(): void
    {
        ...
        $this->persister->sync($fixture, 'TestPlugin', Context::createDefaultContext());
    ...
    public function testSyncDeletesDuplicateNamedSets(): void
    {
        ...
        $this->persister->sync($this->loadFixtureSingleSet(), 'TestPlugin', Context::createDefaultContext());

...
use Contena\Core\System\StateMachine\Event\StateMachineStateChangeEvent;
...
class StateMachineRegistryTest extends TestCase
{
    ...
    {
        return new EntitySearchResult($collection->count(), $collection, null, new Criteria(), $context);
    }

...
class OpenApiRouteDefaultsFilterTest extends TestCase
{
    public function testFiltersOnlyStrictFalseRouteDefaultsLoadedFromAttributes(): void
    {
        ...
        static::assertNotNull($routeCollection->get('channel-api.example.legacy-detail'));
...
{
    #[Route(
        path: '/channel-api/example/detail/{id}',
        name: 'channel-api.example.legacy-detail',
        defaults: [
    ...
    #[Route(
        path: '/channel-api/example/{id}',
        name: 'channel-api.example.detail',
    ...
    #[Route(
        path: '/channel-api/example/explicitly-visible/{id}',
        name: 'channel-api.example.explicitly-visible',
    ...
    #[Route(
        path: '/channel-api/example/null/{id}',
        name: 'channel-api.example.null',
    ...
    #[Route(
        path: '/channel-api/example/string-false/{id}',
        name: 'channel-api.example.string-false',
    ...
    #[Route(
        path: '/channel-api/example/mixed/{id}',
        name: 'channel-api.example.mixed-hidden-get',
        defaults: [PlatformRequest::ATTRIBUTE_OPENAPI => false],
        methods: ['GET']
    )]
    ...
    #[Route(
        path: '/channel-api/example/mixed/{id}',
        name: 'channel-api.example.mixed-visible-post',
        methods: ['POST']
    )]

...
class CreateIntegrationCommandTest extends TestCase
{
    ...
    public function testCreateIntegration(bool $adminOption): void
    {
        ...
        static::assertSame($accessKey, $parsedEnv['CONTENA_ACCESS_KEY_ID']);
        static::assertSame($secretAccessKey, $parsedEnv['CONTENA_SECRET_ACCESS_KEY']);
    }
    ...
    public function testCreateIntegrationWithCustomKeys(): void
    {
        ...
        $parsedEnv = new Dotenv()->parse($output);
        static::assertCount(2, $parsedEnv);
        static::assertSame($customAccessKey, $parsedEnv['CONTENA_ACCESS_KEY_ID']);
        static::assertSame($customSecretAccessKey, $parsedEnv['CONTENA_SECRET_ACCESS_KEY']);
    }
}

 ...
 * @internal
 */
#[CoversClass(ContenaAuthCodeGrantType::class)]
class ContenaAuthCodeGrantTypeTest extends TestCase
{
    private ContenaAuthCodeGrantType $grant;

    protected function setUp(): void
    {
        $this->grant = new ContenaAuthCodeGrantType(
    ...
    public function testIdentifier(): void
    {
        ...
        static::assertSame(ContenaAuthCodeGrantType::TYPE, $this->grant->getIdentifier());
    }
    ...
    {
        $query = ['response_type' => 'code', 'client_id' => 'contena-cli', 'code_challenge' => str_repeat('a', 43)];
        if ($method !== null) {

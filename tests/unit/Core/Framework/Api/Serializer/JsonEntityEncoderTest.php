...
use Contena\Core\Framework\Test\Api\Serializer\AssertValuesTrait;
use Contena\Core\Framework\Test\DataAbstractionLayer\Field\TestDefinition\AssociationExtension;
...
use Contena\Core\Framework\Test\DataAbstractionLayer\Field\TestDefinition\ExtendableDefinition;
use Contena\Core\Framework\Test\DataAbstractionLayer\Field\TestDefinition\ExtendedDefinition;
use Contena\Core\Framework\Test\DataAbstractionLayer\Field\TestDefinition\ScalarRuntimeExtension;
...
use Contena\Tests\Integration\Core\Framework\Api\Serializer\fixtures\TestBasicStruct;
use Contena\Tests\Integration\Core\Framework\Api\Serializer\fixtures\TestBasicWithExtension;
use Contena\Tests\Integration\Core\Framework\Api\Serializer\fixtures\TestBasicWithToManyRelationships;
use Contena\Tests\Integration\Core\Framework\Api\Serializer\fixtures\TestBasicWithToOneRelationship;
...
class JsonEntityEncoderTest extends TestCase
{
    ...
    /**
     * These fields belong to excluded Commerce/CMS bundles and remain in the upstream
     * serializer fixtures for Contena's full distribution.
     *
     * @var list<string>
     */
    private const array EXCLUDED_FIXTURE_FIELDS = [
        'categories',
    ...
    protected function setUp(): void
    {
        $this->definitionRegistry = new StaticDefinitionInstanceRegistry(
            [
                BlogDefinition::class => BlogDefinition::class,
    ...
    public function testEncodeWithEmptyInput(mixed $input): void
    {
        ...
        $encoder->encode(new Criteria(), $this->createDefinition(BlogDefinition::class), $input, SerializationFixture::API_BASE_URL);
    }
    ...
    public function testEncodeComplexStructs(string $definitionClass, SerializationFixture $fixture): void
    {
        ...
        $this->assertValues($this->removeExcludedFixtureFields($fixture->getAdminJsonFixtures()), $actual);
    }
    ...
    public function testEncodeKeepsDecodedKeysWithoutBackingStructVars(): void
    {
        ...
        $struct = new class extends Entity {
            ...
            public function jsonSerialize(): array
            {
                ...
                $data['relatedContent'] = [['id' => '0fa91ce3e96a4bc2be4bd9ce752c3425']];
        ...
        static::assertSame([['id' => '0fa91ce3e96a4bc2be4bd9ce752c3425']], $actual['relatedContent']);
    }
     ...
     */
    private function removeExcludedFixtureFields(array $fixture): array
    {
        foreach ($fixture as $key => &$value) {
            if (\in_array((string) $key, self::EXCLUDED_FIXTURE_FIELDS, true)) {
                unset($fixture[$key]);
            ...
            if (\is_array($value)) {
                $value = $this->removeExcludedFixtureFields($value);
            }
        }
        unset($value);

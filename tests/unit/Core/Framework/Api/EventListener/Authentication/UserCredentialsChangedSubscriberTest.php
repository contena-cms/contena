...
{
    private const string USER_ID = '018d9dcce00a704ab034ec0694981ed5';
    ...
    public function testDeactivatingUserInvalidatesTokens(): void
    {
        ...
        $subscriber->onUserWritten($this->event(['id' => self::USER_ID, 'active' => false]));
    }
    ...
    public function testActivatingUserDoesNotInvalidateTokens(): void
    {
        ...
        $subscriber->onUserWritten($this->event(['id' => self::USER_ID, 'active' => true]));
    }

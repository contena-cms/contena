...
class ConfigurationTest extends TestCase
{
    public function testGetConfigTreeBuilder(): void
    {
        ...
        static::assertSame('contena', $tree->buildTree()->getName());
    }
    ...
    public function testCookieConsentDefaults(): void
    {
        ...
        static::assertSame(['log_storage' => 'none', 'retention_days' => 120], $config['cookie_consent']);
    }
    ...
    public function testNoVarySearchConfigRejectsInvalidValues($value, string $given): void
    {
        $this->expectExceptionObject(new InvalidConfigurationException(\sprintf(
            'Invalid configuration for path "contena.http_cache.policies.my_policy.headers.no_vary_search": '
    ...
    public static function invalidRemoteThumbnailFallbackSizes(): \Generator
    {
        yield 'zero width' => [
            ...
            'path' => 'contena.media.remote_thumbnails.fallback_sizes.0.width',
            'value' => 0,
        ];

        yield 'negative height' => [
            'fallbackSize' => ['width' => 100, 'height' => -1],
            'path' => 'contena.media.remote_thumbnails.fallback_sizes.0.height',
            'value' => -1,
        ];
    }
    ...
    public function testTranslationConfigRejectsInvalidListType(): void
    {
        ...
        $this->expectExceptionObject(new InvalidConfigurationException(
            'Invalid type for path "contena.translation.languages". Expected "array", but got "string"'
        ));
    ...
    public function testSystemConfigTreeNode(): void
    {
        ...
        static::assertInstanceOf(VariableNodeDefinition::class, $nodes['']);
    }
    ...
    public function testValidSystemConfigKeys(): void
    {
        ...
        static::assertTrue($systemConfigs['system_config']['core.platform.enabled']);
    }

    public function testBlogAllowedTypesNode(): void
    {
        $configuration = new Configuration();
        ...
        static::assertArrayHasKey('blog', $nodes);
        static::assertInstanceOf(ArrayNodeDefinition::class, $blogNode = $nodes['blog']);

        $nodes = $blogNode->getChildNodeDefinitions();

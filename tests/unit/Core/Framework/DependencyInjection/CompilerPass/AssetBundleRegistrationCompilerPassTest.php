...
class AssetBundleRegistrationCompilerPassTest extends TestCase
{
    public function testCompilerPass(): void
    {
        ...
        $container->setDefinition('contena.asset.asset_without_versioning', new Definition(Package::class));
        $container->setDefinition('contena.asset.public.version_strategy', new Definition(EmptyVersionStrategy::class));
        ...
        $container->set('contena.asset.asset_without_versioning', static::createStub(Package::class));

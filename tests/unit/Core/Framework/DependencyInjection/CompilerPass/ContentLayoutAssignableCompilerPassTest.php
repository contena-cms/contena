...
class ContentLayoutAssignableCompilerPassTest extends TestCase
{
    ...
    public function testCollectsEntityTypes(): void
    {
        ...
        $this->addSpecificationSource($container, 'blog_source', BlogContentLayoutDefinition::class);
        ...
        static::assertContains('blog', $argument);
    ...
    public function testThrowsOnEntityTypeSectionCollision(): void
    {
        ...
        $this->addSpecificationSource($container, 'blog_source', BlogContentLayoutDefinition::class);
        $this->addSectionSource($container, 'colliding_section', 'blog');

        $this->expectExceptionObject(DependencyInjectionException::rootSourceNamespaceCollision('blog'));
    ...
    public function testAcceptsEntityTypesDisjointFromSections(): void
    {
        ...
        static::assertSame(['blog'], $registryDefinition->getArgument('$entityTypes'));
    }
    ...
    {
        [$container, $registryDefinition] = $this->createContainerWithRegistry();
        $container->setDefinition(BlogContentLayoutDefinition::class, new Definition(BlogContentLayoutDefinition::class));
        ...
        $sourceDefinition->addTag('content_system.entity_specification_source');
        $container->setDefinition('blog_source', $sourceDefinition);
    ...
    {
        $validReference = new Reference(BlogContentLayoutDefinition::class);

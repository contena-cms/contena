...
class TelemetrySubscriberCompilerPassTest extends TestCase
{
    public function testTelemetrySubscribersAreRemovedWhenDisabled(): void
    {
        ...
        $container->setParameter('contena.telemetry.metrics.enabled', false);

        $definition = new Definition(\stdClass::class);
        $definition->addTag('kernel.event_subscriber');
        $definition->addTag('contena.telemetry.subscriber');
    ...
    public function testPeriodicMetricCollectorsAreRemovedWhenDisabled(): void
    {
        ...
        $collectorDef->addTag('contena.telemetry.periodic_metric_collector');
    ...
    {
        $container = new ContainerBuilder();
        $container->setParameter('contena.telemetry.metrics.enabled', true);
        ...
        static::assertTrue($container->getDefinition('test.telemetry.collector')->hasTag('contena.telemetry.periodic_metric_collector'));
    }
}

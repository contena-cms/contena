...
class McpToolAnalysisCompilerPassTest extends TestCase
{
    ...
    public function testToolDependencyIsResolvedAndStoredInParameter(): void
    {
        ...
        $deps = $container->getParameter('contena.mcp.tool_dependencies');

        static::assertArrayHasKey('my-analysis-dep-tool', $deps);
        static::assertSame(['contena-analysis-core-tool'], $deps['my-analysis-dep-tool']);
    }
    ...
    public function testUnknownToolDependencyThrows(): void
    {
        ...
        $this->expectExceptionMessageMatches('/contena-analysis-core-tool/');
    ...
    public function testStaticToolPrivilegeIsResolvedAndStored(): void
    {
        ...
        $privileges = $container->getParameter('contena.mcp.tool_privileges');
    ...
    public function testToolGroupsAreResolvedAndStored(): void
    {
        ...
        static::assertSame([
            'contena-analysis-explicit-group-tool' => 'catalogue',
            'contena-analysis-method-level-group-tool' => 'orders',
        ], $container->getParameter('contena.mcp.tool_groups'));
    }
    ...
    public function testToolWithMissingClassIsSkippedAndWarns(): void
    {
        ...
        static::assertSame([], $container->getParameter('contena.mcp.tool_groups'));
    ...
    public function testSkipsWhenNoMcpServerBuilder(): void
    {
        ...
        $container->setParameter('contena.mcp.tool_dependencies', []);
        $container->setParameter('contena.mcp.tool_privileges', []);
    ...
    private function createContainer(): ContainerBuilder
    {
        ...
        $container->setParameter('contena.mcp.tool_dependencies', []);
        $container->setParameter('contena.mcp.tool_privileges', []);
        $container->setParameter('contena.mcp.tool_groups', []);
 ...
 * @internal
 */
#[McpTool(name: 'contena-analysis-core-tool', description: 'analysis test core tool')]
 ...
 * @internal
 */
#[McpTool(name: 'my-analysis-dep-tool', description: 'tool that depends on contena-analysis-core-tool')]
#[McpToolDependsOn('contena-analysis-core-tool')]
 ...
 * @internal
 */
#[McpTool(name: 'contena-analysis-explicit-group-tool', description: 'tool with explicit group')]
...
{
    #[McpTool(name: 'contena-analysis-method-level-group-tool', description: 'method-level group tool')]
    #[McpToolGroup('orders')]
    public function __invoke(): string
    {
        return '';

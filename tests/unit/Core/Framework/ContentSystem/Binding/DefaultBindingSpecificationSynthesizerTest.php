...
class DefaultBindingSpecificationSynthesizerTest extends TestCase
{
    ...
    public function testSynthesizesOneResolvesEntryPerResolvedByProperty(): void
    {
        ...
        $result = $synthesizer->synthesize(
            [
                'properties' => [
                    'media' => ['type' => 'Contena\\Core\\Content\\Media\\MediaEntity', 'resolvedBy' => 'mediaId'],
        ...
        $result = $synthesizer->synthesize(
            [
                'properties' => [
                    ...
                    'media' => ['type' => 'Contena\\Core\\Content\\Media\\MediaEntity', 'resolvedBy' => ['entity' => ['property' => 123]]],
                    'mediaId' => ['type' => 'string'],
                ],
            ],
            'CT:Media:Image',
    ...
    public function testThrowsOnCollidingStorageKey(string|array $resolvedBy): void
    {
        ...
        $synthesizer->synthesize(
            [
                'properties' => [
                    'media' => ['type' => 'Contena\\Core\\Content\\Media\\MediaEntity', 'resolvedBy' => $resolvedBy],
                    'mediaId' => ['type' => 'string'],
                ],
            ],
            'CT:Media:Image',
    ...
    public function testThrowsWhenTwoResolvedByPropertiesNameSameStorageKey(): void
    {
        ...
        $synthesizer->synthesize(
            [
                'properties' => [
                    'media' => ['type' => 'Contena\\Core\\Content\\Media\\MediaEntity', 'resolvedBy' => 'assetId'],
    ...
    {
        yield 'no property carries resolvedBy' => [['properties' => ['media' => ['type' => 'Contena\\Core\\Content\\Media\\MediaEntity']]]];

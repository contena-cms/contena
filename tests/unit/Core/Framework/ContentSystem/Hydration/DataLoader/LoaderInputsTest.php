...
class LoaderInputsTest extends TestCase
{
    ...
    {
        yield 'resolved' => ['entityId', 'blog-alice'];
    ...
    {
        yield 'string()' => [static fn (LoaderInputs $inputs): string => $inputs->string('entityId'), 'blog-alice'];
    ...
    {
        yield 'stringOrNull()' => [static fn (LoaderInputs $inputs): ?string => $inputs->stringOrNull('entityId'), 'blog-alice'];

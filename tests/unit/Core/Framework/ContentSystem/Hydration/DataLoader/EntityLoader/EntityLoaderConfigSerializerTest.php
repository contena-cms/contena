...
class EntityLoaderConfigSerializerTest extends TestCase
{
     ...
     */
    #[TestWithJson('[{"property": "blogId"}, "NULL"]', 'missing entity key')]
    #[TestWithJson('[{"entity": "", "property": "blogId"}, "string"]', 'entity is empty string')]
    #[TestWithJson('[{"entity": 42, "property": "blogId"}, "integer"]', 'entity is non-string type')]
     ...
     * @param array<string, mixed> $data
     */
    #[TestWithJson('[{"entity": "blog"}, "NULL"]', 'missing property key')]
    #[TestWithJson('[{"entity": "blog", "property": ""}, "string"]', 'property is empty string')]
    #[TestWithJson('[{"entity": "blog", "property": 42}, "integer"]', 'property is non-string type')]

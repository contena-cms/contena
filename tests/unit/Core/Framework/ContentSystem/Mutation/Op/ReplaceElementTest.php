...
class ReplaceElementTest extends TestCase
{
    ...
    {
        $tree = [new ContentElement('el', 'CT:Old')];
        ...
        static::assertSame('CT:New', $result[0]->getComponent());
    }
    ...
    public function testReplaceKeepsMatchingWiring(): void
    {
        ...
        $tree = [new ContentElement('el', 'CT:Old', ['blog' => $requirement])];
    ...
    {
        $tree = [new ContentElement('el', 'CT:Old', [], $oldProperties)];
    ...
    {
        $tree = [new ContentElement('el', 'CT:Old', [], ['headline' => 'Authored'])];
    ...
    public function testReplacePreservesCarriedWiringButFillAppliesDefaultForUnwiredKey(): void
    {
        ...
        $old = ContentElementBuilder::create('CT:Old', 'el')
        ...
        static::assertSame($carriedConfig, $result[0]->getDataRequirements()['blog']->config);
        static::assertSame(['blog' => 'core:carried-spec', 'gallery' => 'core:CT:New'], $result[0]->getAttributedSpecifications());
    }
    ...
    {
        $tree = [new ContentElement('el', 'CT:Old', [], [$propertyKey => $propertyValue])];
    ...
    public function testReplaceContextDefinitionsCarryover(): void
    {
        ...
        $tree = [new ContentElement('el', 'CT:Old', [], [], [], $definitions)];

        $result = new ReplaceElement($this->registry(), 'el', 'CT:New', $this->bindingRegistry([]), $this->unboundApplicator())->apply($tree);

        static::assertSame(['blog' => $kept], $result[0]->getAcceptsContext());
    ...
    public function testReplaceCarriesStyleUnconditionally(): void
    {
        ...
        $tree = [new ContentElement('el', 'CT:Old', [], [], [], new ContextDefinitions([], []), $style)];
    ...
    public function testReplaceSeedsNewTypeDefaultForDroppedIncompatibleKey(): void
    {
        ...
        $result = $replace->apply([new ContentElement('el', 'CT:Old', [], ['count' => 'not-an-int'])]);
    ...
    public function testReplaceDeclaredPrimitiveRuleWinsDroppingTypeMismatchOverStorageKeyShape(): void
    {
        ...
        $tree = [new ContentElement('el', 'CT:Old', [], ['count' => 'some-id-string'])];
    ...
    public function testReplaceDeclaredPrimitiveRuleWinsCarryingTypeMatchOverStorageKeyShape(): void
    {
        ...
        $tree = [new ContentElement('el', 'CT:Old', [], ['count' => 5])];
        $default = new BindingSpecification('CT:New', 'CT:New', 'New', ['count' => new LoaderBinding('entity', ['entity' => 'category', 'property' => 'count'])], [], 'core');
    ...
    public function testReplaceResetsDroppedPropertiesOnReapply(): void
    {
        ...
        $replace->apply([new ContentElement('el', 'CT:Old', [], ['ghost' => 'first-run'])]);
        $replace->apply([new ContentElement('el', 'CT:Old', [], ['count' => 'second-run'])]);
    ...
    {
        $tree = [new ContentElement('el', 'CT:Old', [], ['mediaId' => ['not', 'a', 'string']])];
    ...
    public function testReplaceDropsStorageKeyWiredByNonBuiltinLoader(): void
    {
        ...
        $tree = [new ContentElement('el', 'CT:Old', [], ['activeId' => 'category-1'])];
    ...
    public function testReplaceDropsAndReportsAbsentWiring(): void
    {
        ...
        $tree = [new ContentElement('el', 'CT:Old', ['legacy' => $requirement])];
    ...
    public function testReplaceKeepsAttributedSpecificationForCarriedKeyAndDropsForAbsentKey(): void
    {
        ...
        $result = new ReplaceElement($this->registry(), 'el', 'CT:New', $this->bindingRegistry([]), $this->unboundApplicator())->apply([$old]);

        static::assertSame(['blog' => 'spec-blog'], $result[0]->getAttributedSpecifications());
    }
    ...
    {
        $tree = [new ContentElement('el', 'CT:Old', [], [], [
            'legacy' => new SlotContent([new ContentElement('child', 'CT:Block')]),
        ])];
    ...
    {
        $tree = [new ContentElement('el', 'CT:Old', [], ['headline' => 'Hi'], [
            'content' => new SlotContent([new ContentElement('child', 'CT:Block')]),
        ])];
        $before = $this->snapshotTree($tree);

        new ReplaceElement($this->registry(), 'el', 'CT:New', $this->bindingRegistry([]), $this->unboundApplicator())->apply($tree);
    ...
    public function testReplaceWithAmbiguousDefaultThrows(): void
    {
        ...
        $replace->apply([new ContentElement('el', 'CT:Old')]);
    }

...
{
    private const TYPE = 'Ct:Test:Updatable';
    ...
    {
        $element = StoredElementBuilder::create('Ct:Test:Ghost', 'block-a')->build();
        $update = new UpdateElementProperties($this->registry(), 'block-a', ['headline' => 'New'], []);

        $this->expectExceptionObject(ContentSystemException::mutationUnknownType('Ct:Test:Ghost'));

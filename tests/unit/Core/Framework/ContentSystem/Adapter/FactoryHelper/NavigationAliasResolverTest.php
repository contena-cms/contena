...
class NavigationAliasResolverTest extends TestCase
{
    ...
    public function testResolvesKnownAliasesToCategoryIds(string $alias, string $expectedCategoryId): void
    {
        ...
        $context->getChannel()->setNavigationCategoryId('nav-cat-id');
        $context->getChannel()->setServiceCategoryId('service-cat-id');
        $context->getChannel()->setFooterCategoryId('footer-cat-id');

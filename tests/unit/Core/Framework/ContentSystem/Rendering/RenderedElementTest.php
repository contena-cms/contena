...
class RenderedElementTest extends TestCase
{
    ...
    {
        $element = new RenderedElement('element-1', 'core:blog-box');

        $mutated = $element->withProperty('blog', null);

        static::assertArrayHasKey('blog', $mutated->properties);
        static::assertNull($mutated->properties['blog']);
    }

...
use Contena\Core\Framework\ContentSystem\Rendering\ContextDelivery;
use Contena\Core\Framework\ContentSystem\Rendering\ContextDeliveryIndex;
use Contena\Core\Framework\ContentSystem\Rendering\LoweringResult;
...
class RenderedTreeFactoryTest extends TestCase
{
    ...
    public function testLoaderValuesReachTheirOwnElement(): void
    {
        ...
        static::assertSame(['blog' => $loaded], $tree[0]->properties);
    }
    ...
    public function testProvenanceIsCollectedAcrossTheWholeFold(): void
    {
        ...
        static::assertSame(ValueOrigin::LoaderResolved, $result->provenance['root-1']['blog']->origin);
    }

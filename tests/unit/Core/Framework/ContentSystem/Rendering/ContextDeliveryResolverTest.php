...
class ContextDeliveryResolverTest extends TestCase
{
    ...
    public function testDeliversFromParentToItsChildren(): void
    {
        ...
        static::assertSame(['blog' => 'blog-data'], $index->all()['child-1']->context);
    }
    ...
    public function testEveryRootOfTheForestIsWalked(): void
    {
        ...
        static::assertSame(['blog' => 'first-data'], $index->all()['child-1']->context);
        static::assertSame(['blog' => 'second-data'], $index->all()['child-2']->context);
    }

    /**
     * The reason the walk is top-down. The middle element re-provides under `blog` the value it received
     * under `blog`, so its own delivery has to be in its working map before it distributes. Two hops is
    ...
    public function testChainedRedistributionReachesTheSecondHop(): void
    {
        ...
        static::assertSame(['blog' => 'blog-data'], $index->all()['child-1']->context);
        static::assertSame(['blog' => 'blog-data'], $index->all()['grandchild-1']->context);
    }
    ...
    public function testLoaderValuesAreAvailableToDistribute(): void
    {
        ...
        $index = $this->resolver()->resolve([$root], ['root-1' => ['blog' => 'loaded-data']], []);

        static::assertSame(['blog' => 'loaded-data'], $index->all()['child-1']->context);
    }
    ...
    public function testReceivedContextOutranksTheStoredValue(): void
    {
        ...
        static::assertSame(['blog' => 'inherited-data'], $index->all()['grandchild-1']->context);
    }
    ...
    public function testALoaderNullSuppressesTheStoredProviderValue(): void
    {
        ...
        $index = $this->resolver()->resolve([$root], ['root-1' => ['blog' => null]], []);
    ...
    public function testWalkedElementsAreNotMutated(): void
    {
        ...
        static::assertSame(['blog' => 'blog-data'], array_map(
    ...
    {
        $index = $this->resolver()->resolve([$this->providerRoot('root-1', 'child-1', 'blog-data')], [], []);
    ...
    public function testRequiredDottedConsumerRejectsANonStructProviderValue(): void
    {
        ...
        $this->expectExceptionObject(
            ContentSystemException::contextPathNotResolvable('blog.name', 'child-1', 'Context data is not a Struct instance')
        );
    ...
    public function testDottedRootScopedConsumerResolvesThroughTheAmbientStruct(): void
    {
        ...
        $index = $this->resolver()->resolve(
            [$root],
            [],
            ['blog' => new StubContextStruct('page-cover')]
        );

        static::assertSame(['blog.cover' => 'page-cover'], $index->all()['child-1']->context);
    }
    ...
    public function testRequiredDottedRootScopedConsumerRejectsANonStructAmbientValue(): void
    {
        ...
        $this->resolver()->resolve([$root], [], ['blog' => 'not-a-struct']);
    }
    ...
    public function testOptionalDottedRootScopedConsumerTakesANullOverANonStructAmbientValue(): void
    {
        ...
        $index = $this->resolver()->resolve([$root], [], ['blog' => 'not-a-struct']);

        static::assertSame(['blog.cover' => null], $index->all()['child-1']->context);
    }
    ...
    public function testExactKeyRootDeliveryHandsOnTheSameInstance(): void
    {
        ...
        $index = $this->resolver()->resolve([$root], [], ['blog' => $ambientValue]);

        static::assertSame($ambientValue, $index->all()['child-1']->context['blog']);
    }

...
class ContentSystemDataLoaderSchemaGeneratorTest extends TestCase
{
    ...
    public static function buildsTypesEntryProvider(): iterable
    {
        ...
        yield 'a wildcard collection loader with a config template and generics' => [
            'entity_collection',
            [new LoaderTypeCapability(ChannelBlogCollection::class, ['entity' => 'blog'], [ChannelBlogEntity::class])],
            [[
                'producedType' => ChannelBlogCollection::class,
                'configTemplate' => ['entity' => 'blog'],
                'genericParameters' => [ChannelBlogEntity::class],
            ]],
        ];

    ...
    public static function shapeTable(): iterable
    {
            ...
            [[
                ...
                'dataRequirements' => [
                    'blogs' => [
                        'key' => 'blogs',
                        'source' => 'entity',
                        'config' => ['entity' => 'blog', 'property' => 'blogId'],
                    ],
                ],
                'slots' => [
                ...
                'attributedSpecifications' => ['image' => 'core:blog-image'],
            ]],
            self::ACCEPTED,
            '',
        ];
        ...
        yield 'a data requirement whose key falls back to its map key' => [
            self::forest(['dataRequirements' => [
                'blogs' => ['source' => 'entity', 'config' => ['entity' => 'blog', 'property' => 'blogId']],
            ]]),
            self::ACCEPTED,
            '',
        ];
        ...
        yield 'a null data requirement entry' => [
            self::forest(['dataRequirements' => ['blogs' => null]]),
            self::REJECTED,
            '',
        ];

        yield 'a null context provider entry' => [
            self::forest(['providesContext' => ['blog' => null]]),
            self::REJECTED,
            '',
        ];
        ...
        yield 'a numeric key in dataRequirements' => [
            self::forest(['dataRequirements' => [
                7 => ['source' => 'entity', 'config' => ['entity' => 'blog', 'property' => 'blogId']],
            ]]),
            self::REJECTED,
            '',
        ];
        ...
        yield 'a numeric key in attributedSpecifications' => [
            self::forest(['attributedSpecifications' => [0 => 'core:blog-image']]),
            self::REJECTED,
            '',
        ];
        ...
        yield 'a numeric key in a data requirement config' => [
            self::forest(['dataRequirements' => [
                'blogs' => ['source' => 'entity', 'config' => [0 => 'blog']],
            ]]),
            self::REJECTED,
            '',
        ];
        ...
        yield 'a numeric key in a context provider entry' => [
            self::forest(['providesContext' => [
                'blog' => ['type' => 'single', 'distribution' => 'broadcast', 0 => 'x'],
            ]]),
            self::REJECTED,
            '',
        ];
        ...
        yield 'a consumer declaring the parent scope explicitly' => [
            self::forest(['acceptsContext' => [
                'blog' => ['type' => 'single', 'required' => true, 'scope' => 'parent'],
            ]]),
            self::ACCEPTED,
            '',
        ];
        ...
        yield 'a root-scoped consumer keyed by a dotted path' => [
            self::forest(['acceptsContext' => [
                'blog.cover' => ['type' => 'single', 'required' => true, 'scope' => 'root'],
            ]]),
            self::ACCEPTED,
            '',
        ];
        ...
        yield 'a consumer scope outside the enum' => [
            self::forest(['acceptsContext' => [
                'blog' => ['type' => 'single', 'required' => true, 'scope' => 'ancestor'],
            ]]),
            self::REJECTED,
            '',
        ];
        ...
        yield 'a non-string consumer scope' => [
            self::forest(['acceptsContext' => [
                'blog' => ['type' => 'single', 'required' => true, 'scope' => 42],
            ]]),
            self::REJECTED,
            '',
        ];
        ...
        yield 'a null consumer scope' => [
            self::forest(['acceptsContext' => [
                'blog' => ['type' => 'single', 'required' => true, 'scope' => null],
            ]]),
            self::REJECTED,
            '',
        ];
        ...
        yield 'a redistributing consumer whose propertyAlias names a key an authored provider holds' => [
            self::forest([
                'providesContext' => ['blog' => ['type' => 'single', 'distribution' => 'broadcast']],
                'acceptsContext' => [
                    'category' => ['type' => 'single', 'required' => true, 'redistribute' => true, 'propertyAlias' => 'blog'],
                ],
            ]),
            self::REJECTED,
            '',
        ...
        yield 'an unknown key in a data requirement entry' => [
            self::forest(['dataRequirements' => ['blogs' => [
                'source' => 'entity',
                'config' => ['entity' => 'blog', 'property' => 'blogId'],
                'limit' => 5,
            ]]]),
        ...
        yield 'a keyed context provider with no key property' => [
            self::forest(['providesContext' => ['blog' => ['type' => 'single', 'distribution' => 'keyed']]]),
            self::DESCRIPTOR_ONLY,

...
class ElementTypeSpecificationSerializerTest extends TestCase
{
    ...
    public function testPopulatesPropertyFieldsFromInput(): void
    {
        $data = [
            ...
            'properties' => [
                'blog' => [
                    'type' => 'Contena\Core\Content\Blog\BlogEntity',
                    'required' => true,
                    'title' => 'Blog',
        ...
        static::assertSame('Contena\Core\Content\Blog\BlogEntity', $dto->properties['blog']->type);
        static::assertTrue($dto->properties['blog']->required);
    ...
    public static function denormalizesCopilotBlockProvider(): iterable
    {
        ...
        yield 'explicit copilot block with summary and hints' => [
            array_merge($baseMeta, ['copilot' => ['summary' => 'Blog card element.', 'hints' => ['Use for blogs.']]]),
            'Blog card element.',
            ['Use for blogs.'],
        ];
    ...
    public function testNormalizesPropertyFieldsWhenPopulated(): void
    {
        $dto = $this->buildMinimalDto([
            'blog' => new PropertySpecificationDto(
                'blog',
                'Contena\Core\Content\Blog\BlogEntity',
                true,
                false,
                'Blog',
                'The blog.',
        ...
        static::assertSame('Contena\Core\Content\Blog\BlogEntity', $normalized['properties']['blog']['type']);
        static::assertTrue($normalized['properties']['blog']['required']);
    }
    ...
    public static function normalizesCopilotBlockProvider(): iterable
    {
        yield 'both summary and hints' => [
            new CopilotSpecificationDto('Blog card.', ['Use for blogs.']),
            ['summary' => 'Blog card.', 'hints' => ['Use for blogs.']],
        ];

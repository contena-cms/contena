...
use Contena\Core\Framework\ContentSystem\Layout\Type\Validation\TranslatableType;
...
class TranslatableTypeValidatorTest extends TestCase
{
    ...
    public static function rejectsInvalidSpecificationProvider(): iterable
    {
        ...
        yield 'translatable on FQCN type' => [
            new PropertySpecificationDto('blog', 'Contena\Core\Content\Blog\BlogEntity', false, true, 'Blog', 'A blog.', null, null, null),
            'translatable',
        ];

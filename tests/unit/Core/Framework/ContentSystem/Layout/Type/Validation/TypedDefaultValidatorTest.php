...
use Contena\Core\Framework\ContentSystem\Layout\Type\Validation\TypedDefault;
use Contena\Core\Framework\ContentSystem\Layout\Type\Validation\TypedDefaultValidator;
...
class TypedDefaultValidatorTest extends TestCase
{
    ...
    public static function acceptsValidSpecificationProvider(): iterable
    {
        ...
        yield 'null default on FQCN type' => [
            new PropertySpecificationDto('blog', 'Contena\Core\Content\Blog\BlogEntity', false, false, 'Blog', 'A blog.', null, null, null),
        ];
    }
    ...
    public static function rejectsInvalidSpecificationProvider(): iterable
    {
        ...
        yield 'any default on FQCN type' => [
            new PropertySpecificationDto('blog', 'Contena\Core\Content\Blog\BlogEntity', false, false, 'Blog', 'A blog.', null, 'value', null),
            'default',
        ];

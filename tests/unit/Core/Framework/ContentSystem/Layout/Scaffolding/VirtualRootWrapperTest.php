...
class VirtualRootWrapperTest extends TestCase
{
    ...
    {
        $element = ContentElementBuilder::create('CT:Text')->build();
    ...
    {
        $root1 = ContentElementBuilder::create('CT:Text')->build();
        $root2 = ContentElementBuilder::create('CT:Image')->build();
        ...
        static::assertSame('CT:Internal:PageContext', $virtualRoot->getComponent());
    ...
    public function testIsVirtualRootReturnsTrueForVirtualRoot(): void
    {
        $virtualRoot = $this->wrapper->wrap(
            [ContentElementBuilder::create('CT:Text')->build()],
    ...
    {
        $element = ContentElementBuilder::create('CT:Text', 'some-id')->build();
    ...
    {
        $root1 = ContentElementBuilder::create('CT:Section', 'root-a')->build();
        $root2 = ContentElementBuilder::create('CT:Container', 'root-b')->build();
    ...
    public function testUnwrapThrowsWhenElementIsNotVirtualRoot(): void
    {
        $this->expectExceptionObject(ContentSystemException::pathIntegrityViolation(
            'Expected virtual page context root with ID "__page_context_root__", got element with ID "some-id" and component "CT:Text"'
        ));

        $regularElement = ContentElementBuilder::create('CT:Text', 'some-id')->build();

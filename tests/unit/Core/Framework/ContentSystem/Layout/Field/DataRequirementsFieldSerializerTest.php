...
class DataRequirementsFieldSerializerTest extends TestCase
{
    ...
    public function testEncodeWithDataRequirementArrayYieldsJson(): void
    {
        ...
        $config->method('jsonSerialize')->willReturn(['entityName' => 'blog', 'id' => 'abc']);
        ...
        static::assertSame(['entityName' => 'blog', 'id' => 'abc'], $decoded['my-key']['config']);
    }
    ...
    public function testEncodeWithPlainArrayPassthroughYieldsJson(): void
    {
        $field = $this->createDataRequirementsField();
        $arrayValue = [
            'blog-data' => ['key' => 'blog-data', 'source' => 'entity', 'config' => []],
        ];
    ...
    public function testDecodeWithJsonStringReturnsDataRequirements(): void
    {
        ...
        $json = json_encode([
            ...
            'blogs' => ['key' => 'blogs', 'source' => 'entity_collection', 'config' => ['ids' => []]],
        ], \JSON_THROW_ON_ERROR);
        ...
        static::assertArrayHasKey('blogs', $result);
        ...
        static::assertSame('entity_collection', $result['blogs']->source);
    }
    ...
    public function testDecodeWithArrayReturnsDataRequirements(): void
    {
        ...
        $data = ['blog-data' => ['key' => 'blog-data', 'source' => 'entity', 'config' => ['id' => 'abc']]];

        $result = $this->serializer->decode($field, $data);

        static::assertIsArray($result);
        static::assertArrayHasKey('blog-data', $result);
        static::assertInstanceOf(DataRequirement::class, $result['blog-data']);
        static::assertSame('blog-data', $result['blog-data']->key);
        static::assertSame('entity', $result['blog-data']->source);
        static::assertSame($config, $result['blog-data']->config);
    }
    ...
    public function testSerializeDataRequirementReturnsExpectedArray(array $configValue, array $expectedConfig): void
    {
        ...
        $requirement = new DataRequirement('blog-data', 'entity', $config);

        $result = $this->serializer->serializeDataRequirement($requirement);

        static::assertSame('blog-data', $result['key']);

...
class ContextConsumersFieldSerializerTest extends TestCase
{
    ...
    public function testEncodeWithContextConsumerArrayYieldsJson(): void
    {
        ...
        $kvPair = new KeyValuePair('accepts_context', ['blog' => $consumer], false);
        ...
        static::assertTrue($decoded['blog']['required']);
        static::assertTrue($decoded['blog']['redistribute']);
        static::assertSame('my-alias', $decoded['blog']['consumerAlias']);
        static::assertSame('myProp', $decoded['blog']['propertyAlias']);
    }
    ...
    public function testDecodeWithJsonStringReturnsContextConsumers(): void
    {
        ...
        static::assertInstanceOf(ContextConsumer::class, $result['blog']);
        static::assertSame(ContextType::Single, $result['blog']->type);
        static::assertTrue($result['blog']->required);
    ...
    public function testDecodeWithAllFieldsReturnsFullContextConsumer(): void
    {
        ...
        static::assertIsArray($result);
        static::assertInstanceOf(ContextConsumer::class, $result['blog']);
        static::assertTrue($result['blog']->redistribute);
        static::assertSame('my-alias', $result['blog']->consumerAlias);
        static::assertSame('myProp', $result['blog']->propertyAlias);
    }
    ...
    public function testDecodeThrowsOnConsumerAliasWithoutRedistribute(): void
    {
        ...
        $this->expectExceptionObject(
            ContentSystemException::consumerAliasWithoutRedistribute('blog')
        );
    ...
    public function testDecodeThrowsOnPropertyAliasWithDotNotation(): void
    {
        ...
        $this->expectExceptionObject(
            ContentSystemException::propertyAliasWithDotNotation('blog', 'my.prop')
        );

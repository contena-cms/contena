...
use Contena\Core\Framework\ContentSystem\Layout\Preset\Loader\LayoutPresetSourceDirectory;
...
class YamlLayoutPresetLoaderTest extends TestCase
{
    ...
    public function testLoadDtosFromDirectory(): void
    {
        ...
        $dtos = $this->loader()->loadDtosFromDirectory($this->tempDir, 'core', 'Ct');

        static::assertArrayHasKey('Ct:TextBlock', $dtos);
        static::assertSame('Text block', $dtos['Ct:TextBlock']->name);
    }
    ...
    public function testDuplicateIdInDirectoryThrows(): void
    {
        ...
        $this->expectExceptionObject(ContentSystemException::layoutPresetDuplicate('Ct:TextBlock'));
        $this->loader()->loadFromDirectory($this->tempDir, 'core', 'Ct');
    }

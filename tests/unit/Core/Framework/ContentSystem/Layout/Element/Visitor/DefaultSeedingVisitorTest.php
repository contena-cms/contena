...
use Contena\Core\Framework\ContentSystem\Layout\Element\Visitor\DefaultSeedingVisitor;
...
class DefaultSeedingVisitorTest extends TestCase
{
    ...
    {
        $element = new ContentElement('fresh', 'CT:Block');
    ...
    {
        $element = new ContentElement('authored', 'CT:Block', [], ['headline' => 'Authored']);

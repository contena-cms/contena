...
namespace Contena\Tests\Unit\Core\Framework\ContentSystem\Layout\Element\Visitor;
...
class PropertiesExtractionVisitorTest extends TestCase
{
    ...
    public function testDeduplicates(): void
    {
        ...
        $assignments = $this->visitor->getAssignments();
        static::assertSame($assignments['elem-a']['blog'], $assignments['elem-b']['blog']);

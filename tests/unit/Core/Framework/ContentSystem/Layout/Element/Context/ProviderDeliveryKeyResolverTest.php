...
class ProviderDeliveryKeyResolverTest extends TestCase
{
    ...
    public function testReturnsTheChildFacingKeyMapOfACleanElement(): void
    {
        ...
        static::assertSame(
            ['blog' => 'blog', 'manufacturer' => 'brand', 'section' => 'category'],
    ...
    public function testDerivesTheChildFacingKeyFromTheConsumerAliasOrTheContextKey(?string $consumerAlias, string $expected): void
    {
        ...
        static::assertSame($expected, $this->resolver->derivedChildKey($consumer, 'blog'));
    }
    ...
    public static function derivesChildKeyProvider(): iterable
    {
        ...
        yield 'without an alias the context key is the child-facing key' => [null, 'blog'];
    }

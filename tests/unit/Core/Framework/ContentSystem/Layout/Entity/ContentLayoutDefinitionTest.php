...
namespace Contena\Tests\Unit\Core\Framework\ContentSystem\Layout\Entity;
...
class ContentLayoutDefinitionTest extends TestCase
{
    ...
    public function testDeclaresItsFields(): void
    {
        ...
        $blogAssociation = $fields->get('blogContentLayouts');
        static::assertInstanceOf(OneToManyAssociationField::class, $blogAssociation);
        static::assertTrue($blogAssociation->is(RestrictDelete::class));

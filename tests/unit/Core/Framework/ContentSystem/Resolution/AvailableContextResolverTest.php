...
class AvailableContextResolverTest extends TestCase
{
    ...
    public function testAliasedProviderExposesConsumerAlias(): void
    {
        ...
        $root = new StoredElement(
            ...
            ['content' => [$child]],
            new ContextDefinitions(
                ['blog' => new ContextProvider(ContextType::Single, BroadcastDistributionConfig::aliased('item'))],
                [],
            ),
        );
    ...
    {
        $tree = $this->providerChain(['blog' => new ContextConsumer(ContextType::Single, required: false, redistribute: true)]);
    ...
    {
        $tree = $this->providerChain(['blog' => new ContextConsumer(ContextType::Single, required: false, redistribute: true, consumerAlias: 'item')]);
    ...
    public function testRedistributeWithoutMatchingIncomingKeyExposesNothing(): void
    {
        ...
        // ancestor's `blog` does flow in, so an unconditional re-exposure of `category` would show up here.
    ...
    {
        $tree = $this->providerChain(['blog' => new ContextConsumer(ContextType::Single, required: false, redistribute: false)]);
    ...
    {
        // A chain never carries root context: both intermediates redistribute `blog`, and the key exists
    ...
    {
        // The sanctioned way root-derived data becomes element-provided: the ancestor's own `blog` property
        ...
        $root = new StoredElement(
            ...
            new ContextDefinitions(
                ['blog' => new ContextProvider(ContextType::Single, BroadcastDistributionConfig::simple())],
                ['blog' => new ContextConsumer(ContextType::Single, required: true, scope: ConsumerScope::Root)],
            ),
        );

        $available = $this->resolverWithoutLoaderBacking()->resolve('child-1', [$root], $this->rootAmbientBlogContext());
    ...
    public function testAmbientContextDoesNotBackAProviderThroughAParentScopedConsumer(): void
    {
        ...
        $root = new StoredElement(
            ...
            new ContextDefinitions(
                ['blog' => new ContextProvider(ContextType::Single, BroadcastDistributionConfig::simple())],
                ['blog' => new ContextConsumer(ContextType::Single, required: true)],
            ),
        );
    ...
    public function testAmbientContextDoesNotBackAProviderWhenTheConsumerLandsOnAnotherKey(): void
    {
        ...
        $root = new StoredElement(
            ...
            new ContextDefinitions(
                ['blog' => new ContextProvider(ContextType::Single, BroadcastDistributionConfig::simple())],
                ['blog' => new ContextConsumer(ContextType::Single, required: true, propertyAlias: 'item', scope: ConsumerScope::Root)],
            ),
        );
    ...
    public function testDottedRootScopedConsumerWithoutAPropertyAliasBacksNoProvider(): void
    {
        ...
        $root = new StoredElement(
            ...
            new ContextDefinitions(
                ['blog' => new ContextProvider(ContextType::Single, BroadcastDistributionConfig::simple())],
                ['blog.manufacturer' => new ContextConsumer(ContextType::Single, required: true, scope: ConsumerScope::Root)],
            ),
        );
    ...
    public function testDottedRootScopedConsumerAliasedOntoTheProviderKeyBacksIt(): void
    {
        ...
        $root = new StoredElement(
            ...
            new ContextDefinitions(
                ['blog' => new ContextProvider(ContextType::Single, BroadcastDistributionConfig::simple())],
                ['blog.manufacturer' => new ContextConsumer(ContextType::Single, required: true, propertyAlias: 'blog', scope: ConsumerScope::Root)],
            ),
        );
    ...
    public function testAmbientContextDoesNotBackAProviderWhoseConsumerKeyNoAmbientEntrySupplies(): void
    {
        ...
        $root = new StoredElement(
            ...
            new ContextDefinitions(
                ['blog' => new ContextProvider(ContextType::Single, BroadcastDistributionConfig::simple())],
                ['category' => new ContextConsumer(ContextType::Single, required: true, propertyAlias: 'blog', scope: ConsumerScope::Root)],
            ),
        );
    ...
    public function testAmbientBackingSelectsTheConsumedEntryAmongOffersOfOneType(): void
    {
        ...
        $rootContext = [...$this->rootAmbientBlogContext(), new ProvidedContext(
            contextKey: 'featuredBlog',
    ...
    /**
     * A three-level tree whose chain source is element-provided: root-1 declares a backed `blog` provider,

...
{
    private const string CONTENA_VERSION = '6.5.2.0';
    ...
    public function testCoreIdentifierMigratesAndClearsCache(): void
    {
        ...
        $loader->expects($this->once())
            ...
            ->willReturnCallback(static function (string $version) use ($collection): MigrationCollection {
                static::assertSame(self::CONTENA_VERSION, $version);
        ...
        $command = new MigrationCommand($loader, $cache, self::CONTENA_VERSION);

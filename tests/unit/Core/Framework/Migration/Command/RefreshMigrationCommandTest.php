...
{
    private const string MIGRATION_PATH = __DIR__ . '/_fixtures/Migration1772030791FooBar.php';
    private const string OLD_TIMESTAMP = '1772030791';
    private const string NEW_TIMESTAMP = '1783669827';
    private const string MIGRATION_CONTENT = '<?php declare(strict_types=1);

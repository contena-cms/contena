...
{
    final public const string ERROR_MESSAGE = 'An exception occurred while executing a query: SQLSTATE[23000]: Integrity constraint violation: 1452 Cannot add or update a child row: a foreign key constraint fails on TABLE `child_table` FOREIGN KEY REFERENCES `parent_table` (`id`)';

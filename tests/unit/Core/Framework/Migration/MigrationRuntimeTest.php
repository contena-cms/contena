...
use Contena\Tests\Unit\Core\Framework\Migration\_fixtures\MigrationRuntime\Migration1000000001Successful;
...
class MigrationRuntimeTest extends TestCase
{
    ...
    public function testMigrateSkipsMissingClass(): void
    {
        ...
        $runtime->executableMigrations = ['Contena\Core\Migration\DoesNotExistAnymore'];
    ...
    {
        return new MigrationSource('test', [__DIR__ => 'Contena\Tests\Unit\Core\Framework\Migration\_fixtures\MigrationRuntime']);
    }
}

...
class RouteEventSubscriberTest extends TestCase
{
    ...
    {
        $request = new Request();
        $request->attributes->set(PlatformRequest::ATTRIBUTE_ROUTE_SCOPE, [ApiRouteScope::ID, 'custom']);
        ...
        $this->dispatcher->addListener('custom.scope.request', $this->secondListener);

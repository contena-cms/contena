 ...
 * @internal
 */
#[CoversClass(ContenaHttpException::class)]
class ContenaHttpExceptionTest extends TestCase
{
    #[TestDox('placeholders are interpolated from the parameters')]
    public function testMessageInterpolation(): void
    {
        $exception = new TestContenaHttpException(
    ...
    {
        $exception = new TestContenaHttpException('Value {{value}} and {{  value  }}', ['value' => 'x']);
    ...
    {
        $exception = new TestContenaHttpException('kaputt', ['key' => 'value']);
    ...
    {
        $exception = new TestContenaHttpException('kaputt');
...
/**
 * ContenaHttpException is abstract; the minimal concrete subclass to exercise the base behaviour.
 *
 * @internal
 */
class TestContenaHttpException extends ContenaHttpException
{

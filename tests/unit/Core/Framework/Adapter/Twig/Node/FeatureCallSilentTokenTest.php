...
use Contena\Core\Framework\Adapter\Twig\Node\FeatureCallSilentToken;
use Twig\Compiler;
...
class FeatureCallSilentTokenTest extends TestCase
{
    public function testCompile(): void
    {
        ...
        $code = <<<'PHP'
// line 1
\Contena\Core\Framework\Feature::callSilentIfInactive("v6.5.0.0", function () use(&$context) { yield "test";
});
PHP;

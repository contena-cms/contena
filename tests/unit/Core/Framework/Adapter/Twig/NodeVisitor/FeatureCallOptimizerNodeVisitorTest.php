...
namespace Contena\Tests\Unit\Core\Framework\Adapter\Twig\NodeVisitor;
...
class FeatureCallOptimizerNodeVisitorTest extends TestCase
{
    ...
    private const string OPTIMIZATION_FLAG = 'TWIG_COMPILE_TIME_OPTIMIZATION';
    private const string ACTIVE_FEATURE = 'FEATURE_ACTIVE';
    private const string INACTIVE_FEATURE = 'FEATURE_INACTIVE';

...
class ExtendsTokenParserTest extends TestCase
{
    ...
    public function testParseStringExtendsInNonMatchingScopeButInFrontend(): void
    {
        static::assertSame(
            'extended',
            $this->parseTemplate(
    ...
    private function parseTemplate(
        string $template,
        array $scopes,
        bool $withFrontendPrefix,
        bool $callsTemplateFinder = true,
        bool $callsScopeDetector = true
    ): string {
        $templateName = ($withFrontendPrefix ? '@Frontend/' : '') . Uuid::randomHex() . '.html.twig';

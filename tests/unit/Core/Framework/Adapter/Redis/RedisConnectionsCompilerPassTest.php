...
class RedisConnectionsCompilerPassTest extends TestCase
{
    ...
    {
        $this->containerBuilder->setParameter('contena.redis.connections', [
        ...
        static::assertTrue($this->containerBuilder->hasDefinition('contena.redis.connection.db1'));
        static::assertTrue($this->containerBuilder->hasDefinition('contena.redis.connection.db2'));
        static::assertFalse($this->containerBuilder->hasDefinition('contena.redis.connection.default'));

        $db1Definition = $this->containerBuilder->getDefinition('contena.redis.connection.db1');
        ...
        $db2Definition = $this->containerBuilder->getDefinition('contena.redis.connection.db2');

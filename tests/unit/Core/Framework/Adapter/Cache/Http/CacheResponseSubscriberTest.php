...
class CacheResponseSubscriberTest extends TestCase
{
     ...
     *
     * The area is always the frontend: `applyPolicy()` only uses it to resolve the policy name and
     * has no per-area branch for this header, so a channel-api run would exercise the same code.
     */

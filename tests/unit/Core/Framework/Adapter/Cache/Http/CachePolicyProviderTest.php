...
class CachePolicyProviderTest extends TestCase
{
    ...
    public static function providePolicyResolutionCases(): iterable
    {
        ...
        yield 'route override takes precedence' => [
            ...
            'defaultPolicies' => [
                'channel_api' => new DefaultPolicies('default_policy', 'no_cache'),
            ],
            'route' => 'my.route',
            'area' => 'channel_api',
            'cacheable' => true,
        ...
        yield 'policy modifier appended to route name' => [
            ...
            'defaultPolicies' => [
                'frontend' => new DefaultPolicies('default_policy', 'no_cache'),
            ],
        ...
        yield 'area cacheable default when no route policy' => [
            ...
            'routePolicies' => [],
            'defaultPolicies' => [
                'frontend' => new DefaultPolicies('area_cacheable', 'no_cache'),
            ],
            'route' => 'some.route',
            'area' => 'frontend',
            'cacheable' => true,
        ...
        yield 'area uncacheable default' => [
            ...
            'routePolicies' => [],
            'defaultPolicies' => [
                'channel_api' => new DefaultPolicies('cacheable_policy', 'uncacheable_policy'),
            ],
            'route' => 'some.route',
            'area' => 'channel_api',
            'cacheable' => false,
        ...
        yield 'enforceNoStore with default policy returns noStore policy' => [
            ...
            'routePolicies' => [],
            'defaultPolicies' => [
                'frontend' => new DefaultPolicies('default_policy', 'default_policy'),
            ],
            'route' => 'some.route',
            'area' => 'frontend',
            'cacheable' => false,

...
/**
 * @phpstan-import-type CacheAttributeArray from \Contena\Core\Framework\Adapter\Cache\Http\CacheAttribute
 * @phpstan-import-type CacheAttributeType from \Contena\Core\Framework\Adapter\Cache\Http\CacheAttribute
 *
 * @internal
 */
...
class CacheAttributeTest extends TestCase
{
    ...
    public function testFromArray(array $input, ?int $expectedMaxAge, ?int $expectedSMaxAge): void
    {
    ...
    public static function fromArrayProvider(): \Generator
    {
        yield 'with clientMaxAge and sharedMaxAge' => [
            'input' => ['clientMaxAge' => 100, 'sharedMaxAge' => 200],
            'expectedMaxAge' => 100,
            'expectedSMaxAge' => 200,
        ];

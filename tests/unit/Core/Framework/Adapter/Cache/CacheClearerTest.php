...
class CacheClearerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $testBase = sys_get_temp_dir() . '/contena_test_' . uniqid();
    ...
    protected function tearDown(): void
    {
        ...
        $testBase = \dirname($this->cacheDir, 2); // Go up two levels to contena_test_* directory
        if (is_dir($testBase) && str_starts_with(basename($testBase), 'contena_test_')) {

...
class ReverseProxyCompilerPassTest extends TestCase
{
    ...
    {
        $container = self::getContainer();
        $container->setParameter('contena.http_cache.reverse_proxy.fastly.enabled', false);
    ...
    {
        $container = self::getContainer();
        $container->setParameter('contena.http_cache.reverse_proxy.enabled', false);
    ...
    public static function getContainer(): ContainerBuilder
    {
        ...
        $container->setParameter('contena.http_cache.reverse_proxy.enabled', true);
        $container->setParameter('contena.http_cache.reverse_proxy.fastly.enabled', true);

...
class MySQLFactoryTest extends TestCase
{
    ...
    {
        $this->setEnvVars([
            'DATABASE_URL' => 'mysql://user:pass@localhost:3306/contena',
    ...
    public function testDriverOptionsFromDsnArePreserved(): void
    {
        ...
        $this->setEnvVars([
            'DATABASE_URL' => \sprintf(
                'mysql://user:pass@localhost:3306/contena?driverOptions[%d]=%d',
                $customOption,
                $customValue
            ),
        ]);
    ...
    {
        $this->setEnvVars([
            'DATABASE_URL' => 'mysql://user:pass@localhost:3306/contena?wrapperClass=Contena\Tests\Unit\Core\Framework\Adapter\Database\MyWrapper&driverOptions[x_foo_bar]=3&driverOptions[foo][bar]=true',
        ]);

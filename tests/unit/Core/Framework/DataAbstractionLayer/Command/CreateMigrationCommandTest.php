...
class CreateMigrationCommandTest extends TestCase
{
    ...
    public function testExecute(
        ...
        $contenaVersion = '6.5.0';

        $command = new CreateMigrationCommand($registry, $queryGenerator, $kernel, $filesystem, $migrationFileRenderer, $coreDir, $contenaVersion, new MockClock($now));

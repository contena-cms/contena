...
{
    final public const string ENTITY_NAME = 'reference_version_root';
...
{
    final public const string ENTITY_NAME = 'reference_version_child';
...
{
    final public const string ENTITY_NAME = 'reference_version_plain';

...
class IndexerMetricsInstrumentorTest extends TestCase
{
    ...
    public function testEmitsBatchSizeAndRunDurationWithResolvedLabels(): void
    {
        $this->createInstrumentor()->measureRun(
            $this->createIndexer('blog.indexer'),
        ...
        static::assertSame(['indexer' => 'blog.indexer', 'mode' => 'full'], $batchSize->labels);
        ...
        static::assertSame(['indexer' => 'blog.indexer', 'mode' => 'full', 'result' => 'success'], $duration->labels);
    }

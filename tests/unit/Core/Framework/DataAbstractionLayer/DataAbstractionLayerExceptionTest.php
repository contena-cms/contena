...
class DataAbstractionLayerExceptionTest extends TestCase
{
    ...
    public function testInvalidFilterQuery(): void
    {
        ...
        static::assertSame(Response::HTTP_BAD_REQUEST, $e->getStatusCode());
        static::assertSame('FRAMEWORK__INVALID_FILTER_QUERY', $e->getErrorCode());
    }
    ...
    {
        $e = DataAbstractionLayerException::fkFieldByStorageNameNotFound(DateDefinition::class, 'date_nullable');

        static::assertSame(
            'Can not detect FK field with storage name date_nullable in definition Contena\Core\Framework\Test\DataAbstractionLayer\Field\TestDefinition\DateDefinition',
            $e->getMessage()
        );

        static::assertSame(Response::HTTP_INTERNAL_SERVER_ERROR, $e->getStatusCode());
        static::assertSame('FRAMEWORK__REFERENCE_FIELD_BY_STORAGE_NAME_NOT_FOUND', $e->getErrorCode());
    }

    public function testLanguageFieldByStorageNameNotFound(): void
    {
        $e = DataAbstractionLayerException::languageFieldByStorageNameNotFound(DateDefinition::class, 'date_nullable');

        static::assertSame(
            'Can not detect language field with storage name date_nullable in definition Contena\Core\Framework\Test\DataAbstractionLayer\Field\TestDefinition\DateDefinition',
            $e->getMessage()
        );
        static::assertSame(Response::HTTP_INTERNAL_SERVER_ERROR, $e->getStatusCode());
        static::assertSame('FRAMEWORK__REFERENCE_FIELD_BY_STORAGE_NAME_NOT_FOUND', $e->getErrorCode());
    ...
    {
        $e = DataAbstractionLayerException::definitionFieldDoesNotExist(DateDefinition::class, 'date_nullable');

        static::assertSame(
            'Can not detect reference field with storage name date_nullable in definition Contena\Core\Framework\Test\DataAbstractionLayer\Field\TestDefinition\DateDefinition',
            $e->getMessage()
        );
        static::assertSame(Response::HTTP_INTERNAL_SERVER_ERROR, $e->getStatusCode());
        static::assertSame('FRAMEWORK__REFERENCE_FIELD_BY_STORAGE_NAME_NOT_FOUND', $e->getErrorCode());
    ...
    {
        $e = DataAbstractionLayerException::unmappedField('_date_field_test.dateNullable', new DateDefinition());

        static::assertSame(Response::HTTP_BAD_REQUEST, $e->getStatusCode());
        static::assertSame('FRAMEWORK__DBAL_UNMAPPED_FIELD', $e->getErrorCode());
        static::assertSame('Field "dateNullable" in entity "_date_field_test" was not found.', $e->getMessage());
    }
    ...
    public function testConfigNotFound(): void
    {
        ...
        static::assertSame('Configuration for blog search definition not found', $e->getMessage());
        static::assertSame(Response::HTTP_INTERNAL_SERVER_ERROR, $e->getStatusCode());
        static::assertSame(DataAbstractionLayerException::BLOG_SEARCH_CONFIGURATION_NOT_FOUND, $e->getErrorCode());
    }

...
class AssetServiceTest extends TestCase
{
    ...
    {
        $this->setEnvVars(['CONTENA_SKIP_ASSET_INSTALL_CACHE_INVALIDATION' => '1']);
    ...
    public function testCopyAssetsUsesTopLevelAssetFilesystemVisibility(): void
    {
        ...
        $assetService = $this->createAssetService(
            ...
            parameterBag: new ParameterBag([
                ...
                'contena.filesystem.asset.visibility' => Visibility::PRIVATE,
                'contena.filesystem.asset.config' => [
 ...
 * @internal
 */
class Administration extends ContenaAdministration
{

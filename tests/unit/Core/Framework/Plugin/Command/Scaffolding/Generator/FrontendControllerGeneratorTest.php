 ...
 * @internal
 */
#[CoversClass(FrontendControllerGenerator::class)]
class FrontendControllerGeneratorTest extends TestCase
{
    public function testCommandOptions(): void
    {
        $generator = new FrontendControllerGenerator();
    ...
    public function testAddScaffoldConfig(bool $option, bool $confirm, bool $expected): void
    {
        ...
        new FrontendControllerGenerator()->addScaffoldConfig($configuration, $input, $io);

        static::assertSame($expected, $configuration->hasOption(FrontendControllerGenerator::OPTION_NAME));
        if ($expected) {
    ...
    public function testGenerate(PluginScaffoldConfiguration $config, array $expected): void
    {
        ...
        new FrontendControllerGenerator()->generateStubs($config, $stubs);
    ...
    public static function generateProvider(): \Generator
    {
        ...
        yield 'disabled option' => [self::getConfig([FrontendControllerGenerator::OPTION_NAME => false]), []];
        yield 'enabled option' => [self::getConfig([FrontendControllerGenerator::OPTION_NAME => true]), [

...
class PluginInstallCommandTest extends TestCase
{
    ...
    {
        $dependentPlugin = $this->createPluginEntity('DependentPlugin', 'ct/dependent-plugin');
        $independentPlugin = $this->createPluginEntity('IndependentPlugin', 'ct/independent-plugin');
        $basePlugin = $this->createPluginEntity('BasePlugin', 'ct/base-plugin');
    ...
    public function testInstallSortsStorePluginBeforePluginRequiringItsStoreAlias(): void
    {
        ...
        $storePlugin = $this->createPluginEntity('StoreDependencyPlugin', 'store.contena.cn/store-dependency-plugin');
    ...
    {
        $missingPlugin = $this->createPluginEntity('MissingComposerPlugin', 'ct/missing-composer-plugin');
        $existingPlugin = $this->createPluginEntity('ExistingComposerPlugin', 'ct/existing-composer-plugin');
    ...
    {
        $plugin = $this->createPluginEntity('InstalledPlugin', 'ct/installed-plugin');
        $plugin->setInstalledAt(new \DateTimeImmutable());
    ...
    {
        $plugin = $this->createPluginEntity('NewPlugin', 'ct/new-plugin');
        $this->plugins->add($plugin);
    ...
    {
        $plugin = $this->createPluginEntity('ReinstallPlugin', 'ct/reinstall-plugin');
        $plugin->setInstalledAt(new \DateTimeImmutable());
        $this->plugins->add($plugin);
    ...
    {
        $plugin = $this->createPluginEntity('SkipAssetBuildPlugin', 'ct/skip-asset-build-plugin');
        $this->plugins->add($plugin);

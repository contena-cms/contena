...
class SeoUrlRouteLifecycleHandlerTest extends TestCase
{
    ...
    private const IMPRINT_ROUTE = 'frontend.app.test.imprint';
    private const BLOG_ROUTE = 'frontend.app.test.blog-detail';
    ...
    {
        $legacy = $this->createRoute('legacy', 'frontend.app.test.legacy');

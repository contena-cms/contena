...
{
    private FrontendSeoUrlValidator $validator;
    ...
    protected function setUp(): void
    {
        ...
        $this->validator = new FrontendSeoUrlValidator(new RouteBlocklistService($router));
    }

    public function testManifestWithoutFrontendIsValid(): void
    {
    ...
    private function validate(string $seoUrls): string
    {
            ...
            <<<XML
                ...
                <manifest xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
                    <meta>
                        ...
                        <description>Test for frontend SEO URLs</description>
        ...
        $error = $errors->first();
        static::assertInstanceOf(FrontendSeoUrlError::class, $error);

...
class SecureUrlValidatorTest extends TestCase
{
    ...
    public static function urlValidationProvider(): \Generator
    {
        ...
        yield 'HTTP URL' => ['http://contena.com', false];
        yield 'HTTP with port' => ['http://contena.com:8080', false];

        // Invalid URLs - No scheme or wrong scheme
        yield 'No scheme' => ['contena.com', false];
        yield 'Protocol relative' => ['//contena.com', false];
        yield 'FTP scheme' => ['ftp://contena.com', false];
        yield 'File scheme' => ['file://contena.com', false];
    ...
    public function testPublicIpv4Passes(): void
    {
        ...
        static::assertTrue($validator->isValidTarget('https://contena.com'));
    }
    ...
    public function testUnresolvableHostFails(): void
    {
        ...
        static::assertFalse($validator->isValidTarget('https://contena.com'));
    }

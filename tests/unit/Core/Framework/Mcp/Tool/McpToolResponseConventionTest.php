...
class McpToolResponseConventionTest extends TestCase
{
    ...
    public function testDryRunReturnsErrorOnRollbackFailure(): void
    {
        ...
        $context = new Context(new AdminApiSource(null, null), [Defaults::LANGUAGE_SYSTEM]);
    ...
    public function testOversizedResponseStoresAsResourceAndIncludesQueryFromRequestBody(): void
    {
        ...
        $request->attributes->set(McpServerController::ATTRIBUTE_JSONRPC_BODY, [
            ...
            'params' => [
                ...
                'arguments' => ['entity' => 'blog', 'limit' => 500],
            ],
            'id' => 1,
        ]);
        ...
        static::assertSame('contena://tool-result/019ddd92145f7089a9c717ebea9ec3d3', $result['_meta']['resourceUri']);
        static::assertGreaterThan(100_000, $result['_meta']['responseSize']);
        static::assertSame('contena-entity-search', $result['_meta']['query']['tool']);
        static::assertSame(['entity' => 'blog', 'limit' => 500], $result['_meta']['query']['arguments']);
    }

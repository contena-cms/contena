...
class EntityUpsertToolTest extends TestCase
{
    public function testDeniesAccessWithoutCreatePermission(): void
    {
        ...
        $result = $this->decode(($tool)('blog', '{"name": "Test"}'));

        static::assertFalse($result['success']);
        static::assertStringContainsString('blog:create', $result['error']);
    }
    ...
    public function testAllowsCreateOnlyWithoutUpdatePermission(): void
    {
        ...
        $result = $this->decode(($tool)('blog', '{"name": "Test"}', false));
    ...
    public function testReturnsErrorForNonArrayPayload(): void
    {
        ...
        $result = $this->decode(($tool)('blog', '"just a string"'));
    ...
    public function testDryRunRollsBackAndReturnsWriteResult(): void
    {
        ...
        $writeResult = new EntityWriteResult('abc', [], 'blog', EntityWriteResult::OPERATION_INSERT);
        ...
        $result = $this->decode(($tool)('blog', '[{"name": "Test"}]', true));

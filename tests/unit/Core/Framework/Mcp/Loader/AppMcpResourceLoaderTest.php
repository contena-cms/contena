...
class AppMcpResourceLoaderTest extends TestCase
{
    ...
    public function testResourceWithReservedContenaPrefixIsSkipped(): void
    {
        $this->storage->method('forActiveApps')->willReturn([
            $this->feature($this->resourceConfig(name: 'entities', uri: 'contena://entities', mimeType: null), appName: 'contena'),
        ]);

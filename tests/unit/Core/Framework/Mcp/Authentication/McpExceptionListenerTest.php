...
class McpExceptionListenerTest extends TestCase
{
    ...
    public function testHandlesPostRegister(): void
    {
        ...
        static::assertStringContainsString('/channel-api/_mcp', $body['error_description']);
    }
    ...
    #[TestDox('converts HTTP exception on Channel API MCP route to JSON-RPC error')]
    public function testConvertsChannelApiHttpExceptionToJsonRpcError(): void
    {
        $listener = new McpExceptionListener();
        $httpException = new class extends \RuntimeException {
            public function getStatusCode(): int
        ...
        $event = $this->createExceptionEvent('/channel-api/_mcp', 'channel-api.mcp.endpoint', $httpException);

...
class MediaFileExtensionListProviderTest extends TestCase
{
    ...
    {
        $provider = new MediaFileExtensionListProvider(new EventDispatcher(), [], ['unknown-contena-extension']);
        $context = Context::createDefaultContext();

        static::assertSame(['unknown-contena-extension'], $provider->getAllowedExtensions(true, $context));
        static::assertSame(
            ['unknown-contena-extension' => []],

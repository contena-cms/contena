...
use Contena\Core\Content\Media\Upload\FileMetadataResult;
...
class PresignedMediaUploadServiceTest extends TestCase
{
    ...
    public function testPreparePrivateUploadIsSignedAsPrivate(): void
    {
        ...
        $result = $service->prepare(new PresignedUploadPreparePayload(
            fileName: 'secret',
            extension: 'pdf',
    ...
    public function testFinalizePrivateUploadIsVerifiedAsPrivate(): void
    {
        ...
        $service->finalize($mediaId, new PresignedUploadFinalizePayload(
            fileName: 'secret',
            extension: 'pdf',
            mimeType: 'application/pdf',
            path: $path,

...
use Contena\Core\Content\Media\Event\ThumbnailGeneratedEvent;
...
class ThumbnailServiceTest extends TestCase
{
    ...
    public function testGenerateWithValidMediaCollection(): void
    {
        ...
        $file = file_get_contents(__DIR__ . '/contena-logo.png');
        ...
        $connection->expects($this->once())
            ...
            ->willReturnCallback(static function ($_, $params) {
                return [
                    Uuid::fromBytesToHex($params['ids'][0]) => '/contena-logo.png',
                ];
            });
    ...
    public function testUpdateThumbnailsWithForceRegeneratesExistingThumbnails(): void
    {
        ...
        $connection->expects($this->once())
            ...
            ->willReturnCallback(function (\Closure $func) use ($mediaEntity, $mediaFolderEntity) {
                ...
                static::assertSame([['id' => '$mediaThumbnailEntity-id-1']], $staticVars['delete']);
        ...
        static::assertSame(1, $thumbnailService->updateThumbnails($mediaEntity, $this->context, false, true));
    }
    ...
    public function testGenerateDispatchesThumbnailGeneratedEvent(): void
    {
        ...
        $file = (string) file_get_contents(__DIR__ . '/contena-logo.png');
    ...
    private function createMediaEntity(MediaThumbnailEntity $mediaThumbnailEntity, MediaFolderEntity $mediaFolderEntity): MediaEntity
    {
        ...
        $mediaEntity->setFileName('contena-logo');
        ...
        $mediaEntity->setPath(__DIR__ . '/contena-logo.png');
        ...
        $mediaEntity->setUrl('/url/to/contena-logo.png');
    ...
    private function createMediaThumbnailEntity(string $mediaThumbnailSizeId = '$mediaThumbnailSizeEntity-id-1'): MediaThumbnailEntity
    {
        ...
        $mediaThumbnailEntity->setHeight(100);
        $mediaThumbnailEntity->setMediaId('media-id-1');
        $mediaThumbnailEntity->setPath(__DIR__ . '/contena-logo.png');

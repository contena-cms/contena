...
class UnusedMediaPurgerTest extends TestCase
{
    public function testGetNotUsedMediaOnlyAppliesValidAssociationsToCriteria(): void
    {
        ...
        $purger = $this->createPurger($repo, static::createStub(Connection::class), new EventDispatcher(), new NativeClock());
    ...
    public function testGetNotUsedMediaAppliesFolderRestrictionToCriteriaIfPresent(): void
    {
        ...
        $purger = $this->createPurger($repo, $connection, new EventDispatcher(), new NativeClock());
    ...
    public function testGetNotUsedMediaDoesNotFetchMediaIfRemovedByListener(): void
    {
        ...
        $purger = $this->createPurger($repo, static::createStub(Connection::class), $eventDispatcher, new NativeClock());
        $media = array_merge([], ...iterator_to_array($purger->getNotUsedMedia()));
    ...
    public function testDeleteNotUsedMediaOnlyAppliesValidAssociationsToCriteria(): void
    {
        ...
        $repo = new StaticEntityRepository(
            [
                static fn (Criteria $criteria, Context $context) => new EntitySearchResult(10, new MediaCollection(), null, $criteria, $context), // total media count query
                static fn (Criteria $criteria, Context $context) => new EntitySearchResult(2, new MediaCollection(), null, $criteria, $context), // purgable media count query
                [$id1, $id2],
                // fake the grace period filter
                static fn (Criteria $criteria) => $criteria->getIds(),
                [],

...
class MailMetricsInstrumentorTest extends TestCase
{
    ...
    {
        $this->createInstrumentor()->measureSend('member.register', fn () => null);
        ...
        static::assertSame(['mail_group' => 'mail_group_label:member.register', 'result' => 'sent'], $count->labels);
    }
    ...
    public function testSendClosureIsInvokedExactlyOnce(): void
    {
        ...
        $this->createInstrumentor()->measureSend('member.register', function () use (&$calls): void {
            ++$calls;
        });
    ...
    public function testFailingSendIsRethrownAndBothMetricsRecordedAsFailed(): void
    {
        ...
        try {
            $this->createInstrumentor()->measureSend('member.register', function (): void {
        ...
        static::assertSame('mail_group_label:member.register', $count->labels['mail_group']);
    }

...
use Contena\Core\Content\Category\ContentSystem\DataLoader\ServiceMenuLoaderConfig;
...
class ServiceMenuDataLoaderTest extends TestCase
{
    ...
    public function testLoadResolvesRootIdAndFlattensNavigationTree(
        ...
        if ($expectedRootId === null) {
            ...
            $context->getChannel()->setServiceCategoryId($expectedRootId);
        }
    ...
    {
        $context = Generator::generateChannelContext();
        static::assertNull($context->getChannel()->getFooterCategoryId());
    ...
    #[TestDox('degrades to notFound when the navigation loader throws the Contena exception $_dataName')]
    public function testLoadReturnsNotFoundWhenNavigationLoaderThrows(\Throwable $exception): void
    {
        ...
        $context = Generator::generateChannelContext();
        $context->getChannel()->setServiceCategoryId($serviceCategoryId);
    ...
    {
        $context = Generator::generateChannelContext();
        $context->getChannel()->setServiceCategoryId(Uuid::randomHex());
     ...
     * `ContenaHttpException`, so no row maps to a clause of its own.
     *
    ...
    public static function sampleDomainExceptionProvider(): iterable
    {
        ...
        // but the class it returns is CategoryNotFoundException, which extends ContenaHttpException directly

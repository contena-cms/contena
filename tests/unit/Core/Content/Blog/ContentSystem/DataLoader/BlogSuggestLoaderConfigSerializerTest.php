 ...
 * @internal
 */
#[CoversClass(BlogSuggestLoaderConfigSerializer::class)]
class BlogSuggestLoaderConfigSerializerTest extends TestCase
{
    private BlogSuggestLoaderConfigSerializer $serializer;

    protected function setUp(): void
    {
        $this->serializer = new BlogSuggestLoaderConfigSerializer();
    }

    #[TestDox('returns blog_suggest source identifier')]
    public function testGetSourceReturnsBlogSuggestString(): void
    {
    ...
    #[TestDox('throws exception when encoding a non-BlogSuggestLoaderConfig config instance')]
    public function testEncodeWithWrongConfigTypeThrowsException(): void
    {
        $this->expectExceptionObject(
            BlogException::invalidFieldValueType('config', BlogSuggestLoaderConfig::class, StubLoaderConfig::class)
        );

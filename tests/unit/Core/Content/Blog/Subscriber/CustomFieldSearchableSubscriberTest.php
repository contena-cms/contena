...
namespace Contena\Tests\Unit\Core\Content\Blog\Subscriber;
...
class CustomFieldSearchableSubscriberTest extends TestCase
{
    ...
    public function testOnCustomFieldWrittenDeletesFromBlogSearchConfigField(): void
    {
        ...
        $this->connection->expects($this->once())
            ...
            WHERE custom_field_id IN (:customFieldIds)',
                ['customFieldIds' => Uuid::fromHexToBytesList([$customFieldId1, $customFieldId2])],

...
class CookieRouteTest extends TestCase
{
    ...
    public function testGetCookieGroups(): void
    {
        ...
        $response1 = $cookieRoute->getCookieGroups(new Request(), $channelContext);
        $response2 = $cookieRoute->getCookieGroups(new Request(), $channelContext);
        ...
        // Verify languageId is included and matches the channel context
        static::assertSame($channelContext->getLanguageId(), $response1->getLanguageId());
        static::assertSame($channelContext->getLanguageId(), $response2->getLanguageId());
    }
    ...
    public function testHashChangesWithDifferentCookieConfiguration(): void
    {
        ...
        $response1 = new CookieRoute($cookieProvider1)->getCookieGroups(new Request(), $channelContext);
        $response2 = new CookieRoute($cookieProvider2)->getCookieGroups(new Request(), $channelContext);
    ...
    public function testOriginalCookieGroupOrderIsPreserved(): void
    {
        ...
        $response = new CookieRoute($cookieProvider)->getCookieGroups(new Request(), $channelContext);
    ...
    public function testHashIgnoresExtendedProperties(): void
    {
        ...
        $standardResponse = new CookieRoute($standardProvider)->getCookieGroups(new Request(), $channelContext);
        $extendedResponse = new CookieRoute($extendedProvider)->getCookieGroups(new Request(), $channelContext);
    ...
    public function testHashChangesWhenDefinedPropertiesChange(): void
    {
        ...
        $response1 = new CookieRoute($provider1)->getCookieGroups(new Request(), $channelContext);
        $response2 = new CookieRoute($provider2)->getCookieGroups(new Request(), $channelContext);
    ...
    public function testThrowsCookieExceptionWhenHashGenerationFails(): void
    {
        ...
        $cookieRoute->getCookieGroups(new Request(), $channelContext);
    }
    ...
    public function testSetsCookieConfigHashValueWhenEntryExists(): void
    {
        ...
        $cookieRoute = new CookieRoute($cookieProvider);
        $response = $cookieRoute->getCookieGroups(new Request(), $channelContext);

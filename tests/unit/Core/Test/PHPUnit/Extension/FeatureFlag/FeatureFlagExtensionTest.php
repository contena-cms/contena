...
class FeatureFlagExtensionTest extends TestCase
{
    ...
    {
        $defaultNamespace = 'Contena\\Tests\\Unit\\';
    ...
    public static function invalidNamespaceDataProvider(): iterable
    {
        yield 'empty string namespace' => [
            ...
            'Namespace must be a valid PHP namespace ending with a backslash like this "Contena\Tests\Unit\", "" given.',
        ];
        ...
        yield 'white spaces string namespace with characters' => [
            ' a ',
            \InvalidArgumentException::class,
            'Namespace must be a valid PHP namespace ending with a backslash like this "Contena\Tests\Unit\", " a " given.',
        ];

        yield 'white spaces string namespace and backslashes' => [
            '  a\\b  ',
            \InvalidArgumentException::class,
            'Namespace must be a valid PHP namespace ending with a backslash like this "Contena\Tests\Unit\", "  a\b  " given.',
        ];
        ...
        yield 'namespace without backslashes at the end' => [
            ...
            \InvalidArgumentException::class,
            'Namespace must be a valid PHP namespace ending with a backslash like this "Contena\Tests\Unit\", "valid\namespace\without\backslash\at\the\end" given.',
        ];

        yield 'namespace already present' => [
            'Contena\\Tests\\Unit\\',
            \InvalidArgumentException::class,
            'Namespace "Contena\Tests\Unit\" was already added to test namespaces.',
        ];
    }
}

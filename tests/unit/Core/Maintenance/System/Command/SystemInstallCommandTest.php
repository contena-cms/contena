...
class SystemInstallCommandTest extends TestCase
{
    ...
    public function testBasicSetupCreatesSupperadminAndRoleBasedAdminUsersWithTheSamePassword(): void
    {
    ...
    {
        $this->setEnvVars(['CONTENA_SKIP_WEBINSTALLER' => '0']);
    ...
    {
        $this->setEnvVars(['CONTENA_SKIP_WEBINSTALLER' => '1']);

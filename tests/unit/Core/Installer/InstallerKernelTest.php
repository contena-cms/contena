...
{
    #[TestDox('constructor resolves version from contena/platform when installed')]
    public function testConstructorUsesPlatformVersionWhenInstalled(): void
    {
        ...
        static::assertSame('6.6.0.0', $params['kernel.contena_version']);
        static::assertSame('abc123platform', $params['kernel.contena_version_revision']);
    }
    ...
    #[TestDox('resolveComposerVersion falls back to contena/core when contena/platform is not installed')]
    public function testResolveComposerVersionFallsBackToCorePackage(): void
    {
        ...
        try {
            ...
            static::assertSame('6.6.1.0', $params['kernel.contena_version']);
            static::assertSame('coreref123', $params['kernel.contena_version_revision']);

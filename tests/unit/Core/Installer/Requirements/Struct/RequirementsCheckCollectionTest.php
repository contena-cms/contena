...
class RequirementsCheckCollectionTest extends TestCase
{
    public function testGetExpectedClass(): void
    {
        ...
        $this->expectExceptionObject(FrameworkException::collectionElementInvalidType(RequirementCheck::class, MediaEntity::class));
        $collection->add(new MediaEntity()); /** @phpstan-ignore argument.type (for test purpose) */
    }

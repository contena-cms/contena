...
use Contena\Core\DevOps\StaticAnalyze\PHPStan\Rules\PublicServiceDecoratorRule;
...
class PublicServiceDecoratorRuleTest extends RuleTestCase
{
    public function testRule(): void
    {
        ...
        $this->analyse([__DIR__ . '/data/PublicServiceDecoratorRule/NonPublicDecorator.php'], [
            [
                'Service "Contena\Tests\DevOps\Core\DevOps\StaticAnalyse\PHPStan\Rules\data\PublicServiceDecoratorRule\NonPublicDecorator" decorates the public service "translator" but is not marked as public. Decorators of public services must also be public.',
                9,
            ],
        ]);
        ...
        $this->analyse([__DIR__ . '/data/PublicServiceDecoratorRule/NonExistDecorator.php'], [
            [
                'Service "Contena\Tests\DevOps\Core\DevOps\StaticAnalyse\PHPStan\Rules\data\PublicServiceDecoratorRule\NonExistDecorator" is a decorator for "some.non.exists.service", but the decorated service does not exist.',
                9,
            ],
        ]);
    }

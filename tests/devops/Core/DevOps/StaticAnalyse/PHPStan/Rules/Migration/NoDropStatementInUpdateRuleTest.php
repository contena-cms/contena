...
class NoDropStatementInUpdateRuleTest extends RuleTestCase
{
    public function testRule(): void
    {
        $this->analyse([
            ...
            ['Usage of method "dropForeignKeyIfExists" is disallowed in the "update" method of a migration to avoid blue green compatibility breaks. Dropping FKs is OK if immediately re-added, or if not breaking old app version validation. Use @phpstan-ignore contena.dropStatement if intentional.', 20],
            ...
            ['Usage of "DROP FOREIGN KEY" statements is disallowed in the "update" method of a migration to avoid blue green compatibility breaks. Dropping FKs is OK if immediately re-added, or if not breaking old app version validation. Use @phpstan-ignore contena.dropStatement if intentional.', 28],

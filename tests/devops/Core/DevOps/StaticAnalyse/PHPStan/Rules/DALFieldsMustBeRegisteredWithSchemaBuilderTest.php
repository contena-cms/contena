...
use Contena\Core\DevOps\StaticAnalyze\PHPStan\Rules\DALFieldsMustBeRegisteredWithSchemaBuilder;
...
class DALFieldsMustBeRegisteredWithSchemaBuilderTest extends RuleTestCase
{
    ...
    public function testRule(): void
    {
        ...
        $this->analyse([__DIR__ . '/data/DALFieldsMustBeRegisteredWithSchemaBuilder/NotRegisteredField.php'], [
            [
                'Field Contena\Core\Framework\DataAbstractionLayer\Field\Field\NotRegisteredField must be registered with Contena\Core\Framework\DataAbstractionLayer\Dbal\SchemaBuilder',
                12,
            ],
        ]);

...
use Contena\Core\DevOps\StaticAnalyze\PHPStan\Rules\NoRouteOverrideInDecoratorsRule;
...
class NoRouteOverrideInDecoratorsRuleTest extends RuleTestCase
{
    public function testRule(): void
    {
        ...
        $this->analyse([__DIR__ . '/data/NoRouteOverrideInDecoratorsRule/ControllerDecoratorWithRouteOverrides.php'], [
            [
                'Service "Contena\Tests\DevOps\Core\DevOps\StaticAnalyse\PHPStan\Rules\data\NoRouteOverrideInDecoratorsRule\ControllerDecoratorWithRouteOverrides" is a decorator but overrides @Route attributes (class or method-level). Decorators must not override or define routes, otherwise changes to the core route definition don\'t have any affect; only the core route should define the @Route attribute.',
                11,
            ],
        ]);
        ...
        //            [
        //                'Service "Contena\Tests\DevOps\Core\DevOps\StaticAnalyse\PHPStan\Rules\data\NoRouteOverrideInDecoratorsRule\ControllerDecoratorWithRouteOverridesViaDeprecatedAttributeClass" is a decorator but overrides @Route attributes (class or method-level). Decorators must not override or define routes, otherwise changes to the core route definition don\'t have any affect; only the core route should define the @Route attribute.',
        //                12,
        //            ],
        //        ]);
    }

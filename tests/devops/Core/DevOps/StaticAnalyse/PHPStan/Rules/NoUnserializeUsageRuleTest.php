...
use Contena\Core\DevOps\StaticAnalyze\PHPStan\Rules\NoUnserializeUsageRule;
...
class NoUnserializeUsageRuleTest extends RuleTestCase
{
    ...
    {
        $class = 'Contena\Tests\DevOps\Core\DevOps\StaticAnalyse\PHPStan\Rules\data\NoUnserializeUsageRule\HasUnserialize';
    ...
    {
        $class = 'Contena\Tests\DevOps\Core\DevOps\StaticAnalyse\PHPStan\Rules\data\NoUnserializeUsageRule\HasUnserializeInTestClass';
        ...
        $this->analyse([__DIR__ . '/data/NoUnserializeUsageRule/HasUnserializeInTestClass.php'], [
            ...
            ['No error with identifier contena.unserializeUsage is reported on line 19.', 19],

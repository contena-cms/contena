...
use Contena\Core\DevOps\StaticAnalyze\PHPStan\Rules\AbstractClassUsageRule;
...
class AbstractClassUsageRuleTest extends RuleTestCase
{
    ...
    public function testRule(): void
    {
        ...
        $this->analyse([__DIR__ . '/data/AbstractClassUsageRule/implementation-used.php'], [
            [
                'Decoration error: Parameter Contena\Core\Framework\Adapter\Translation\Translator $translator of Service is using the decoration pattern, but non-abstract constructor parameter is used.',
                8,
            ],
        ]);
    }

...
use Contena\Core\DevOps\StaticAnalyze\PHPStan\Rules\Tests\NoExpectExceptionMessageRule;
...
class NoExpectExceptionMessageRuleTest extends RuleTestCase
{
    public function testRule(): void
    {
        ...
        $this->analyse([__DIR__ . '/../data/NoExpectExceptionMessage/contena-unit-test.php'], [
            [$message, 15],
            [$message, 24],
            [$message, 33],
            [$message, 42],

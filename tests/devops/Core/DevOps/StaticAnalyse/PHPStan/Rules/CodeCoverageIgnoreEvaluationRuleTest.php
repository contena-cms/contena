...
{
    private const string FIXTURE_DIR = __DIR__ . '/data/CodeCoverageIgnoreEvaluation/';
    private const string FQCN_PREFIX = 'Contena\\Tests\\DevOps\\Core\\DevOps\\StaticAnalyse\\PHPStan\\Rules\\data\\CodeCoverageIgnoreEvaluation\\';

...
class McpDiscoveryScanDirsConfigTest extends TestCase
{
    ...
    public function testScanDirsResolveToBundleMcpDirectoriesForAnyProjectDir(): void
    {
        ...
        if (class_exists(Frontend::class)) {
            static::assertContains($this->bundleMcpDir(Frontend::class), $resolved);
        }
    }

    /**
     * For a monorepo checkout (project dir = repo root) the core scan dir stays
    ...
    private function loadScanDirs(string $projectDir): array
    {
        ...
        $container->setParameter('kernel.bundles_metadata', [
            ...
            'Frontend' => ['path' => $this->bundleDir(Frontend::class)],
        ]);

...
class AdminSearchRegistryTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $searchHelper = new AdminElasticsearchHelper(true, true, 'ct-admin', 'test', true, $this->createMock(LoggerInterface::class));
    ...
    public function testIterate(): void
    {
        ...
        if (Feature::isActive('ENABLE_OPENSEARCH_FOR_ADMIN_API')) {
            // Assert Blog-specific properties from mapping()
            static::assertArrayHasKey('active', $properties);
            static::assertArrayHasKey('name', $properties);
            static::assertArrayHasKey('releaseDate', $properties);
            static::assertArrayHasKey('categoryIds', $properties);
            static::assertArrayHasKey('tagIds', $properties);
            static::assertArrayHasKey('channelIds', $properties);

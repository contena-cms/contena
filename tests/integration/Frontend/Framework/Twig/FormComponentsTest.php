...
class FormComponentsTest extends TestCase
{
    ...
    public function testInputRendersLabelAndValidationHooks(): void
    {
        ...
        static::assertStringContainsString('class="ct-form-input ct-form-field form-group"', $html);
        static::assertStringContainsString('class="ct-form-label form-label" for="firstName"', $html);
        ...
        static::assertStringContainsString('class="ct-form-feedback form-field-feedback" id="firstName-feedback"', $html);
    }
    ...
    public function testClassAndStyleDressTheWrapperAndEveryOtherAttributeReachesTheControl(): void
    {
        ...
        static::assertStringContainsString('class="ct-form-input ct-form-field form-group col-sm-6"', $html);
    ...
    public function testAnExplicitIdRipplesIntoTheLabelAndFeedbackReferences(): void
    {
        ...
        static::assertStringContainsString('id="profileName"', $explicit);
        static::assertStringContainsString('for="profileName"', $explicit);
        static::assertStringContainsString('aria-describedby="profileName-feedback"', $explicit);
    }
    ...
    public function testCheckboxUsesTheBootstrapFormCheckStructure(): void
    {
        ...
        static::assertStringContainsString('class="ct-form-checkbox ct-form-field form-group form-check"', $html);
    ...
    public function testRadioGroupWrapsTheOptionsInAFieldset(): void
    {
        ...
        static::assertStringContainsString('class="ct-form-radio-group ct-form-field form-radio-group mb-3"', $html);
    ...
    public function testRadioRendersStandaloneWithItsOwnFormCheck(): void
    {
        ...
        static::assertStringContainsString('class="ct-form-radio form-check mb-2"', $html);
    ...
    public function testBirthdaySelectRendersThreeAutocompletedSelects(): void
    {
        ...
        static::assertStringContainsString('<fieldset ', $html);
        static::assertStringContainsString('class="ct-form-birthday-select form-group"', $html);
    ...
    public function testBirthdaySelectPrefixesNamesAndIds(): void
    {
        ...
        static::assertStringContainsString('name="address[birthdayDay]"', $html);
        static::assertStringContainsString('name="address[birthdayMonth]"', $html);
        static::assertStringContainsString('name="address[birthdayYear]"', $html);
        static::assertStringContainsString('id="address-birthdayDay"', $html);
        static::assertStringContainsString('id="address-birthdayYear"', $html);
    }
    ...
    public function testEveryFieldTypeCarriesTheSharedFieldAndControlHooks(): void
    {
        ...
        foreach ($fields as $component => $props) {
            ...
            static::assertStringContainsString('ct-form-field ', $html, $component);
            static::assertStringContainsString('ct-form-field__control ', $html, $component);
            static::assertStringContainsString('ct-form-feedback ', $html, $component);
        }
    }
    ...
    public function testRadioGroupIsOneFieldWithSeveralControls(): void
    {
        ...
        static::assertSame(1, substr_count($html, 'ct-form-field '));
        static::assertSame(2, substr_count($html, 'ct-form-field__control '));
        static::assertSame(1, substr_count($html, 'ct-form-feedback '));
    ...
    public function testCheckboxLinksItsDescriptionToTheControl(): void
    {
        ...
        static::assertStringContainsString('aria-describedby="updates-description updates-feedback"', $html);
        static::assertStringContainsString('id="updates-description"', $html);
    }

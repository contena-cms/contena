...
class NavigationTreeComponentTest extends TestCase
{
    ...
    /**
     * Depth belongs to the channel. Exposing it per element cannot be done honestly: Studio
     ...
     */
    public function testDepthIsLeftToTheChannel(): void
    {
        $types = static::getContainer()->get(ContentSystemElementTypeRegistry::class);
        static::assertInstanceOf(AbstractContentSystemElementTypeRegistry::class, $types);
    ...
    public function testRendersNestedListsWithSingleNavLandmark(): void
    {
        ...
        static::assertStringContainsString('--ct-navigation-tree-items-level: 1;', $html);
        static::assertStringContainsString('--ct-navigation-tree-items-level: 2;', $html);
    }
    ...
    public function testRendersFolderAsNonInteractiveText(): void
    {
        ...
        static::assertStringContainsString('ct-navigation-tree-items__folder', $html);
     ...
     * (`contena.navigation`, `context.channel`, the translator) are never evaluated.
     *

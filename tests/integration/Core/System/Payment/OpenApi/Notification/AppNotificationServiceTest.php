...
namespace Contena\Tests\Integration\Core\System\Payment\OpenApi\Notification;
...
final class AppNotificationServiceTest extends TestCase
{
    ...
    public function testDeliversASignedNotificationAndPersistsTheResponse(): void
    {
        ...
        static::assertTrue(Signature::verify($sentPayload, self::APP_SECRET, $this->clock->now()->getTimestamp()));

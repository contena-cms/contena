...
class ChannelFileControllerTest extends TestCase
{
    ...
    public function testItListsDiscoveredFilesWithChannelConfiguration(): void
    {
        ...
        $this->getBrowser()->request('GET', '/api/_action/channel-file/agentic/' . TestDefaults::CHANNEL);
    ...
    public function testItLoadsDiscoveredFileDetailWithTemplateContent(): void
    {
        ...
        $this->getBrowser()->request('GET', '/api/_action/channel-file/agentic/' . TestDefaults::CHANNEL . '/detail?fileName=llms.txt');
    ...
    public function testItPreviewsChannelFileWithMerchantOverrides(): void
    {
        $this->getBrowser()->jsonRequest('POST', '/api/_action/channel-file/agentic/' . TestDefaults::CHANNEL . '/preview', [
            'fileName' => 'llms.txt',
            'templateOverrides' => [
    ...
    public function testItRejectsInvalidPreviewPath(): void
    {
        ...
        static::assertSame('FRAMEWORK__CHANNEL_FILE_INVALID_PATH', $response['errors'][0]['code']);
    }

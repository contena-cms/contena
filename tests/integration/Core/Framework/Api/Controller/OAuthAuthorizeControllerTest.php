...
class OAuthAuthorizeControllerTest extends TestCase
{
    ...
    private const CLIENT_ID = 'contena-cli';
    ...
    public function testInfoDescribesTheClient(): void
    {
        ...
        static::assertSame([
            'client' => ['id' => self::CLIENT_ID, 'name' => 'Contena CLI'],
    ...
    public function testFullAuthorizationCodeFlow(): void
    {
        ...
        $accessToken = static::getContainer()->get('contena.jwt_config')->parser()->parse($tokens['access_token']);
    ...
    private function getUserIdOfBrowser(KernelBrowser $browser): string
    {
        ...
        $token = static::getContainer()->get('contena.jwt_config')->parser()->parse($bearer);

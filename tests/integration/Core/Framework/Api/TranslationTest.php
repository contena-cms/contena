...
class TranslationTest extends TestCase
{
    ...
    public function testDelete(): void
    {
        ...
        $this->getBrowser()->jsonRequest('POST', $baseResource, $countryData);
        $response = $this->getBrowser()->getResponse();
        static::assertSame(204, $response->getStatusCode());
    ...
    public function testDeleteSystemLanguageViolation(): void
    {
        ...
        $countryData = [
            'id' => $id,
            'translations' => [
                Defaults::LANGUAGE_SYSTEM => ['name' => 'Test country'],
            ],
        ];
        $this->getBrowser()->jsonRequest('POST', $baseResource, $countryData);
        $response = $this->getBrowser()->getResponse();
    ...
    {
        /**
         * This works because the dal does not generate a `DeleteCommand` for the `CountryTranslation`.
    ...
    public function testMixedTranslationStatus(): void
    {
        ...
        $this->assertEntityExists($this->getBrowser(), 'country', $idSystem);
        ...
        $this->assertEntityExists($this->getBrowser(), 'country', $idRoot);
        ...
        $this->assertEntityExists($this->getBrowser(), 'country', $idChild);
    ...
    private function assertTranslationError(array $errors, array $data): void
    {
        ...
        $countryData = array_merge_recursive($countryData, $data);
     ...
     */
    private function assertTranslation(array $expectedTranslations, array $data, ?string $langOverride = null, string $entity = 'country'): void
    {

...
use Contena\Core\Framework\Api\OAuth\AuthCode;
...
class AuthCodeRepositoryTest extends TestCase
{
    ...
    public function testPersistedCodeIsValidUntilRevoked(): void
    {
        ...
        static::assertSame('contena-cli', $stored['client_id']);
    ...
    public function testCodesWithoutUserAreNotPersisted(): void
    {
        ...
        $authCode->setClient(new ApiClient('contena-cli', true, confidential: false));

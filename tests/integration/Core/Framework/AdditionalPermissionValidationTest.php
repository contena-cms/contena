...
class AdditionalPermissionValidationTest extends TestCase
{
     ...
     */
    private const array ROOT_CLASSES = [Administration::class, Kernel::class];

    /**
     * @var array<int, string> disallow list file path segments for ignored paths
     */
    ...
    public function testSourceFilesForUnvalidatedPrivileges(): void
    {
        ...
        foreach ($this->disallowList as $path) {
            $finder->notPath($path);
        }

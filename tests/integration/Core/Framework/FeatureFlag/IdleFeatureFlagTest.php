...
class IdleFeatureFlagTest extends TestCase
{
    ...
    final public const array EXCLUDED_DIRS = [
        'Docs',
    ...
    final public const array EXCLUDE_BY_FLAG = [
        'FEATURE_NEXT_1',
        'FEATURE_NEXT_2',
        'FEATURE_NEXT_101',
        'FEATURE_NEXT_102',
    ...
    protected function setUp(): void
    {
        ...
        Feature::registerFeatures(self::getContainer()->getParameter('contena.feature.flags'));
    }

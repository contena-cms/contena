...
class RedisContainerWiringTest extends TestCase
{
    ...
    public function testRedisConnections(): void
    {
        ...
        static::assertTrue($container->hasParameter('contena.redis.connections.ephemeral.dsn'));
        static::assertSame($redisUrl, $container->getParameter('contena.redis.connections.ephemeral.dsn'));
    ...
    {
        $container = self::$kernel->getContainer();
        $gatewayRegistry = $container->get('contena.increment.gateway.registry');
    ...
    public function testCacheInvalidatorAdapter(): void
    {
        ...
        static::assertTrue($container->has('contena.cache.invalidator.storage.redis_adapter'));
        $redis = $container->get('contena.cache.invalidator.storage.redis_adapter');
    ...
    public function testNumberRanges(): void
    {
        ...
        static::assertTrue($container->has('contena.number_range.redis'));
        $redis = $container->get('contena.number_range.redis');
    ...
    public function testCartRedisConnection(): void
    {
        ...
        static::assertTrue($container->has('contena.cart.redis'));
        $redis = $container->get('contena.cart.redis');

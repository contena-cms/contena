...
namespace Contena\Tests\Integration\Core\Framework\DataAbstractionLayer\Indexing;
...
{
    final public const string ENTITY_NAME = 'test_tree';
...
{
    final public const string ENTITY_NAME = 'test_tree_without_version';

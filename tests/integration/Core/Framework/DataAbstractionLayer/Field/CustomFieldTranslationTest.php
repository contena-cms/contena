...
class CustomFieldTranslationTest extends TestCase
{
    ...
    public function testRawIsNotInherited(): void
    {
        ...
        $context = new Context(new SystemSource(), $chain);
    ...
    public function testTranslationChainOnFilter(): void
    {
        ...
        // system
        $context = new Context(new SystemSource(), [Defaults::LANGUAGE_SYSTEM]);
        ...
        // root -> system
        $context = new Context(new SystemSource(), [$rootId, Defaults::LANGUAGE_SYSTEM]);
        ...
        // child -> root -> system
        $context = new Context(new SystemSource(), [$childId, $rootId, Defaults::LANGUAGE_SYSTEM]);

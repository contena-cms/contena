...
class MigrationLoaderTest extends TestCase
{
    ...
    public function testTheInterfaceNew(): void
    {
        ...
        $collection = $this->loader->collect('core.V6_8');

        static::assertSame('core.V6_8', $collection->getName());
        static::assertContainsOnlyInstancesOf(MigrationStep::class, $collection->getMigrationSteps());
    ...
    public function testThatInvalidMigrationClassesThrowOnLazyInit(): void
    {
        ...
        $this->expectExceptionMessageMatches('/Unable to load migration Contena\\\\Core\\\\Framework\\\\Test\\\\Migration\\\\_test_migrations_invalid_namespace\\\\Migration1WithoutANamespace at path/');

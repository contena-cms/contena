...
class MigrationCommandTest extends TestCase
{
    ...
    public function testCommandMigrateCacheClearBehaviourWithoutMigrations(): void
    {
        ...
        $command = new MigrationCommand($loader, $cache, static::getContainer()->getParameter('kernel.contena_version'));
    ...
    public function testCommandMigrateCacheClearBehaviourWithOneMigration(): void
    {
        ...
        $command = new MigrationCommand(static::getContainer()->get(MigrationCollectionLoader::class), $cache, static::getContainer()->getParameter('kernel.contena_version'));

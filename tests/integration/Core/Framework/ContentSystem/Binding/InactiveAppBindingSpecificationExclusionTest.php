 ...
 * core "Ct:Media:Image" synthesized default shipped via the filesystem loader -- both remain, proving
...
class InactiveAppBindingSpecificationExclusionTest extends TestCase
{
    ...
    {
        // Reuses the shape of the shipped core:Ct:Media:Image default so TypeConsistentBindingSpecificationValidator

...
namespace Contena\Tests\Integration\Core\Framework\ContentSystem\Output;
...
use Contena\Tests\Integration\Core\Framework\ContentSystem\Channel\ContentRouteRenderingTest;
...
class ContentPageAliasRegistrationTest extends TestCase
{
    ...
    public function testNoEntityIsRegisteredUnderAContentPageAlias(string $alias): void
    {
        static::assertFalse(
            ...
            'An entity registered as "' . $alias . '" would put the channel-api protection gate in charge of a '

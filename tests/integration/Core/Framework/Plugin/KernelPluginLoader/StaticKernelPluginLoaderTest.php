...
class StaticKernelPluginLoaderTest extends TestCase
{
    ...
    public function testExpectExceptionOnMissingAutoload(): void
    {
        ...
        $this->expectExceptionObject(PluginException::kernelPluginLoaderError('CtTestPlugin', 'Unable to register plugin "CtTestPlugin\CtTestPlugin" in autoload. Required property `autoload` missing.'));
        $loader->initializePlugins(TEST_PROJECT_DIR);
    }
    ...
    public function testExpectExceptionOnMissingAutoloadPsr(): void
    {
        ...
        $this->expectExceptionObject(PluginException::kernelPluginLoaderError('CtTestPlugin', 'Unable to register plugin "CtTestPlugin\CtTestPlugin" in autoload. Required property `psr-4` or `psr-0` missing in property autoload.'));
        $loader->initializePlugins(TEST_PROJECT_DIR);
    }
    ...
    public function testGetBundles(): void
    {
        ...
        static::assertInstanceOf(CtTestPlugin::class, $bundles[1]);
    ...
    public function testGetBundlesWithAdditionalBundlesThatAreDuplicatesButKeepOrder(): void
    {
        ...
        static::assertInstanceOf(CtTestPlugin::class, $bundles[1]);
        static::assertInstanceOf(FooBarBundle::class, $bundles[2]);
        static::assertInstanceOf(CtTestWithBundle::class, $bundles[3]);
    ...
    public function testExpectExceptionWithFakePlugin(): void
    {
        ...
        /** @phpstan-ignore argument.type (for test purpose) */
        $plugin->setBaseClass(CtTestFake::class);

        $loader = $this->createKernelPluginLoaderWithPlugins([$plugin->jsonSerialize()]);

        $this->expectExceptionObject(PluginException::kernelPluginLoaderError('CtTestPlugin', 'Plugin class "CtTestPlugin\CtTestFake" must extend "Contena\Core\Framework\Plugin"'));
        $loader->initializePlugins(TEST_PROJECT_DIR);
    }
    ...
    public function testBuild(): void
    {
        ...
        $definition = $container->getDefinition(CtTestPlugin::class);
    ...
    public function testBuildWithExistingDefinition(): void
    {
        ...
        $container->setDefinition(CtTestPlugin::class, $definition);

        $loader->build($container);

        $actualDefinition = $container->getDefinition(CtTestPlugin::class);
    ...
    public function testExpectExceptionExternalPath(): void
    {
        ...
        $this->expectExceptionObject(PluginException::kernelPluginLoaderError('CtTestPlugin', 'Plugin dir /custom/plugins/TestPlugin needs to be a sub-directory of the project dir ' . TEST_PROJECT_DIR));

...
class EmailSenderTest extends TestCase
{
    ...
    private function doRunTest(): void
    {
        ...
        $filesystem = $container->get('contena.filesystem.private');
        static::assertInstanceOf(FilesystemOperator::class, $filesystem);
        $maxMessageSizeKiB = $container->getParameter('contena.messenger.message_max_kib_size');
        ...
        $expectedMailPath = 'mail-data/platform/' . Hasher::hash($serializedMail);

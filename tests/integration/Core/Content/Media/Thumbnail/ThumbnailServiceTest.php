...
class ThumbnailServiceTest extends TestCase
{
    ...
    public function testThumbnailGeneration(): void
    {
        ...
        $resource = fopen(__DIR__ . '/../fixtures/contena-logo.png', 'r');
    ...
    public function testItUsesOriginalImageIfItsSmallerThanGeneratedThumbnail(): void
    {
        ...
        $filePath = $media->getPath();
        $resource = fopen(__DIR__ . '/../fixtures/contena_optimized.jpg', 'r');
        \assert($resource !== false);
        $this->getPublicFilesystem()->writeStream($filePath, $resource);
    ...
    public function testItUsesFolderConfigGenerateThumbnails(): void
    {
        ...
        $filePath = $media->getPath();
        $resource = fopen(__DIR__ . '/../fixtures/contena.jpg', 'r');
                ...
                [
                    ...
                    'thumbnails' => [
                        [
                            ...
                            'highDpi' => false,
                            'mediaThumbnailSizeId' => $this->getOrCreateThumbnailSizeId(100, 100),
                        ],
                        [
                            'width' => 300,
                            'height' => 300,
                            ...
                            'highDpi' => true,
                            'mediaThumbnailSizeId' => $this->getOrCreateThumbnailSizeId(300, 300),
                        ],
                    ],
                ],
            ],
    ...
    public function testGenerateThumbnailsWithSmallerImageSizeThanThumbnailSize(): void
    {
        ...
        $this->thumbnailRepository->create([
            [
                ...
                'width' => 150,
                'height' => 150,
                'mediaThumbnailSizeId' => $this->getOrCreateThumbnailSizeId(150, 150),
            ],
            [
                'mediaId' => $media->getId(),
                'width' => 300,
    ...
    public function testGenerate(): void
    {
        ...
        $this->getFilesystem('contena.filesystem.public')->writeStream($media->getPath(), $resource);
    }
}

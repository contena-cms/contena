...
class ImageTypeDetectorTest extends TestCase
{
    ...
    {
        $type = $this->getImageTypeDetector()->detect(
            $this->createMediaFile(__DIR__ . '/../fixtures/contena-logo.vp8x.webp'),
            null
        );
    ...
    {
        $type = $this->getImageTypeDetector()->detect(
            $this->createMediaFile(__DIR__ . '/../fixtures/contena-logo.avif'),
            null
        );
    ...
    {
        $type = $this->getImageTypeDetector()->detect(
            $this->createMediaFile(__DIR__ . '/../fixtures/contena.jpg'),
            null
        );
    ...
    {
        $type = $this->getImageTypeDetector()->detect(
            $this->createMediaFile(__DIR__ . '/../fixtures/contena-logo.png'),
            null
        );
    ...
    {
        $type = $this->getImageTypeDetector()->detect(
            $this->createMediaFile(__DIR__ . '/../fixtures/contena-logo-1.PNG'),
            null
        );

...
namespace Contena\Tests\Integration\Core\Content\Cookie\Channel;
...
class CookieConsentLogRouteTest extends TestCase
{
    ...
    {
        $response = $this->route->log(new Request(content: (string) json_encode($payload)), $this->channelContext);

...
class SetupDatabaseAdapterTest extends TestCase
{
    public function testInitialize(): void
    {
        ...
        try {
            ...
            static::assertFalse($setupDatabaseAdapter->hasContenaTables($connection, $testDbName));

            $setupDatabaseAdapter->initializeContenaDb($connection, $testDbName);

            static::assertTrue($setupDatabaseAdapter->hasContenaTables($connection, $testDbName));
        } finally {

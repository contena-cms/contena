...
class KnownIpsCollector implements KnownIpsCollectorInterface
{
     ...
     * <code>
     *     [
     *         '127.0.0.1' => 'global.ct-multi-tag-ip-select.knownIps.you',
     *         // or
     *         '2001:0db8:0123:4567:89ab:cdef:1234:5678' => 'global.ct-multi-tag-ip-select.knownIps.you',
     *         '2001:0db8:0123:4567::/64' => 'global.ct-multi-tag-ip-select.knownIps.youIPv6Block64',
     *         '2001:0db8:0123:4500::/56' => 'global.ct-multi-tag-ip-select.knownIps.youIPv6Block56'
     *     ]
     * </code>
     */
    public function collectIps(Request $request): array
    {
        ...
        $result[$clientIp] = 'global.ct-multi-tag-ip-select.knownIps.you';
        ...
        if (\is_string($binaryRepresentation64)) {
            ...
            $result[$cidr64] = 'global.ct-multi-tag-ip-select.knownIps.youIPv6Block64';
        }

        if (\is_string($binaryRepresentation56)) {
            $cidr56 = \inet_ntop($binaryRepresentation56) . '/56';
            $result[$cidr56] = 'global.ct-multi-tag-ip-select.knownIps.youIPv6Block56';
        }

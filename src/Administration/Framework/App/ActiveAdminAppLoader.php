...
namespace Contena\Administration\Framework\App;
...
readonly class ActiveAdminAppLoader
{
    ...
    app.name, app.active, LOWER(HEX(app.integration_id)) as integrationId,
    app.base_app_url as baseUrl, app.version, app.source_type as sourceType,
    ar.privileges as privileges
FROM app LEFT JOIN acl_role ar on app.acl_role_id = ar.id

...
namespace Contena\Administration\Framework\Asset;
...
{
    private const string VITE_ENTRYPOINTS_JSON = 'administration/.vite/entrypoints.json';
    private const string VITE_MANIFEST_JSON = 'administration/.vite/manifest.json';

...
class ViteFileAccessorDecorator extends FileAccessor
{
     ...
     * @return array<string, mixed>
     */
    public function getBundleData(ContenaBundle $bundle): array
    {
    ...
    private function getTechnicalBundleName(ContenaBundle $bundle): string
    {
     ...
     * @return array<string, mixed>
     */
    private function getContent(string $fileType, ContenaBundle $bundle): array
    {

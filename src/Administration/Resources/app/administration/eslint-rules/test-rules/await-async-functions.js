...
const getAsyncExpressionName = (node) => {
    // Contena.Component.build
    if (node.callee?.object?.object?.name === 'Contena' && node.callee?.object?.property?.name === 'Component' && node.callee?.property?.name === 'build') {
        return 'Contena.Component.build';
    }

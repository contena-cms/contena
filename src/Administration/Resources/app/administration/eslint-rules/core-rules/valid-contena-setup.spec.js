...
ruleTester.run('valid-contena-setup', rule, {
    valid: [
        {
            filename: 'base.vue',
            code: `<script setup>
...
swDefineOverride({});
            ...
            errors: [
                {
                    message: 'defineProps() is only supported in base Contena setup blocks.',
                },
            ],
        },
        {
...
swDefineOverride({});
            ...
            errors: [
                {
                    message: 'withDefaults() is only supported in base Contena setup blocks.',
                },
            ],
        },
        {
...
swDefineOverride({});
            ...
            errors: [
                {
                    message: 'defineEmits() is only supported in base Contena setup blocks.',
                },
            ],
        },
        {
...
swDefineOverride({});
            ...
            errors: [
                {
                    message: 'defineSlots() is only supported in base Contena setup blocks.',
                },
            ],
        },
        {
...
swDefineOverride({});
            ...
            errors: [
                {
                    message: 'defineOptions() is only supported in base Contena setup blocks.',
                },
            ],
        },
        {

const { validateContenaSetupSfc, ContenaSetupTransformError } = require('../../build/vue-setup-transform');
...
module.exports = {
    meta: {
        type: 'problem',
        docs: {
            description: 'Validate Contena setup SFC blocks',
    ...
    create(context) {
        return {
            Program(node) {
                ...
                try {
                    validateContenaSetupSfc(sourceCode.text, filename);
                } catch (error) {

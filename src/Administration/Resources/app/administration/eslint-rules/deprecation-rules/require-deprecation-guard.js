 ...
 * and the `Contena.Component.wrapComponentConfig` variant.
 */
...
module.exports = {
    meta: {
        ...
        docs: {
            ...
            recommended: true,
            url: 'https://github.com/contena/contena/blob/trunk/adr/2026-08-10-administration-javascript-deprecation-guards.md',
        },
        ...
        messages: {
            missingGuard:
                ...
                "Contena.Feature.triggerDeprecationOrThrow('{{flag}}', '...') as the first statement of its " +

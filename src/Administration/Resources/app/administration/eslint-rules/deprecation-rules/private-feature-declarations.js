 ...
 * Contena.Component.register('bar', {});
 * Module.register('foo', {});
 * Contena.Module.register('bar', {});
...
module.exports = {
    meta: {
        ...
        docs: {
            ...
            recommended: true,
            url: 'https://handbook.contena.cn/Product/Product/Components/Admin/NewFeatures',
        },
    },
    create(context) {
        return {
            ...
            ExpressionStatement(node) {
                ...
                if (!isFeatureRegister && root?.object && root?.property && root?.object?.name === 'Contena' && root.property.name === 'Component' && property === 'register') {
                    isFeatureRegister = true;
                }
                ...
                if (!isFeatureRegister && root?.object && root?.property && root?.object?.name === 'Contena' && root.property.name === 'Module' && property === 'register') {
                    isFeatureRegister = true;
                }
                ...
                if (!isFeatureRegister && root?.callee?.object && root?.callee?.property && root?.callee?.object.name === 'Contena' && root.callee.property.name === 'Service' && property === 'register') {
                    isFeatureRegister = true;
                }

...
yetAnotherThing();
      ...
      `,
        ...
        const obj = {
          sliderLength() {
              const children = Contena.Utils.VueHelper.getCompatChildren();
...
return true;
      ...
      `,
        ...
        const children = this.isCompatEnabled('INSTANCE_CHILDREN')
                ? this.$children
                : Contena.Utils.VueHelper.getCompatChildren();
      `,
            output: `
        const children = Contena.Utils.VueHelper.getCompatChildren();
      `,
        ...
        },
        {
            ...
            code: `const children = this.isCompatEnabled('INSTANCE_CHILDREN') ? this.$children : Contena.Utils.VueHelper.getCompatChildren();`,
            output: `const children = Contena.Utils.VueHelper.getCompatChildren();`,
            errors: [{ message: 'Feature flag condition should be removed' }],
        },
        {
        ...
        if (!this.isCompatEnabled('INSTANCE_EVENT_EMITTER')) {
            ...
            Contena.Utils.EventBus.$off('on-change-notification-center-visibility', this.changeVisibility);
        }
      `,
            output: `
        this.$root.$off('on-change-notification-center-visibility', this.changeVisibility);

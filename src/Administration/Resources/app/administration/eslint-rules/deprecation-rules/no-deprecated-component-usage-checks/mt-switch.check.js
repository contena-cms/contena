...
const handleMtSwitch = (context, node) => {
    ...
    // Refactor the old usage of ct-switch-field to mt-switch after the migration to the new component
...
const mtSwitchValidChecks = [
    {
        name: '"ct-switch-field" usage is allowed',
        filename: 'test.html.twig',
        code: `
            <template>
                <ct-switch-field></ct-switch-field>
            </template>
        `,
    }
]

...
const handleMtButton = (context, node) => {
    ...
    // Refactor the old usage of ct-button to mt-button after the migration to the new component
...
const mtButtonValidChecks = [
    ...
    {
        name: '"ct-button" usage is allowed',
        filename: 'test.html.twig',
        code: `
            <template>
    ...
    {
        name: 'Ignore wrong "ct-button" usage with old variant prop "ghost"',
        filename: 'test.html.twig',
        code: `
            <template>
                <ct-button variant="ghost">Hello</ct-button>
            </template>`,
    },
    {
...
const mtButtonInvalidChecks = [
    ...
    },
    {
        ...
        code: `
            <template>
                <mt-button variant="secondary" router-link="ct.example.link">Hello</mt-button>
            </template>`,
        output: `
            <template>
                <mt-button variant="secondary" @click="$router.push('ct.example.link')">Hello</mt-button>
            </template>`,
        errors: [{
            message: '[mt-button] The "router-link" prop is deprecated without replacement.',
        }]
    ...
    },
    {
        ...
        output: `
            <template>
                <mt-button
                    @click="$router.push('ct.example.link')"
                    variant="secondary"
                >
                    Hello
                </mt-button>
    ...
    },
    {
        ...
        code: `
            <template>
                <mt-button variant="secondary" :router-link="{ name: 'ct.example.link' }">Hello</mt-button>
            </template>`,
        output: `
            <template>
                <mt-button variant="secondary" @click="$router.push({ name: 'ct.example.link' })">Hello</mt-button>
            </template>`,
        errors: [{
            message: '[mt-button] The "router-link" prop is deprecated without replacement.',
        }]
    ...
    },
    {
        ...
        code: `
            <template>
                <mt-button
                    :router-link="{ name: 'ct.example.link' }"
                    variant="secondary"
                >
                    Hello
                </mt-button>
        ...
        output: `
            <template>
                <mt-button
                    @click="$router.push({ name: 'ct.example.link' })"
                    variant="secondary"
                >
                    Hello
                </mt-button>

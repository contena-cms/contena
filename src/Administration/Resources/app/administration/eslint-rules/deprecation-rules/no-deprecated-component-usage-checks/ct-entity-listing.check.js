...
const handleCtEntityListing = (context, node) => {
    ...
    if (itemsAttribute) {
        context.report({
            node: itemsAttribute,
            message: '[ct-entity-listing] The "items" prop is deprecated and will be removed in v6.8.0. Please use "data-source" instead.',
            *fix(fixer) {
...
const ctEntityListingValidChecks = [
    ...
    {
        name: '"ct-entity-listing" without items prop is allowed',
        filename: 'test.html.twig',
        code: `
            <template>
                <ct-entity-listing
...
const ctEntityListingInvalidChecks = [
    ...
    {
        name: '"ct-entity-listing" with deprecated items prop [disableFix]',
        filename: 'test.html.twig',
        options: ['disableFix'],
        code: `
            <template>
    ...
    {
        name: '"ct-entity-listing" with deprecated items prop [single line]',
        filename: 'test.html.twig',
        code: `
            <template>
                <ct-entity-listing :items="taxList" :repository="taxRepository" :columns="columns" />
            </template>`,
        output: `
            <template>
                <ct-entity-listing :data-source="taxList" :repository="taxRepository" :columns="columns" />
            </template>`,
        errors: [{
            message: '[ct-entity-listing] The "items" prop is deprecated and will be removed in v6.8.0. Please use "data-source" instead.',
        }]
    ...
    {
        name: '"ct-entity-listing" with deprecated items prop [multiple props]',
        filename: 'test.html.twig',
        code: `
            <template>
                <ct-entity-listing

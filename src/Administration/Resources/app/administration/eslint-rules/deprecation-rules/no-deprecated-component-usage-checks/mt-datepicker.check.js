...
const handleMtDatepicker = (context, node) => {
    ...
    // Refactor the old usage of ct-datepicker to mt-datepicker after the migration to the new component
...
const mtDatepickerValidTests = [
    ...
    {
        name: '"ct-datepicker" usage is allowed',
        filename: 'test.html.twig',
        code: `
            <template>
                <ct-datepicker>Hello</ct-datepicker>
            </template>`
    }
]

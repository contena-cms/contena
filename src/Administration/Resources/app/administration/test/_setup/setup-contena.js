/**
 *
 * Initializes the Contena global object and core registries for the test environment.
 * Previously provided by @contena-ag/jest-preset-sw6-admin.
 */
...
const Contena = require(resolve(join(srcPath, 'src/core/contena.ts'))).ContenaInstance;
...
const app = createApp();
app.use(Contena.Store._rootState);

process.env.NODE_ENV = envBefore;

module.exports = (() => {
    global.Contena = Contena;

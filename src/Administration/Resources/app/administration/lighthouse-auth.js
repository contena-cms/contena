...
module.exports = async (browser, context) => {
    ...
    try {
        await page.waitForSelector('.ct-dashboard', { timeout: 3000 });
        return;
    } catch (e) {
    ...
    await page.waitForSelector('input#ct-field--username', { timeout: 30000 });

    // Fill in the login credentials (default Contena admin credentials)
    await page.type('input#ct-field--username', 'admin');
    await page.type('input#ct-field--password', 'contenaAdmin');
    ...
    await page.waitForSelector('.ct-help-center__button', { timeout: 60000 });

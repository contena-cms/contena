/**
 * Selects the mode-specific lowering stage for an analyzed Contena setup block.
 *
...
import type { ContenaSetupScriptAnalysis } from '../script-analyzer';
 ...
 */
function lowerContenaSetupBlock(
    block: ContenaSetupBlock,
    analysis: ContenaSetupScriptAnalysis,

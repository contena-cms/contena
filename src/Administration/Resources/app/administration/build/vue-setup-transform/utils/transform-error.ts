 ...
 */
class ContenaSetupTransformError extends Error {
     ...
     */
    constructor(message: string, position: number | ContenaSetupErrorPosition | null = null) {
        super(message);
        this.name = 'ContenaSetupTransformError';

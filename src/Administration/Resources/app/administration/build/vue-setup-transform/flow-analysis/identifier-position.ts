...
function isValueReadPosition(node: BabelNode, parent: BabelNode | null): boolean {
    ...
    // Import specifiers declare local bindings; their imported/source-side names are module API names.
    // Neither side reads a setup binding, even when an imported name happens to match one.
    if (

...
const config: Config = {
    roots: [
        '<rootDir>',
        '<rootDir>/../../../../Frontend/Resources/app/administration',
    ],
    ...
    collectCoverageFrom: [
        ...
        '!src/**/*.spec/**',
        '!**/*.d.ts',
        '<rootDir>/../../../../Frontend/Resources/app/administration/src/**/*.js',
        '<rootDir>/../../../../Frontend/Resources/app/administration/src/**/*.ts',
        '!<rootDir>/../../../../Frontend/Resources/app/administration/src/**/*.spec.js',
        '!<rootDir>/../../../../Frontend/Resources/app/administration/src/**/*.spec/**',
    ...
    setupFilesAfterEnv: [
        resolve(join(__dirname, '/test/_setup/setup-contena.js')),
        'jest-expect-message',
    ...
    transform: {
        ...
        '^.+\\.vue$': '<rootDir>/test/transformer/contenaSetupVueTransformer.js',
    },

    transformIgnorePatterns: [
        '/node_modules/(?!(@contena/meteor-component-library|@contena/meteor-icon-kit|uuidv7|other)/)',
    ],
    ...
    moduleNameMapper: {
        ...
        '^test(.*)$': '<rootDir>/test$1',
        '^@contena-ag/admin-extension-sdk/es/(.*)': '<rootDir>/node_modules/@contena-ag/admin-extension-sdk/umd/$1',
        '^@contena/meteor-admin-sdk/es/(.*)': '<rootDir>/node_modules/@contena/meteor-admin-sdk/umd/$1',
        '^@contena/meteor-component-library$':
            '<rootDir>/node_modules/@contena/meteor-component-library/dist/common/index.js',
        '^@contena/meteor-component-library/dist/esm/(.*)$':
            '<rootDir>/node_modules/@contena/meteor-component-library/dist/common/$1',
    ...
    reporters: isCi
        ? [
              ...
              [
                  'jest-junit',
                  {
                      suiteName: 'Contena 6 Unit Tests',
    ...
    testMatch: [
        ...
        '<rootDir>/../../../../Frontend/Resources/app/administration/src/**/*.spec.js',
        '<rootDir>/../../../../Frontend/Resources/app/administration/src/**/*.spec.ts',
        '<rootDir>/../../../../Frontend/Resources/app/administration/src/**/*.spec/*.spec.js',
        '<rootDir>/../../../../Frontend/Resources/app/administration/src/**/*.spec/*.spec.ts',

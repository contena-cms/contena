...
class Tooltip {
    ...
    update({
        ...
        if (appearance && this._appearance !== appearance) {
            this._DOMElement!.classList.remove(`ct-tooltip--${this._appearance}`);
            this._appearance = appearance;
            this._DOMElement!.classList.add(`ct-tooltip--${this._appearance}`);
        }
    ...
    createParentDOMElementWrapper() {
        ...
        element.classList.add('ct-tooltip--wrapper');
    ...
    createDOMElement(): HTMLElement {
        ...
        element.classList.add('ct-tooltip');
        element.classList.add(`ct-tooltip--${this._appearance}`);
    ...
    _placeTooltip() {
        ...
        this._DOMElement!.classList.remove(`ct-tooltip--${this._actualTooltipPlacement!}`);
        ...
        this._DOMElement!.classList.add(`ct-tooltip--${this._actualTooltipPlacement ?? ''}`);
    }
 ...
 *  appearance: Sets a additional css class "ct-tooltip--$appearance" for styling
 ...
 */
Contena.Directive.register('tooltip', {

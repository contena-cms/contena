        ...
        template: `
            <div>
                <span
                    ...
                    :key="i"
                    :id="getIdName(i)"
                    v-droppable="{ data: { id: i }, dragGroup: 'ct-multi-snippet'}"
...
describe('directives/dragdrop', () => {
    ...
    beforeAll(() => {
        draggable = Contena.Directive.getByName('draggable');
        droppable = Contena.Directive.getByName('droppable');
    });
    ...
    it('should remove class name `is--draggable` for the draggable directive', async () => {
        ...
        const mockElement = document.getElementById('ct-dragdrop--1');
    ...
    it('should update data for the droppable directive with default config', async () => {
        ...
        const mockElement = document.getElementById('ct-dragdrop--2');
    ...
    it('should remove class name `is--droppable` for the droppable directive', async () => {
        ...
        const mockElement = document.getElementById('ct-dragdrop--3');
    ...
    it('should create the correct class on drag', async () => {
        ...
        const dragDrop1 = wrapper.find('#ct-dragdrop--1');
    ...
    it('should set the correct values when dragDrop moves over dropzone', async () => {
        ...
        const dragDrop1 = wrapper.find('#ct-dragdrop--1');
        const dragDrop2 = wrapper.find('#ct-dragdrop--2');

...
const marker = (node: VNode): unknown => node.props?.['data-ct-block'];

describe('ct-block/mark-block-vnodes', () => {
    ...
    it('extends an existing marker', () => {
        const marked = markBlockVNodes(h('div', { 'data-ct-block': 'inner' }), 'outer');

...
import 'src/app/component/meteor/ct-meteor-navigation';

async function createWrapper(customRoute, fromLink = null) {
    return mount(await wrapTestComponent('ct-meteor-navigation', { sync: true }), {
        props: { fromLink },
        global: {
            stubs: {
                'router-link': {
                    template: '<div class="ct-router-link"><slot></slot></div>',
                    props: ['to'],
                },
            },
            mocks: {
...
describe('src/app/component/meteor/ct-meteor-navigation', () => {
    const testRoute = {
    ...
    it('should display the back link', async () => {
        ...
        const routerLink = wrapper.getComponent('.ct-meteor-navigation__link');
    ...
    it('should not display the back link when no parent exists', async () => {
        ...
        const routerLink = wrapper.find('.ct-meteor-navigation__link');

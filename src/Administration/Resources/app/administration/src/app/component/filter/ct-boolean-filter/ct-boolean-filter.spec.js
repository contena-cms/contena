...
async function createWrapper() {
    return mount(await wrapTestComponent('ct-boolean-filter', { sync: true }), {
...
describe('components/ct-boolean-filter', () => {
    it('should emit `filter-update` event when user changes from default option to `Active`', async () => {
        const wrapper = await createWrapper();

        await selectMtSelectOptionByText(wrapper, 'ct-boolean-filter.active');
    ...
    it('should emit `filter-update` event when user changes from default option to `Inactive`', async () => {
        ...
        await selectMtSelectOptionByText(wrapper, 'ct-boolean-filter.inactive');

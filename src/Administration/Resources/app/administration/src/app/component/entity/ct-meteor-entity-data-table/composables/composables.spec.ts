...
import type { MeteorEntityTableRecord } from '../ct-meteor-entity-data-table.types';
...
describe('ct-meteor-entity-data-table composables', () => {
    it('normalizes wrapper column definitions for mt-data-table', () => {
        ...
        expect(resolvedColumns.value).toEqual([
            {
                property: 'name',
                label: 'translated.ct-settings-tag.list.columnName',
                position: 100,
                renderer: 'badge',
                rendererOptions: {
                    renderItemBadge,

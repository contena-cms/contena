...
describe('src/app/component/filter/ct-date-filter - legacy compatibility and invalid input', () => {
    ...
    describe('legacy timeframe compatibility', () => {
        ...
        it('should leave unknown legacy timeframe values untouched so they still trigger the console-error guard', async () => {
            ...
            expect(global.console.error).toHaveBeenCalledWith('Timeframe -42 is not allowed for ct-date-filter component');
    ...
    it('should console.error for invalid timeframe', async () => {
        ...
        expect(global.console.error).toHaveBeenCalledWith('Timeframe yeeet is not allowed for ct-date-filter component');

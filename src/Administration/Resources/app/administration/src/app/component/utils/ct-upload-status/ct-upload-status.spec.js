...
const snippetData = {
    'global.ct-media-upload.snackbar.message': (params) => {
        if (params.count === 1) {
    ...
    'global.ct-media-upload.snackbar.errorMessage': (params) => `${params.count} upload(s) failed`,
    'global.ct-media-upload.notification.failure.message': () => 'Error while uploading file.',
    'global.ct-media-upload.notification.illegalFilename.message': (params) => `Illegal filename: ${params.fileName}`,
    'global.ct-media-upload.notification.illegalFileUrl.message': (params) => `Illegal file URL: ${params.fileName}`,
    'global.ct-media-upload.notification.illegalFileType.message': (params) => `File type not supported: ${params.fileName}`,
    'global.ct-media-upload.notification.requestCanceled.message': (params) => `Request canceled: ${params.fileName}`,
    'global.ct-media-upload.notification.payloadTooLarge.message': (params) => `Payload too large: ${params.fileName}`,
    'global.ct-media-upload.notification.transportError.message': (params) => `Transport error: ${params.fileName}`,
};

jest.mock('@contena/meteor-component-library', () => ({
...
async function createWrapper() {
    const component = await import('src/app/component/utils/ct-upload-status');
...
describe('src/app/component/utils/ct-upload-status', () => {
    let wrapper;
    ...
    it('should use singular snackbar message for a single upload', async () => {
        ...
        expect(wrapper.vm.$t).toHaveBeenCalledWith('global.ct-media-upload.snackbar.message', {
            count: 1,
            progress: 0,
            processed: 0,
            total: 1,
    ...
    it('should include processed count in snackbar message for multiple uploads', async () => {
        ...
        expect(wrapper.vm.$t).toHaveBeenCalledWith(
            'global.ct-media-upload.snackbar.message',

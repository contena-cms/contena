 ...
 * lives in a `<ct-block extends>` somewhere else in the tree, and the block that renders it has no
...
describe('src/app/component/structure/ct-block-override/ct-block: override slot reactivity', () => {
    it.each([
        [

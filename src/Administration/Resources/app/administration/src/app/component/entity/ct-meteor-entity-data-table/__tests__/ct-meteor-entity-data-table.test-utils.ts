...
import CtMeteorEntityDataTable from '../ct-meteor-entity-data-table'; // eslint-disable-line import/extensions

export { CtMeteorEntityDataTable };
        ...
        global: {
            stubs: {
                ...
                'ct-modal': {
                    ...
                    emits: ['modal-close'],
                    template: `
                        <div class="ct-modal-stub" :data-title="title" :data-variant="variant">
                            <slot />

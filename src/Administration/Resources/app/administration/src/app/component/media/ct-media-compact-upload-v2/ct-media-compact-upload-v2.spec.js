...
describe('src/app/component/media/ct-media-compact-upload-v2', () => {
    let wrapper;
    ...
    beforeEach(async () => {
        ...
        wrapper = mount(
            await wrapTestComponent('ct-media-compact-upload-v2', {
                sync: true,
            }),
            {
                props: {
    ...
    it('should contain the default accept value', async () => {
        const fileInput = wrapper.find('.ct-media-upload-v2__file-input');
    ...
    it('should contain url upload form when input type is url-upload', async () => {
        ...
        let urlForm = wrapper.find('.ct-media-upload-v2__url-form');
        let uploadBtn = wrapper.find('.ct-media-upload-v2__button.upload');
        ...
        urlForm = wrapper.find('.ct-media-upload-v2__url-form');
        uploadBtn = wrapper.find('.ct-media-upload-v2__button.upload');
    ...
    it('should render optional remove button label when corresponding prop is passed', async () => {
        ...
        const removeButton = wrapper.find('.ct-media-upload-v2__delete-item-button');
    ...
    it('should disable deletion option in context menu when the disableDeletion is enabled and multiselect source length is lower or equal 1', async () => {
        ...
        expect(wrapper.find('.ct-context-menu-item__buttonRemove').attributes('disabled')).toBeTruthy();
    });
});

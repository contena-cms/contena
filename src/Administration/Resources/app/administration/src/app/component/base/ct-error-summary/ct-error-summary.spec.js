...
async function createWrapper(errors = {}, options = {}) {
    Contena.Store.get('error').api = errors;

    return mount(await wrapTestComponent('ct-error-summary', { sync: true }), {
...
describe('src/app/component/base/ct-error-summary/index.js', () => {
    let wrapper;
    ...
    it('should show alert box with errors', async () => {
        ...
        const quantity = wrapper.find('.ct-error-summary__quantity');

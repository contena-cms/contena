...
describe('src/app/component/structure/ct-language-info', () => {
    let wrapper = null;

    beforeEach(async () => {
        Contena.Store.get('context').api.languageId = '123456789';
        Contena.Store.get('context').api.systemLanguageId = 123456789;
        Contena.Store.get('context').api.language = {
            id: '123',
            parentId: '456',
        };

        wrapper = mount(await wrapTestComponent('ct-language-info', { sync: true }), {
            global: {
                mocks: {
    ...
    it('should not render the infoText when no language is set', async () => {
        ...
        Contena.Store.get('context').api.language = null;
    ...
    it('should not render the infoText when user is in default language', async () => {
        ...
        Contena.Store.get('context').api.systemLanguageId = '123';
    ...
    it('should render the infoText for a root language', async () => {
        Contena.Store.get('context').api.systemLanguageId = '987654312';
        Contena.Store.get('context').api.language = {
            id: '1a2b3c',
            parentId: null,
        };

<template>
    <ct-block name="sw_data_grid_skeleton">
        <tbody class="ct-data-grid-skeleton" aria-busy="true">
            <ct-block name="sw_data_grid_skeleton_row">
                <tr
                    v-for="(item, itemIndex) in itemAmount"
                    :key="`grid-skeleton-itme-${itemIndex}`"
                    class="ct-data-grid__row"
                >
                    <ct-block name="sw_data_grid_skeleton_cell_selection">
                        <td v-if="showSelection" class="ct-data-grid__cell">
                            <ct-block name="sw_data_grid_skeleton_cell_selection_content">
                                <div class="ct-grid__cell-content"></div>
                            </ct-block>
                        </td>
                    </ct-block>

                    <ct-block name="sw_data_grid_skeleton_columns">
                        <td
                        ...
                        >
                            <ct-block name="sw_data_grid_skeleton_columns_content">
                                <div
                                    class="ct-data-grid__cell-content"
                                    :style="{ width: getRandomLength() + '%', 'min-width': '100px' }"
                                >
                                    <ct-block name="sw_data_grid_skeleton_element">
                    ...
                    <ct-block name="sw_data_grid_skeleton_spacer">
                        <td v-if="hasResizeColumns" class="ct-data-grid__cell" aria-hidden="true">
                            <ct-block name="sw_data_grid_skeleton_spacer_content">
                                <div class="ct-grid__cell-content"></div>
                            </ct-block>
                        </td>
                    </ct-block>

                    <ct-block name="sw_data_grid_skeleton_cell_actions">
                        <td v-if="showActions" class="ct-data-grid__cell">
                            <ct-block name="sw_data_grid_skeleton_cell_actions_content">
                                <div class="ct-grid__cell-content"></div>
                            </ct-block>
                        </td>
                    </ct-block>

...
import 'src/app/component/utils/ct-time-ago';

// mock Date.now() to 2025-06-24 15:00
Date.now = jest.fn(() => new Date(Date.UTC(2025, 5, 24, 15, 0)).valueOf());

async function createWrapper(props = {}) {
    return mount(await wrapTestComponent('ct-time-ago', { sync: true }), {
        props,
        global: {
            mocks: {
...
describe('src/app/component/utils/ct-time-ago', () => {
    afterEach(() => {
        jest.useRealTimers();
    });
    ...
    describe('date property as string', () => {
        describe('past dates', () => {
            it('should show the correct time for less than one minute', async () => {
                ...
                expect(wrapper.text()).toContain('global.ct-time-ago.justNow');
            });
            ...
            it('should show the correct time for less than one hour', async () => {
                ...
                expect(wrapper.text()).toContain('global.ct-time-ago.minutesAgo');
            });
        ...
        describe('future dates', () => {
            it('should show the correct time for less than one minute from now', async () => {
                ...
                expect(wrapper.text()).toContain('global.ct-time-ago.aboutNow');
            });
            ...
            it('should show the correct time for less than one hour from now', async () => {
                ...
                expect(wrapper.text()).toContain('global.ct-time-ago.minutesFromNow');
            });

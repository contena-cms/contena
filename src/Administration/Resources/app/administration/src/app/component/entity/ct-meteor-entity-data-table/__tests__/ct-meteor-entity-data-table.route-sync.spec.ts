...
describe('src/app/component/entity/ct-meteor-entity-data-table route synchronization', () => {
    ...
    it('reloads when the administration language changes', async () => {
        ...
        contextStore.api.languageId = 'new-language-id' as typeof contextStore.api.languageId;
        await flushPromises();

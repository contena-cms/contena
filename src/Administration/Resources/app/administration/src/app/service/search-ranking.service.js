const { merge, cloneDeep } = Contena.Utils.object;
const { Criteria } = Contena.Data;
const { Service, Module } = Contena;
...
export default function createSearchRankingService() {
    ...
    function getConfiguredMinSearchTermLength() {
        const configuredMinSearchTermLength = Contena.Context.app.config?.settings?.minSearchTermLength;

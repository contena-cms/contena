...
export default class AppAclService {
        ...
        return this._appRepository
            ...
            .then((apps) => apps.map((app) => {
                ...
                return {
                    ...
                    parent: null,
                    key: 'app',
                    roles: { [app.name]: { privileges: [], dependencies: [] } },
                };
            }))
            .then((appPermission) => {
                appPermission.push({
                    ...
                    parent: null,
                    key: 'app',
                    roles: { all: { privileges: [], dependencies } },
                });
    ...
    addAppPermissions() {
        return this.getAppPermissions().then((response) => this._privileges.addPrivilegeMappingEntries(response));
    }
}

describe('src/app/filter/thumbnail-size.filter.ts', () => {
    const thumbnailSizeFilter = Contena.Filter.getByName('thumbnailSize');
    const mediaThumbnailFactory = Contena.Service('repositoryFactory').create('media_thumbnail_size');

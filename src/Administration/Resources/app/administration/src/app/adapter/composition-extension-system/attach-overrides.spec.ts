...
describe('src/app/adapter/composition-extension-system attachOverrides', () => {
    ...
    it('lowered shape: a private setup binding may have the same name as a prop', async () => {
        ...
        const userFixture = { name: 'Ada' } as { name: string; timeZone?: string };
        ...
        expect(userFixture.timeZone).toBe('UTC');

    ...
    describe('actions', () => {
        describe('addApiError', () => {
            it('adds an API error', () => {
                ...
                store.addApiError({
                    ...
                    error: new ContenaError(base),
                });

                // @ts-expect-error
                const actual = store.api.entity.field as ContenaError;

                expect(actual).toBeInstanceOf(ContenaError);
            ...
            it('adds a nested API error', () => {
                ...
                const actual = store.api.entity.nested.field as ContenaError;
        ...
        describe('removeApiError', () => {
            it('removes an API error', () => {
                const error = new ContenaError({ code: 'TEST-003', detail: 'Test error' });
            ...
            it('removes a nested API error', () => {
                const error = new ContenaError({ code: 'TEST-004', detail: 'Nested error' });
        ...
        describe('resetApiErrors', () => {
            it('resets all API errors', () => {
                store.addApiError({
                    ...
                    error: new ContenaError({ code: 'TEST-005', detail: 'Error 1' }),
                });
                store.addApiError({
                    expression: 'entity2.field',
                    error: new ContenaError({ code: 'TEST-006', detail: 'Error 2' }),
                });
        ...
        describe('addSystemError', () => {
            it('adds a system error with generated ID', () => {
                const error = new ContenaError({ code: 'SYS-001', detail: 'System error' });
            ...
            it('adds a system error with provided ID', () => {
                const error = new ContenaError({ code: 'SYS-002', detail: 'System error' });
        ...
        describe('removeSystemError', () => {
            it('removes a system error', () => {
                const error = new ContenaError({ code: 'SYS-003', detail: 'System error' });
    ...
    describe('getters', () => {
        describe('getErrorsForEntity', () => {
            ...
            it('returns errors for a specific entity', () => {
                const error = new ContenaError({ code: 'ENT-001', detail: 'Entity error' });
        ...
        describe('getApiErrorFromPath', () => {
            ...
            it('returns the error at the specified path', () => {
                const error = new ContenaError({ code: 'PATH-001', detail: 'Nested error' });
        ...
        describe('getApiError', () => {
            it('returns the error for a given entity and field', () => {
                const error = new ContenaError({ code: 'FIELD-001', detail: 'Field error' });
        ...
        describe('getAllApiErrors', () => {
            it('returns all API errors', () => {
                store.addApiError({
                    ...
                    error: new ContenaError({ code: 'ALL-001', detail: 'Error 1' }),
                });
                store.addApiError({
                    expression: 'entity2.id.field',
                    error: new ContenaError({ code: 'ALL-002', detail: 'Error 2' }),
                });
        ...
        describe('existsErrorInProperty', () => {
            ...
            it('returns true if an error exists in the specified property', () => {
                store.addApiError({
                    ...
                    error: new ContenaError({ code: 'PROP-001', detail: 'Error' }),
                });
        ...
        describe('getSystemError', () => {
            ...
            it('returns the system error with the given ID', () => {
                const error = new ContenaError({ code: 'SYS-004', detail: 'System error' });
                store.addSystemError({ error, id: 'test-id' });
        ...
        describe('countSystemError', () => {
            it('returns the correct count of system errors', () => {
                ...
                store.addSystemError({ error: new ContenaError({ code: 'COUNT-001', detail: 'Error 1' }) });
                store.addSystemError({ error: new ContenaError({ code: 'COUNT-002', detail: 'Error 2' }) });

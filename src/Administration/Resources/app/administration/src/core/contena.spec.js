...
describe('core/contena', () => {
    ...
    it('should contain the necessary methods for the Classes', async () => {
        expect(Classes).toHaveProperty('ContenaError');
    ...
    it('should expose the host Vue I18n instance for administration extensions', async () => {
        expect(VueI18n).toHaveProperty('createI18n');
        expect(VueI18n).toHaveProperty('useI18n');
    });

    it('should expose the host Vue Router instance for administration extensions', async () => {
        expect(VueRouter).toHaveProperty('createRouter');
        expect(VueRouter).toHaveProperty('useRoute');
        expect(VueRouter).toHaveProperty('useRouter');
    });
});

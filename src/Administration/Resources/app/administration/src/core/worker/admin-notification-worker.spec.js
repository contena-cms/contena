...
describe('src/core/worker/admin-notification-worker', () => {
    ...
    beforeAll(() => {
        ...
        Contena.Service().register('notificationsService', () => notificationService);
        Contena.Service().register('userConfigService', () => userConfigService);
        Contena.Service().register('userService', () => userService);
    });
    ...
    it.each([
        ...
        jest.spyOn(Contena.Store, 'get').mockReturnValue({ createNotification });

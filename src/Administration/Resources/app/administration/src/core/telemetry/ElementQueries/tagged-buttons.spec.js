...
describe('src/core/telemetry/ElementQueries/tagged-button.ts', () => {
    it('recognizes added tagged button', async () => {
        ...
        button.setAttribute('data-analytics-id', 'ct-order-detail.save');
    ...
    it('recognizes nested tagged button', async () => {
        ...
        first.setAttribute('data-analytics-id', 'ct-order-detail.save');
        const second = document.createElement('button');
        second.setAttribute('data-analytics-id', 'ct-order-detail.cancel');

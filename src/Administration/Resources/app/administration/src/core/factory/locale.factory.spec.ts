...
describe('core/factory/locale.factory.ts', () => {
    beforeEach(() => {
        ...
        window.localStorage.removeItem('contena-admin-locale');

        setBrowserLanguages(originalNavigatorLanguage, [...originalNavigatorLanguages]);

        // Reset Contena.Snippet mock
        Object.defineProperty(Contena, 'Snippet', {
            value: undefined,
            writable: true,
            configurable: true,
        });
    ...
    describe('extend', () => {
        ...
        it('should not call setLocaleMessage when Contena.Snippet is not instantiated', () => {
            LocaleFactory.register('en-GB', {
                test: 'value',
            });
        ...
        it('should call setLocaleMessage twice when Contena.Snippet is instantiated', () => {
            LocaleFactory.register('en-GB', {
                original: 'value',
            });

            // Mock Contena.Snippet
        ...
        it('should handle optional chaining for setLocaleMessage', () => {
            ...
            // Mock Contena.Snippet but without setLocaleMessage
            Object.defineProperty(Contena, 'Snippet', {
                value: {},
                writable: true,
                configurable: true,
    ...
    describe('getLastKnownLocale', () => {
        it('should prefer the stored locale over the browser locale', () => {
            ...
            window.localStorage.setItem('contena-admin-locale', 'en-GB');
        ...
        it('should fall back to Chinese when the browser locale is not registered', () => {
            setBrowserLanguages('es-ES');

            LocaleFactory.setSystemFallbackLocale('en-GB');
            LocaleFactory.register('zh-CN', {});
            LocaleFactory.register('en-GB', {});
        ...
        it('should ignore an unsupported stored locale', () => {
            ...
            LocaleFactory.register('zh-CN', {});
            LocaleFactory.register('en-GB', {});
            window.localStorage.setItem('contena-admin-locale', 'fr-FR');

            expect(LocaleFactory.getLastKnownLocale()).toBe('zh-CN');
        });

        it('should fall back to the system locale when neither browser nor Chinese are registered', () => {
            setBrowserLanguages('es-ES');
        ...
        it('sets the complete locale on the document for locale-aware CJK font selection', () => {
            LocaleFactory.storeCurrentLocale('zh-CN');

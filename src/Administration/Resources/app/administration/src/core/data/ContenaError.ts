 ...
 * @memberOf module:core/data/ContenaError
 */
// eslint-disable-next-line ct-deprecation-rules/private-feature-declarations
export default class ContenaError {
    ...
    constructor({
        ...
        if (typeof code !== 'string' || code === '') {
            throw new Error('[ContenaError] can not identify error by code');
        }

...
class MediaApiService extends ApiService {
        ...
        this.getListenerForTag(uploadTag).forEach((listener) => {
            listener(
                this._createUploadEvent(UploadEvents.UPLOAD_FINISHED, uploadTag, {
                    ...
                    failureAmount: 0,
                    totalAmount: 0,
                    customMessage: 'global.ct-media-upload.notification.assigned.message',
                }),
            );
        });
    }
    ...
    async getDefaultFolderId(entity) {
        ...
        const defaultFolderRepository = Contena.Service('repositoryFactory').create('media_default_folder');

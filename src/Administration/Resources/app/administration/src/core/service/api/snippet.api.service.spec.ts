...
describe('core/service/api/snippet.api.service.ts', () => {
    ...
    describe('getSnippets', () => {
        ...
        it('should call setLocaleMessage when registering new locale with Contena.Snippet instantiated', async () => {
            const { snippetApiService, clientMock } = createSnippetApiService();
        ...
        it('should not call setLocaleMessage when Contena.Snippet is not instantiated', async () => {
            const { snippetApiService, clientMock } = createSnippetApiService();
        ...
        it('should call setLocaleMessage when Contena.Snippet is instantiated', async () => {
            const { snippetApiService, clientMock } = createSnippetApiService();
    ...
    describe('getFilter', () => {
        it('should get filter correctly', async () => {
            ...
            await expect(snippetApiService.getFilter()).resolves.toEqual({
                total: 2,
                data: [
                    'filter1',
                    'filter2',

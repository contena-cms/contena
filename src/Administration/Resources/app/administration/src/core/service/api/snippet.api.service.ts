...
class SnippetApiService extends ApiService {
    ...
    async getFilter(): Promise<SnippetFilter> {
        ...
        return this.httpClient
            ...
            .then((response: AxiosResponse<SnippetFilter>) => ApiService.handleResponse(response));
    }
            ...
            .then((snippetRegistry: SnippetRegistry) => {
                ...
                Object.entries(snippetRegistry).forEach(
                    ([
                        ...
                        if (fnName === 'register' && Contena.Snippet?.setLocaleMessage) {
                            ...
                            Contena.Snippet.setLocaleMessage?.(localeKey, {});
                            Contena.Snippet.setLocaleMessage?.(localeKey, allMessagesForLocale);
                        }
                    },
                );
            });

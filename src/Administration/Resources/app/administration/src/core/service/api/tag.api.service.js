    ...
    async merge(ids, name, definitionProperties, bulkMergeProgress) {
        ...
        for (const [
            ...
            do {
                ...
                const { data, total } = await repository.searchIds(criteria, Contena.Context.api);
        ...
        await tagRepository.syncDeleted(ids, Contena.Context.api);
    }

    getRepository(entity) {
        return Contena.Service('repositoryFactory').create(entity);
    }
}

    ...
    it('gets message statistics correctly when enabled and stats are available', async () => {
        ...
        const mockResponse = {
            ...
            stats: {
                ...
                messageTypeStats: [
                    {
                        type: 'Contena\\Core\\Framework\\Adapter\\Cache\\InvalidateCacheTask',
                        count: 2,
                    },
                    {
                        type: 'Contena\\Core\\Content\\ProductExport\\ScheduledTask\\ProductExportGenerateTask',
                        count: 2,
                    },
                    {
                        type: 'Contena\\Elasticsearch\\Framework\\Indexing\\CreateAliasTask',
                        count: 1,
                    },
                ],
            },

...
async function createWrapper(category = {}) {
    ...
    return mount(await wrapTestComponent('ct-category-link-settings', { sync: true }), {
        global: {
            stubs: {
                'mt-card': {
...
describe('src/module/ct-category/component/ct-category-link-settings', () => {
    beforeEach(() => {
    ...
    it('should have an enabled text field for old configuration', async () => {
        ...
        const linkTypeField = wrapper.find('ct-single-select-stub');
        ...
        const urlField = wrapper.findComponent('.ct-category-link-settings__external-link');
    ...
    it('should have enabled select fields for internal link', async () => {
        ...
        const selects = wrapper.findAll('ct-single-select-stub');
        ...
        const blogSelectField = wrapper.find('ct-entity-single-select-stub');
        expect(blogSelectField.attributes('disabled')).toBeFalsy();
        expect(blogSelectField.attributes('entity')).toBe('blog');
    ...
    it('should clean up on switch to internal', async () => {
        ...
        await wrapper.getComponent('.ct-category-link-settings__type').vm.$emit('update:value', 'internal');
    ...
    it('should clean up on switch to external', async () => {
        ...
        await wrapper.getComponent('.ct-category-link-settings__type').vm.$emit('update:value', 'external');
    ...
    it('should have disabled fields with no rights', async () => {
        ...
        const externalLinkField = wrapper.findComponent('.ct-category-link-settings__external-link');
        ...
        const newTabField = wrapper
            .findComponent('.ct-category-link-settings__link-new-tab')
            .find('[aria-label="ct-category.base.link.linkNewTabLabel"]');
    ...
    it('should have correct internal link', async () => {
        ...
        wrapper.find('ct-category-tree-field-stub');
        expect(wrapper.vm.category.internalLink).toBe('someUuid');
    });
});

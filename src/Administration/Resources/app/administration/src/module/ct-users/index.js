...
Contena.Component.register('ct-users-user-detail-base', () => import('./view/ct-users-user-detail-base'));
Contena.Component.register('ct-users-user-detail-interface', () => import('./view/ct-users-user-detail-interface'));
Contena.Component.register('ct-users-user-detail-roles', () => import('./view/ct-users-user-detail-roles'));
Contena.Component.register('ct-users-user-detail-integrations', () => import('./view/ct-users-user-detail-integrations'));

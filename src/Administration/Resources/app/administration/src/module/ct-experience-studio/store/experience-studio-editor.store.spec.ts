...
describe('src/module/ct-experience-studio/store/experience-studio-editor.store.ts', () => {
    ...
    const getStore = () => Contena.Store.get('experienceStudioEditor');
    ...
    it('should register a store', () => {
        expect(Contena.Store.get('experienceStudioEditor')).toBeDefined();
    });

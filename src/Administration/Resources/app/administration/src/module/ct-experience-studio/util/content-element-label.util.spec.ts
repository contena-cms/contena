...
function makeElement(properties: Record<string, unknown>): ContentElementNode {
    return {
        component: 'Ct:Product:Slider',
        properties,
    } as ContentElementNode;
}

describe('module/ct-experience-studio/util/content-element-label.util', () => {
    ...
    it('formats a namespaced component identifier into its trailing segment', () => {
        expect(formatComponentName('Ct:Product:Slider')).toBe('Slider');
    });
});

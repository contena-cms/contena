...
describe('module/ct-experience-studio/util/element-settings.util', () => {
    ...
    it('returns adminUI help text when provided', () => {
        expect(
            getAdminUiHelpText({
                ...
                adminUI: {
                    component: 'mt-text-field',
                    helpText: 'ct-experience-studio.elements.grid.columns.helpText',
                },
            }),
        ).toBe('ct-experience-studio.elements.grid.columns.helpText');
    });

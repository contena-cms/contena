...
Contena.Service().register('contenaDiscountCampaignService', () => {
    return {
...
async function createWrapper() {
    return mount(
        await wrapTestComponent('ct-profile-index-search-preferences', {
            sync: true,
        }),
        {
            global: {
...
describe('src/module/ct-profile/view/ct-profile-index-search-preferences', () => {
    ...
    it('should be able to select all', async () => {
        ...
        await wrapper.find('.ct-profile-index-search-preferences-searchable-elements__button-select-all').trigger('click');
    ...
    it('should be able to deselect all', async () => {
        ...
        await wrapper.find('.ct-profile-index-search-preferences-searchable-elements__button-deselect-all').trigger('click');

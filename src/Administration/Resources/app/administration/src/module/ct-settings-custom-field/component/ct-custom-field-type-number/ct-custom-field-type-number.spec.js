...
async function createWrapper(customFieldOverrides = {}) {
    return mount(await wrapTestComponent('ct-custom-field-type-number', { sync: true }), {
        props: {
        ...
        global: {
            ...
            stubs: {
                ...
                'ct-container': {
                    template: '<div class="ct-container"><slot /></div>',
                },
                'mt-select': {
...
describe('src/module/ct-settings-custom-field/component/ct-custom-field-type-number', () => {
    it('should provide correct property names for translations', async () => {
        ...
        expect(wrapper.vm.propertyNames).toEqual({
            ...
            placeholder: 'ct-settings-custom-field.customField.detail.labelPlaceholder',
    ...
    it('should provide number type options to the select', async () => {
        ...
        expect(select.props('options')).toEqual([
            {
                value: 'int',
                label: 'ct-settings-custom-field.customField.detail.labelInt',
            },
            {
                value: 'float',
                label: 'ct-settings-custom-field.customField.detail.labelFloat',
            },
        ]);
    });

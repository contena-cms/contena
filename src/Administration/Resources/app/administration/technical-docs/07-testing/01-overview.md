...
The Contena Administration uses **Jest** as the primary testing framework for unit and component tests. This document provides a basic overview of the testing infrastructure and common patterns.

For normative test rules, see [Administration testing](../../../../../../../coding-guidelines/administration/testing.md).

For detailed examples and advanced topics, see the [official Contena Jest testing documentation](https://developer.contena.cn/docs/guides/plugins/plugins/testing/jest-admin.html).
...
```text
src/app/component/base/ct-button/
├── index.ts
├── ct-button.vue
└── ct-button.spec.ts          # Test file
```
...
async function createWrapper(options = {}) {
    return mount(await wrapTestComponent('ct-your-component', { sync: true }), {
        props: {
            // Component props
        },
        ...options,
...
- **`wrapTestComponent()`** - Resolves Contena components with template inheritance
...
```javascript
beforeAll(() => {
    Contena.Service.register('customService', () => ({
...
- [Jest Admin Testing Guide](https://developer.contena.cn/docs/guides/plugins/plugins/testing/jest-admin.html) - Comprehensive guide with detailed examples

...
The feature flag system in Contena 6 administration serves two primary purposes:
...
Feature flags are initialized early in the application bootstrap process in `src/core/contena.ts`:
...
```typescript
/**
 * @deprecated tag:v6.9.0 - Will be removed, use NewComponent instead
 */
```
...
V6_9_0_0  // Enables features or warnings planned for version 6.9.0.0
```
...
```typescript
/**
 * @deprecated tag:v6.9.0 - Will be removed, use mt-button instead
 */
export default {
    name: 'ct-button',

...
> Purpose: Internal-facing technical documentation for the Contena 6 Administration (Vue application). Each linked document currently contains only a bullet list of intended content. Expand iteratively.
...
- Runtime → Global Contena object, feature flags, context/auth lifecycles
- UI → Meteor vs legacy `ct-` components, design tokens, accessibility approach

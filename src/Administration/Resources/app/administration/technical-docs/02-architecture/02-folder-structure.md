...
This document describes the folder structure of the Contena 6 Administration interface, located in `src/Administration/Resources/app/administration/src`.
...
- **`contena.ts`** - Core Contena instance and API
...
The `module/` directory contains business domain modules representing different areas of the Contena administration.

### Module Categories:

#### Core Business Modules:
- **`ct-product/`** - Product management
- **`ct-category/`** - Category management
- **`ct-customer/`** - Customer management
- **`ct-order/`** - Order processing
- **`ct-media/`** - Media library
- **`ct-manufacturer/`** - Manufacturer management

#### Content Management:
- **`ct-cms/`** - Content Management System
- **`ct-landing-page/`** - Landing page builder
- **`ct-mail-template/`** - Email template editor

#### Sales & Marketing:
- **`ct-promotion-v2/`** - Promotion management
- **`ct-product-stream/`** - Product streams
- **`ct-sales-channel/`** - Sales channel configuration

#### System & Configuration:
- **`ct-settings*/`** - Various system settings modules
- **`ct-users/`** - User management
- **`ct-permissions/`** - Role and permission management
- **`ct-integration/`** - Third-party integrations

#### Utilities & Tools:
- **`ct-bulk-edit/`** - Bulk editing functionality
- **`ct-import-export/`** - Data import/export
- **`ct-extension/`** - Plugin and app management
...
### Plugin Structure Example (CtPayPal):

```
custom/plugins/CtPayPal/src/Resources/app/administration/src/

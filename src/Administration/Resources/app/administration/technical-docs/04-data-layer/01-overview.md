...
The Contena 6 Administration data layer provides a robust abstraction over the backend Data Abstraction Layer (DAL), offering consistent CRUD operations, type safety, and efficient data management for the Vue.js-based administration interface.
...
- **Source**: Imported from `@contena/meteor-admin-sdk`
...
```
Component → Repository → HTTP Client → Contena API
    ↑           ↑            ↑              ↓

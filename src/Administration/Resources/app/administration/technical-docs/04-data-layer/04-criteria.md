...
The Criteria API provides a fluent, type-safe interface for expressing complex queries in Contena 6 Administration. It translates query intentions into backend DAL search parameters, enabling powerful filtering, sorting, pagination, and aggregation capabilities.

...
runNpmAudit({
    ignoredGHSAs: [
        ...
        'https://github.com/advisories/GHSA-cp6q-959q-f8rh', // @tiptap/core mergeAttributes prototype pollution, moderate; pulled in by @contena/meteor-component-library and a direct v2 integration, with no compatible v2 fix

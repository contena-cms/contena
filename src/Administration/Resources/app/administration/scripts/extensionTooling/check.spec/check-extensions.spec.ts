...
describe('scripts/extensionTooling/check checkExtensions', () => {
    ...
    it('visibly skips custom configs that do not compose the Contena preset', async () => {
        linkRealToolchain(administrationRoot);
        ...
        expect(probe.eslintResolution?.detail).toContain('does not compose the Contena factory');

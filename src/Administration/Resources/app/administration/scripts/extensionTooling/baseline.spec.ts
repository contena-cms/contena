...
describe('scripts/extensionTooling/baseline', () => {
    ...
    beforeEach(() => {
        projectRoot = createTempProject('ct-tooling-baseline-');
    });
    ...
    describe('canHoldBaseline', () => {
        it('admits only writable custom/plugins extensions', () => {
            ...
            expect(canHoldBaseline({ basePath: 'src/Frontend', vendor: false })).toBe(false);
    ...
    describe('readBaseline', () => {
        ...
        it('ignores the marker field and normalizes missing streams', () => {
            writeFile(
                ...
                JSON.stringify({
                    '//': '@generated by Contena Administration extension tooling',
                    version: 1,

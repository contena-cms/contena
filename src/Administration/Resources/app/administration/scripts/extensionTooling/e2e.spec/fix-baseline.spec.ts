...
describe('extension tooling fix -> baseline workflow (e2e)', () => {
    it(
        ...
        async () => {
            const projectRoot = createTempProject('ct-tooling-fix-baseline-');
            ...
            const baselinePath = path.join(projectRoot, 'custom/plugins/FixBase/.contena-admin-baseline.json');

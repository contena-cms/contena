...
const COMMAND: CommandSpec = {
    ...
    flags: [
        ...
        { name: '--project-root', value: 'required', valueName: '<path>', description: 'Project root to set up.' },
    ],
};
...
describe('scripts/extensionTooling/cli', () => {
    describe('parseCli', () => {
        it('parses boolean flags and value options', () => {
            ...
            expect(parsed.values['--root-config']).toBe('Ct:.');
            expect(parsed.values['--project-root']).toBe('/srv/project');
        });

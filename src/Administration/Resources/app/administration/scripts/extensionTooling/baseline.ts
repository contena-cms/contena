 ...
 * `.contena-admin-baseline.json` at the plugin root records the findings that
...
export const BASELINE_FILE_NAME = '.contena-admin-baseline.json';
 ...
 * in-repo bundle (`src/Frontend`, …) must not collect per-developer debt

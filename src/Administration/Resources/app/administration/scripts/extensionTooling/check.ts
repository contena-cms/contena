 ...
 * that do not compose the Contena preset are visibly skipped as
...
const CHECK_COMMAND: CommandSpec = {
    ...
    flags: [
        ...
        },
        {
            name: '--fix',
            description:
                'Apply ESLint autofixes, incl. Contena deprecation codemods (ct-* → mt-*), not only formatting ' +
        ...
        },
        {
            ...
            valueName: '<path>',
            description:
                'Project root to check (defaults to the PROJECT_ROOT env). Set this when running from a ' +

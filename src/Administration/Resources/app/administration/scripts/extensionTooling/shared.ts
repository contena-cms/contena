 ...
 */
export const GENERATED_MARKER = '@generated by Contena Administration extension tooling';

export const STATE_DIR = 'var/admin-extension-tooling';
export const SHIM_DIR_NAME = '.contena';
...
export type ConfigDefect =
    ...
    | 'include-missing'
    /** An ESLint config that never composes the Contena factory. */
    | 'factory-missing';
...
export interface AdministrationTarget {
    ...
    adminFolder: string;
    /** Whether a generated `.contena/` bridge sits beside this source root. */
...
export interface ExtensionToolingProject {
    /** Folder name of the extension root (nearest composer.json), e.g. "CtPayPal". */
    name: string;
 ...
 * itself: with cwd `/tmp/project` and canonical `/private/tmp/project`, removing
 * `/tmp/project/` from `/private/tmp/project/custom/a.ts` yielded
 * `/privatecustom/a.ts`.
 */
 ...
 * as an extension root (its composer.json is the project, not an extension).
 */

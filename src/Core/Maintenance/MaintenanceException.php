...
{
    final public const string MAINTENANCE_SYMFONY_CONSOLE_APPLICATION_NOT_FOUND = 'MAINTENANCE__SYMFONY_CONSOLE_APPLICATION_NOT_FOUND';
    final public const string MAINTENANCE_MIGRATION_INVALID_VERSION_SELECTION_MODE = 'MAINTENANCE__MIGRATION_INVALID_VERSION_SELECTION_MODE';
    final public const string MAINTENANCE_ENVIRONMENT_VARIABLE_NOT_DEFINED = 'MAINTENANCE__ENVIRONMENT_VARIABLE_NOT_DEFINED';
    final public const string MAINTENANCE_ENVIRONMENT_VARIABLE_NOT_VALID = 'MAINTENANCE__ENVIRONMENT_VARIABLE_NOT_VALID';
    final public const string MAINTENANCE_DB_CONNECTION_PARAMETER_MISSING = 'MAINTENANCE__DB_CONNECTION_PARAMETER_MISSING';
    final public const string MAINTENANCE_DB_VERSION_SELECT_FAILED = 'MAINTENANCE__DB_VERSION_SELECT_FAILED';
    final public const string MAINTENANCE_COULD_NOT_GET_ID = 'MAINTENANCE__COULD_NOT_GET_ID_OF_ENTITY';
    final public const string MAINTENANCE_USER_ALREADY_EXISTS = 'MAINTENANCE__USER_ALREADY_EXISTS';
    final public const string MAINTENANCE_USER_PASSWORD_TOO_SHORT = 'MAINTENANCE__USER_PASSWORD_TOO_SHORT';
    final public const string MAINTENANCE_COULD_NOT_READ_FILE = 'MAINTENANCE__COULD_NOT_READ_FILE';
    final public const string MAINTENANCE_COULD_NOT_CREATE_DIRECTORY = 'MAINTENANCE__COULD_NOT_CREATE_DIRECTORY';

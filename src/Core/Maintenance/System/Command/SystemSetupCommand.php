...
class SystemSetupCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addOption('http-cache-enabled', null, InputOption::VALUE_OPTIONAL, 'Http-Cache enabled', $this->getDefault('CONTENA_HTTP_CACHE_ENABLED', '1'))
            ->addOption('cdn-strategy', null, InputOption::VALUE_OPTIONAL, 'CDN Strategy', $this->getDefault('CONTENA_CDN_STRATEGY_DEFAULT', 'id'))
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        $env = [
            ...
            'CONTENA_HTTP_CACHE_ENABLED' => $input->getOption('http-cache-enabled'),
            'CONTENA_CDN_STRATEGY_DEFAULT' => $input->getOption('cdn-strategy'),
    ...
    private function getDsn(InputInterface $input, SymfonyStyle $io): array
    {
        ...
        $dbName = $io->ask('Database name', 'contena', $emptyValidation);

...
return static function (ContainerConfigurator $container, ContainerBuilder $builder): void {
    ...
    $container->extension('mcp', [
        'servers' => [
            ...
            'channel_api' => [
                'name' => 'Contena CMS Channel API',
                'version' => '1.0.0',
                'description' => 'Contena CMS Channel API MCP server for channel and member-context operations.',

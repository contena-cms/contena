...
use Contena\Core\Framework\Plugin\Exception\NoPluginFoundInZipException;
...
class PluginZipImportCommand extends Command
{
    ...
    {
        $this->addArgument('zip-file', InputArgument::REQUIRED, 'Zip file that contains a Contena Platform plugin.')

...
use Contena\Core\Framework\Script\ScriptCollection;
...
class ScriptLifecycleHandler extends AbstractLifecycleHandler
{
    ...
    public function refresh(): void
    {
        ...
        // We don't automatically update service scripts, as that would do a request to the service on every request to contena

...
class ClientRepository implements ClientRepositoryInterface
{
     ...
     */
    private const string DUMMY_CLIENT_SECRET_HASH = '$2y$12$PVcA5R6ri9kS.7FnFUBRIOLwqU//bCicx5RFxwecAAccbmZ7V7PKu';
    ...
    {
        /** @var array{id: string, label: string, secret_access_key: string}|false $key */
        $key = $this->connection->fetchAssociative(
            'SELECT integration.id AS id, integration.label, integration.secret_access_key
             FROM integration

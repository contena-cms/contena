...
use Contena\Core\Framework\DataAbstractionLayer\EntityProtection\EntityProtection;
...
class ApiController extends AbstractController
{
    ...
    public function aggregate(Request $request, Context $context, ResponseFactoryInterface $responseFactory, string $entityName, string $path): Response
    {
        ...
        $result = new EntitySearchResult(0, new EntityCollection(), $aggregations, $criteria, $context);
    ...
    private function resolveSearch(Request $request, Context $context, string $entityName, string $path): array
    {
        ...
        if ($association instanceof ManyToManyAssociationField) {
             ...
             * $definition:     \Contena\Core\Content\Product\Definition\ProductPriceDefinition
             */
             ...
             * $definition:     \Contena\Core\Content\Product\Aggregate\ProductManufacturer\ProductManufacturerDefinition
             */
             ...
             * $definition:     \Contena\Core\Checkout\Order\Aggregate\OrderCustomer\OrderCustomerDefinition
             */
    ...
    private function getDefinitionOfPath(string $entityName, string $path, Context $context): EntityDefinition
    {
        ...
        if ($association instanceof ManyToManyAssociationField) {
             ...
             * $definition:     \Contena\Core\Content\Category\CategoryDefinition
             */

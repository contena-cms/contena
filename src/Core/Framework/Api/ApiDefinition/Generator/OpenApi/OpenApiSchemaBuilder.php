...
class OpenApiSchemaBuilder
{
    ...
    private function createInfo(string $api, string $version): Info
    {
        return new Info([
            ...
            'description' => $api === DefinitionService::API
                ? <<<'EOF'
This endpoint reference contains an overview of all endpoints comprising the Contena Admin API.
...
EOF
                : 'This endpoint reference contains an overview of all endpoints comprising the Contena Channel API.',
        ]);
    }
    ...
    {
        if ($api !== DefinitionService::CHANNEL_API) {

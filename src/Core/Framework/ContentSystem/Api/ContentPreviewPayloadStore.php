 ...
 * {@see ContentPreviewRequest} behind a short-lived token, and the Frontend redemption route reads one back.
...
class ContentPreviewPayloadStore
{
    ...
    private function deserialize(array $payload): ContentPreviewRequest
    {
        ...
        $request = new ContentPreviewRequest(
            ...
            channelId: $this->stringField($payload, 'channelId'),
            ...
            memberId: $this->nullableStringField($payload, 'memberId'),

...
class ChannelDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            new DataScopeField()->setDescription('Non-null identity of the owning data scope for channel.'),
            ...
            new FkField('currency_id', 'currencyId', CurrencyDefinition::class)->addFlags(new ApiAware(), new Required())->setDescription('Unique identity of the default currency.'),
            ...
            new ManyToOneAssociationField('currency', 'currency_id', CurrencyDefinition::class, 'id', false)->addFlags(new ApiAware())->setDescription('Default currency for the channel.'),

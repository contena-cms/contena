...
use Contena\Core\System\Snippet\Struct\InvalidPluralizationStruct;
use Contena\Core\System\Snippet\Struct\MissingSnippetCollection;
use Contena\Core\System\Snippet\Struct\MissingSnippetStruct;
use Contena\Core\System\Snippet\Struct\SnippetValidationStruct;
...
readonly class SnippetValidator
{
    ...
    protected function getAllFiles(): SnippetFileCollection
    {
        ...
        $this->hydrateFiles($this->snippetFileHandler->findFrontendSnippetFiles(), $snippetFiles);
